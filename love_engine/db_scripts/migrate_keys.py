...
## VARIABLES
DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/love_engine"
        ...
        with open(csv_file_path, "r", encoding="utf-8") as file:
            ...
            for row in csv_reader:
                try:
                    ...
                    existing_token = await prisma.love_engine_verificationtoken.find_unique(
                    ...
                    # Insert the record
                    await prisma.love_engine_verificationtoken.create(
