"""
Main Search function for LoveEngine.
"""
...
from love_engine.utils import ProviderConfigManager, client, filter_out_love_engine_params
...
async def asearch(
    ...
    **kwargs,
    ...
    Example:
        ...
        # Basic search
        response = await love_engine.asearch(
...
def search(
    ...
    **kwargs,
    ...
    try:
        ...
        # Filter out internal LoveEngine parameters from kwargs
        filtered_kwargs = filter_out_love_engine_params(kwargs=kwargs)
