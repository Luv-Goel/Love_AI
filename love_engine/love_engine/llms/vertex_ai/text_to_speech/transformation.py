...
from love_engine.types.llms.vertex_ai import VERTEX_CREDENTIALS_TYPES
from love_engine.types.llms.vertex_ai_text_to_speech import (
...
class VertexAITextToSpeechConfig(BaseTextToSpeechConfig, VertexBase):
    ...
    def dispatch_text_to_speech(
        ...
        **kwargs: Any,
        ...
        vertex_credentials = self.safe_get_vertex_ai_credentials(love_engine_params_dict)
        vertex_project = self.safe_get_vertex_ai_project(love_engine_params_dict)
        vertex_location = self.safe_get_vertex_ai_location(love_engine_params_dict)
        ...
        # Store credentials in love_engine_params for use in transform methods
    ...
    def _validate_vertex_input(
        ...
        if use_ssml:
            ...
            # LoveEngine will auto-detect if text is in ssml format
    ...
    def transform_text_to_speech_request(
        ...
        """
        # Get Vertex AI credentials from love_engine_params
        vertex_credentials: Optional[VERTEX_CREDENTIALS_TYPES] = love_engine_params.get(
            "vertex_credentials"
        )
        vertex_project: Optional[str] = love_engine_params.get("vertex_project")
        ...
        auth_header, _ = self._get_token_and_url(
            ...
            vertex_credentials=vertex_credentials,
            vertex_project=vertex_project,
            vertex_location=love_engine_params.get("vertex_location"),
            stream=False,
            custom_llm_provider="vertex_ai_beta",
        ...
        # 1. love_engine_params by dispatch method
        # 2. optional_params by map_openai_params
        voice_dict = love_engine_params.get("vertex_voice_dict") or optional_params.get(
            "vertex_voice_dict"
        )
