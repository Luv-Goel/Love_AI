...
from love_engine.types.llms.vertex_ai import VertexPartnerProvider
from love_engine.utils import ModelResponse
...
class VertexAIPartnerModels(VertexBase):
    ...
    def completion(
        ...
        try:
            ...
            from love_engine.llms.anthropic.chat import AnthropicChatCompletion
            from love_engine.llms.codestral.completion.handler import (
                CodestralTextCompletion,
            )
            from love_engine.llms.openai_like.chat.handler import OpenAILikeChatHandler
        ...
        try:
            ...
            if "codestral" in model and love_engine_params.get("text_completion") is True:
    ...
    async def count_tokens(
        ...
        Args:
            ...
            love_engine_params: LoveEngine parameters dict
        ...
        # Vertex on any LoveEngine install without that extra. Stay SDK-free.
        try:
            from love_engine.llms.vertex_ai.vertex_ai_partner_models.count_tokens.handler import (
            ...
            # Prepare love_engine_params with credentials
            _love_engine_params = love_engine_params.copy()
            if vertex_project:
                _love_engine_params["vertex_project"] = vertex_project
            if vertex_location:
                _love_engine_params["vertex_location"] = vertex_location
            if vertex_credentials:
                _love_engine_params["vertex_credentials"] = vertex_credentials
