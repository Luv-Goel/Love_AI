...
class VertexAIPartnerModelsTokenCounter(VertexBase):
    ...
    async def handle_count_tokens_request(
        ...
        Args:
            ...
            love_engine_params: LoveEngine parameters containing credentials, project, location
        ...
        vertex_count_tokens_location = love_engine_params.get(
            "vertex_count_tokens_location"
        )
        vertex_location_raw = self.get_vertex_ai_location(love_engine_params)
