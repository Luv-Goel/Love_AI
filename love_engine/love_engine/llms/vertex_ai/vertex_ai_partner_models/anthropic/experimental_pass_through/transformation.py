...
class VertexAIPartnerModelsAnthropicMessagesConfig(AnthropicMessagesConfig, VertexBase):
    ...
    def validate_anthropic_messages_environment(
        ...
        """
        vertex_ai_project = VertexBase.safe_get_vertex_ai_project(love_engine_params)
        vertex_ai_location = VertexBase.safe_get_vertex_ai_location(love_engine_params)
