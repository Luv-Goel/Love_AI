...
from love_engine.constants import DEFAULT_GOOGLE_VIDEO_DURATION_SECONDS
...
from love_engine.types.videos.main import VideoCreateOptionalRequestParams, VideoObject
...
if TYPE_CHECKING:
    ...
    from love_engine.llms.base_llm.chat.transformation import (
...
class VertexAIVideoConfig(BaseVideoConfig, VertexBase):
    ...
    def validate_environment(
        ...
        love_engine_params: Optional[Union[GenericLoveEngineParams, dict]] = None,
    ) -> dict:
        """
        ...
        # Use safe_get_* methods that don't mutate love_engine_params dict
        # Ensure love_engine_params is a dict for type checking
        params_dict: Dict[str, Any] = (
            cast(Dict[str, Any], love_engine_params) if love_engine_params is not None else {}
        )

        vertex_project = VertexBase.safe_get_vertex_ai_project(
            love_engine_params=params_dict
        )
    ...
    def get_complete_url(
        ...
        """
        vertex_project = VertexBase.safe_get_vertex_ai_project(love_engine_params)
        vertex_location = VertexBase.safe_get_vertex_ai_location(love_engine_params)
    ...
    def transform_video_content_request(
        ...
        return self.transform_video_status_retrieve_request(
            video_id, api_base, love_engine_params, headers
        )
    ...
    def transform_video_create_character_request(
        self, name, video, api_base, love_engine_params, headers
    ):
        raise NotImplementedError(
    ...
    def transform_video_get_character_request(
        self, character_id, api_base, love_engine_params, headers
    ):
    ...
    def get_error_class(
        ...
        from love_engine.llms.vertex_ai.common_utils import VertexAIError
