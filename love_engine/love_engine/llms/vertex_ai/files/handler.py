...
from love_engine.integrations.gcs_bucket.gcs_bucket_base import (
    GCSBucketBase,
    GCSLoggingConfig,
)
...
class VertexAIFilesHandler(GCSBucketBase):
    ...
    def create_file(
        ...
        Only supported for Async love_engine.acreate_file
        """
    ...
    def _extract_bucket_and_object_from_file_id(
        ...
        Expected format: gs://bucket-name/love_engine-vertex-files/path/to/file

        Returns:
            tuple: (bucket_name, object_path)
            - bucket_name: "bucket-name"
            - object_path: "love_engine-vertex-files/path/to/file"
        """
    ...
    async def afile_content(
        ...
        return config.transform_file_content_response(
            raw_response=mock_response, logging_obj=logging_obj, love_engine_params={}
        )
