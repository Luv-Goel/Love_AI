...
from love_engine.types.utils import EmbeddingResponse, Usage
...
class VertexAITextEmbeddingConfig(BaseModel):
    ...
    def transform_openai_request_to_vertex_embedding_request(
        ...
        """
        # Import here to avoid circular import issues with love_engine.__init__
        from love_engine.llms.vertex_ai.vertex_embeddings.bge import VertexBGEConfig
