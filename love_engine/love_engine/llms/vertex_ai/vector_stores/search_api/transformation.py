...
class VertexSearchAPIVectorStoreConfig(BaseVectorStoreConfig, VertexBase):
    ...
    def get_auth_credentials(
        ...
        vertex_credentials = self.get_vertex_ai_credentials(dict(love_engine_params))
        vertex_project = self.get_vertex_ai_project(dict(love_engine_params))
    ...
    def validate_environment(
        ...
        auth_headers = self.get_auth_credentials(love_engine_params.model_dump())
    ...
    def get_complete_url(
        ...
        collection_id = (
            love_engine_params.get("vertex_collection_id") or "default_collection"
        )
        ...
        engine_id = love_engine_params.get("vertex_engine_id")
        if engine_id:
        ...
        datastore_id = love_engine_params.get("vector_store_id")
        if not datastore_id:
            raise ValueError(
    ...
    def transform_search_vector_store_request(
        ...
        is_engine = bool(love_engine_params.get("vertex_engine_id"))
        ...
        love_engine_logging_obj.model_call_details["query"] = request_body.get(
            "query", query
        )
