...
class VertexAITokenCounter(GoogleAIStudioTokenCounter, VertexBase):
    async def validate_environment(
        ...
        vertex_project = self.get_vertex_ai_project(love_engine_params=love_engine_params)
        vertex_location = self.get_vertex_ai_location(love_engine_params=love_engine_params)
        should_use_v1beta1_features = self.is_using_v1beta1_features(love_engine_params)
