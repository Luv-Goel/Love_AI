...
Handles transforming LoveEngine's unified formats to Vertex AI RAG Engine API format.
"""
...
class VertexAIRAGTransformation(VertexBase):
    ...
    def transform_chunking_strategy_to_vertex_format(
        ...
        """
        Transform LoveEngine's unified chunking_strategy to Vertex AI RAG format.

        LoveEngine format (RAGChunkingStrategy):
            {
                "chunk_size": 1000,
                "chunk_overlap": 200,
                "separators": ["\n\n", "\n", " ", ""]
    ...
    def build_import_rag_files_request(
        ...
        Args:
            ...
            chunking_strategy: LoveEngine unified chunking config
