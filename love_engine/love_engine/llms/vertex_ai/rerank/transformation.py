...
from love_engine.llms.vertex_ai.common_utils import (
    vertex_request_labels_from_love_engine_params,
)
...
from love_engine.types.rerank import (
    RerankBilledUnits,
    RerankResponse,
    RerankResponseMeta,
...
class VertexAIRerankConfig(BaseRerankConfig, VertexBase):
    ...
    def get_complete_url(
        ...
        # Fallback to environment or love_engine config
        project_id = (
            vertex_project
        ...
        if not project_id:
            raise ValueError(
                "Vertex AI project ID is required. Please set 'VERTEXAI_PROJECT', 'love_engine.vertex_project', or pass 'vertex_project' parameter"
            )
    ...
    def validate_environment(
        ...
        love_engine_params = optional_params.copy() if optional_params else {}
    ...
    def transform_rerank_request(
        ...
        user_labels = vertex_request_labels_from_love_engine_params(love_engine_params)
        if user_labels:
