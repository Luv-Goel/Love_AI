...
from love_engine.types.fine_tuning import OpenAIFineTuningHyperparameters
from love_engine.types.llms.openai import FineTuningJobCreate
...
class VertexFineTuningAPI(VertexLLM):
    ...
    def convert_vertex_response_to_open_ai_response(
        ...
        return LoveEngineFineTuningJob(
