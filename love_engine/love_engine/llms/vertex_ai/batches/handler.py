...
import love_engine
from love_engine.love_engine_core_utils.url_utils import (
    async_safe_get,
...
from love_engine.types.llms.openai import CreateBatchRequest
...
class VertexAIBatchPrediction(VertexLLM):
    ...
    async def _async_create_batch(
        ...
        try:
            ...
            love_engine.verbose_logger.error(
            ...
            if isinstance(logging_obj, Logging):
                logging_obj.pre_call(
                    ...
                    additional_args={
                        ...
                        "headers": headers,
                        "request_str": (
                            f"\nGET Request Sent from LoveEngine:\n"
                            f"curl -X GET \\\n"
                            f"{api_base} \\\n"
