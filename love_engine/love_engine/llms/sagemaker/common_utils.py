...
from love_engine.types.utils import StreamingChatCompletionChunk
...
def _load_sagemaker_response_stream_shape():
    try:
        ...
        verbose_logger.warning(
            "love_engine: could not load sagemaker-runtime response stream shape "
        ...
        for chunk in iterator:
            ...
            for event in event_stream_buffer:
                ...
                if message:
                    ...
                    message = (
                        love_engine.CustomStreamWrapper._strip_sse_data_from_chunk(message)
                        or ""
                    )
            ...
            for event in event_stream_buffer:
                try:
                    ...
                    if message:
                        ...
                        # remove data: prefix and "\n\n" at the end
                        message = (
                            love_engine.CustomStreamWrapper._strip_sse_data_from_chunk(
                                message
                            )
                            or ""
                        )
