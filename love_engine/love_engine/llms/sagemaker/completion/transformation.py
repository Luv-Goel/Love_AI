...
class SagemakerConfig(BaseConfig):
    ...
    def transform_request(
        ...
        custom_prompt_dict = (
            love_engine_params.get("custom_prompt_dict", None) or love_engine.custom_prompt_dict
        )
    ...
    def transform_response(
        ...
        try:
            ...
            raise SagemakerError(
                message=f"love_engine Error: Unable to parse sagemaker RAW RESPONSE {json.dumps(completion_response)}",
                status_code=500,
            )
