...
from love_engine.llms.custom_httpx.http_handler import _get_httpx_client, HTTPHandler
...
def fetch_credentials(
    ...
    **kwargs,
    ...
    service_key = _parse_service_key_once(
        service_key or love_engine.sap_service_key or os.environ.get(SERVICE_KEY_ENV_VAR)
    )
