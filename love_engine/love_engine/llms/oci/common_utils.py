...
try:
    from love_engine._version import version as _love_engine_version
except ImportError:
    _love_engine_version = "0.0.0"
...
def validate_oci_environment(
    ...
    headers.setdefault("user-agent", f"love_engine/{_love_engine_version}")
    return headers
