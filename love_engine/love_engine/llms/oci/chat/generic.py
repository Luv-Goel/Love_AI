...
from love_engine.types.utils import ChatCompletionMessageToolCall, Usage
...
def handle_generic_response(
    ...
    """Parse a non-streaming GENERIC OCI response into a love_engine ModelResponse."""
    try:
...
def handle_generic_stream_chunk(dict_chunk: dict) -> ModelResponseStream:
    """Parse a single GENERIC SSE chunk into a love_engine ModelResponseStream."""
