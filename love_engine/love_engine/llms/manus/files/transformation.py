...
from love_engine.types.files import TwoStepFileUploadConfig, TwoStepFileUploadRequest
...
class ManusFilesConfig(BaseFilesConfig):
    ...
    def validate_environment(
        ...
        """
        api_key = api_key or love_engine.api_key or get_secret_str("MANUS_API_KEY")
    ...
    def transform_create_file_request(
        ...
        # Get API key
        api_key = (
            love_engine_params.get("api_key")
    ...
    def transform_create_file_response(
        ...
        For two-step uploads, the handler stores the initial response in love_engine_params.
        ...
        """
        try:
            # For two-step uploads, get the initial response from love_engine_params
            initial_response_data = love_engine_params.get("initial_file_response")
