...
from love_engine.llms.openai.common_utils import OpenAIError
...
class GroqChatConfig(OpenAILikeChatConfig):
    ...
    def get_supported_openai_params(self, model: str) -> list:
        ...
        try:
            if love_engine.supports_reasoning(
    ...
    def _transform_messages(
        ...
        for idx, message in enumerate(messages):
            """
            1. Don't pass 'null' function_call assistant message to groq - https://github.com/BerriAI/love_engine/issues/5839
            """
    ...
    def map_openai_params(
        ...
        if _response_format is not None and isinstance(_response_format, dict):
            ...
            if json_schema is not None:
                ...
                if not love_engine.supports_response_schema(
                    ...
                    if "tools" in non_default_params:
                        raise love_engine.BadRequestError(
                            ...
                            "love_engine uses a tool-calling workaround for structured outputs on this model, "
...
class GroqChatCompletionStreamingHandler(OpenAIChatCompletionStreamingHandler):
    def chunk_parser(self, chunk: dict) -> ModelResponseStream:
        ...
        # Map Groq's 'reasoning' field to love_engine's 'reasoning_content' field
        # Groq returns delta.reasoning, but love_engine expects delta.reasoning_content
