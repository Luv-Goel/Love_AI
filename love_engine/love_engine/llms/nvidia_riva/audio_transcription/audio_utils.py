...
from love_engine.llms.nvidia_riva.common_utils import NvidiaRivaException
...
_INSTALL_HINT = (
    ...
    "`pip install 'love_engine[stt-nvidia-riva]'`"
)
    ...
    try:
        ...
        raise NvidiaRivaException(
            ...
            message=(
                ...
                f"(`pip install 'love_engine[stt-nvidia-riva]'`) or convert your "
