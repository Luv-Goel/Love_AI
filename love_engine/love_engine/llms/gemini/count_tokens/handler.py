...
if TYPE_CHECKING:
    from love_engine.types.google_genai.main import GenerateContentContentListUnionDict
else:
...
class GoogleAIStudioTokenCounter:
    ...
    async def validate_environment(
        ...
        """
        from love_engine.llms.gemini.google_genai.transformation import GoogleGenAIConfig
    ...
    async def acount_tokens(
        ...
        **kwargs,
        ...
        Raises:
            ...
            love_engine.APIError: If the API call fails
            love_engine.APIConnectionError: If the connection fails
