...
from love_engine.utils import get_empty_usage
...
class GeminiRealtimeConfig(BaseRealtimeConfig):
    ...
    def transform_response_done_event(
        ...
        responses_api_usage = LoveEngineCompletionResponsesConfig._transform_chat_completion_usage_to_responses_usage(
    ...
    def transform_realtime_response(
        ...
        for key, value in list(json_message.items()):
            ...
            if openai_event == OpenAIRealtimeEventTypes.SESSION_CREATED:
                ...
                tool_call_responses_api_usage = LoveEngineCompletionResponsesConfig._transform_chat_completion_usage_to_responses_usage(
                    _tool_call_chat_completion_usage,
                )
    ...
    def requires_session_configuration(self) -> bool:
        ...
        #   love_engine.gemini_live_defer_setup = True
        return not love_engine.gemini_live_defer_setup
