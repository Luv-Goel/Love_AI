...
class GoogleGenAIConfig(BaseGoogleGenAIGenerateContentConfig, VertexLLM):
    ...
    def map_generate_content_optional_params(
        ...
        """
        from love_engine.llms.vertex_ai.gemini.transformation import (
            _camel_to_snake,
            _snake_to_camel,
        )
    ...
    def validate_environment(
        ...
        # Use the passed api_key first, then fall back to love_engine_params and environment
        gemini_api_key = api_key or self._get_google_ai_studio_api_key(
            dict(love_engine_params or {})
        )
    ...
    def _get_google_ai_studio_api_key(self, love_engine_params: dict) -> Optional[str]:
        return (
            love_engine_params.pop("api_key", None)
            or love_engine_params.pop("gemini_api_key", None)
    ...
    def _get_common_auth_components(
        ...
        """
        vertex_credentials = self.get_vertex_ai_credentials(love_engine_params)
        vertex_project = self.get_vertex_ai_project(love_engine_params)
        vertex_location = self.get_vertex_ai_location(love_engine_params)
    ...
    def _build_final_headers_and_url(
        ...
        """
        gemini_api_key = self._get_google_ai_studio_api_key(love_engine_params)
    ...
    def sync_get_auth_token_and_url(
        ...
        (
            ...
            vertex_project,
            vertex_location,
        ) = self._get_common_auth_components(love_engine_params)
    ...
    def transform_generate_content_response(
        ...
        """
        from love_engine.types.google_genai.main import GenerateContentResponse
