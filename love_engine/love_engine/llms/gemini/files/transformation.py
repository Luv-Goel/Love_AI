...
from love_engine.types.llms.gemini import GeminiCreateFilesResponseObject
...
class GoogleAIStudioFilesHandler(GeminiModelInfo, BaseFilesConfig):
    ...
    def validate_environment(
        ...
        love_engine_params: dict[Any, Any],
    ...
    def get_complete_url(
        ...
        final_api_key = api_key or love_engine_params.get("api_key") or self.get_api_key()
    ...
    def transform_retrieve_file_request(
        ...
        """
        api_key = love_engine_params.get("api_key") or self.get_api_key()
        if not api_key:
            raise ValueError("api_key is required")
        ...
        api_base = (
            self.get_api_base(love_engine_params.get("api_base"))
    ...
    def transform_delete_file_request(
        ...
        Args:
            ...
            love_engine_params: love_engine parameters containing api_key

        Returns:
            tuple[str, dict]: (url, params) for the DELETE request
        """
        api_base = self.get_api_base(love_engine_params.get("api_base"))
        if not api_base:
            raise ValueError("api_base is required")
