...
def supports_gemini_image_size(model: str) -> bool:
    try:
        model_info = love_engine.get_model_info(model=model)
...
class GeminiModelInfo(BaseLLMModelInfo):
    ...
    def process_model_name(self, models: List[Dict[str, str]]) -> List[str]:
        ...
        for model in models:
            ...
            love_engine_model_name = "gemini/" + stripped_model_name
    ...
    def get_models(
        ...
        love_engine_model_names = self.process_model_name(models)
        return love_engine_model_names
...
class GoogleAIStudioTokenCounter(BaseTokenCounter):
    ...
    async def count_tokens(
        ...
        from love_engine.llms.gemini.count_tokens.handler import GoogleAIStudioTokenCounter
