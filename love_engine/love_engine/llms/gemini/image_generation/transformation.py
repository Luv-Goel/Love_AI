...
from love_engine.llms.gemini.image_usage_transformation import (
    transform_gemini_image_usage,
)
from love_engine.secret_managers.main import get_secret_str
from love_engine.types.llms.gemini import GeminiImageGenerationRequest
...
class GoogleImageGenConfig(BaseImageGenerationConfig):
    ...
    def transform_image_generation_response(
        ...
        """
        Transform Google AI Imagen response to love_engine ImageResponse format
        """
        try:
