...
def get_nvidia_nim_rerank_config(model: str):
    ...
    """
    from love_engine.llms.nvidia_nim.rerank.ranking_transformation import (
        NvidiaNimRankingConfig,
    )
    from love_engine.llms.nvidia_nim.rerank.transformation import NvidiaNimRerankConfig
