...
from love_engine.types.llms.openai import AllMessageValues, CreateBatchRequest
from love_engine.types.utils import LoveEngineBatch, LlmProviders, ModelResponse
...
class AnthropicBatchesConfig(BaseBatchesConfig):
    ...
    def transform_create_batch_response(
        ...
        """
        Transform Anthropic MessageBatch creation response to love_engine format.
    ...
    def transform_retrieve_batch_response(
        ...
        """Transform Anthropic MessageBatch retrieval response to love_engine format."""
        try:
