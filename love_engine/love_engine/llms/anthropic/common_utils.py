...
class AnthropicModelInfo(BaseLLMModelInfo):
    ...
    def _apply_sampling_param(
        ...
        if AnthropicModelInfo._supports_sampling_params(model) or (
        ...
        elif not (love_engine.drop_params or drop_params):
            supported_hint = (
            ...
            raise love_engine.utils.UnsupportedParamsError(
                message=(
                    ...
                    "To drop unsupported params, set `love_engine.drop_params = True`."
                ),
                status_code=400,
            )
    ...
    def _get_model_capability(model: str, key: str) -> Optional[bool]:
        ...
        try:
            for cand in AnthropicModelInfo._model_map_lookup_candidates(model):
                value = love_engine.model_cost.get(cand, {}).get(key)
    ...
    def get_anthropic_beta_list(
        ...
        """
        from love_engine.types.llms.anthropic import ANTHROPIC_EFFORT_BETA_HEADER
    ...
    def get_anthropic_headers(
        ...
        if tool_search_used or programmatic_tool_calling_used or input_examples_used:
            from love_engine.types.llms.anthropic import ANTHROPIC_TOOL_SEARCH_BETA_HEADER
    ...
    def get_models(
        ...
        for model in models:
            ...
            love_engine_model_name = "anthropic/" + stripped_model_name
    ...
    def get_token_counter(self) -> Optional[BaseTokenCounter]:
        ...
        """
        from love_engine.llms.anthropic.count_tokens.token_counter import (
