...
class LoveEngineAnthropicToResponsesAPIAdapter:
    """
    ...
    def translate_request(
        ...
        love_engine.responses() / love_engine.aresponses() kwargs.
        """
    ...
    def translate_response(
        ...
        from love_engine.types.llms.openai import ResponseAPIUsage
