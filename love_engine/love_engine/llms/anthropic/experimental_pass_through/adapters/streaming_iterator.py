...
from love_engine.types.utils import AdapterCompletionStreamWrapper
...
class AnthropicStreamWrapper(AdapterCompletionStreamWrapper):
    ...
    def __next__(self):
        from .transformation import LoveEngineAnthropicMessagesAdapter
        ...
        try:
            ...
            for chunk in self.completion_stream:
                ...
                processed_chunk = LoveEngineAnthropicMessagesAdapter().translate_streaming_openai_response_to_anthropic(
                    response=chunk,
    ...
    def _should_start_new_content_block(self, chunk: "ModelResponseStream") -> bool:
        ...
        (
            block_type,
            content_block_start,
        ) = LoveEngineAnthropicMessagesAdapter()._translate_streaming_openai_chunk_to_anthropic_content_block(
        ...
        if block_type == "tool_use":
            ...
            from love_engine.types.llms.anthropic import ToolUseBlock
