...
from love_engine.types.llms.anthropic_tool_search import get_tool_search_beta_header
...
class AnthropicMessagesConfig(BaseAnthropicMessagesConfig):
    ...
    def _translate_reasoning_effort_to_anthropic(
        ...
        """
        from love_engine.exceptions import BadRequestError as _BadRequestError
