...
class BaseAnthropicMessagesStreamingIterator:
    ...
    def __init__(
        ...
        self.love_engine_logging_obj = love_engine_logging_obj
    ...
    async def _handle_streaming_logging(self, collected_chunks: List[bytes]):
        ...
        from love_engine.proxy.pass_through_endpoints.streaming_handler import (
        ...
        if self.completion_start_time is not None:
            self.love_engine_logging_obj.completion_start_time = self.completion_start_time
            self.love_engine_logging_obj.model_call_details["completion_start_time"] = (
                self.completion_start_time
            )
        asyncio.create_task(
            PassThroughStreamingHandler._route_streaming_logging_to_handler(
                love_engine_logging_obj=self.love_engine_logging_obj,
