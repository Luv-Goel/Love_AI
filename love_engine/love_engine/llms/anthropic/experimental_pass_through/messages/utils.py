...
from love_engine.types.llms.anthropic import AnthropicMessagesRequestOptionalParams
...
def mock_response(
    ...
    **kwargs,
    ...
    if mock_response == "love_engine.InternalServerError":
        raise InternalServerError(
            message="this is a mock internal server error",
            llm_provider="anthropic",
            model=model,
        )
    elif mock_response == "love_engine.ContextWindowExceededError":
        raise ContextWindowExceededError(
            message="this is a mock context window exceeded error",
            llm_provider="anthropic",
            model=model,
        )
    elif mock_response == "love_engine.RateLimitError":
