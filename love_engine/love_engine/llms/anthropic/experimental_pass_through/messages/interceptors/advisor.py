...
import love_engine.constants as _c
from love_engine.llms.anthropic.common_utils import strip_advisor_blocks_from_messages
from love_engine.types.llms.anthropic_messages.anthropic_response import (
    AnthropicMessagesResponse,
)
from love_engine.types.llms.anthropic import ANTHROPIC_ADVISOR_TOOL_TYPE
...
class AdvisorOrchestrationHandler(MessagesInterceptor):
    ...
    async def handle(
        ...
        **kwargs,
        ...
        # If not set in the tool definition, love_engine resolves from env vars.
        ...
        parent_request_id: str = str(
            kwargs.pop("love_engine_call_id", None) or uuid.uuid4()
        )
        ...
        while True:
            ...
            advisor_response: AnthropicMessagesResponse = await _call_messages_handler(
                ...
                stream=False,
                max_tokens=max_tokens,
                custom_llm_provider=None,  # let love_engine resolve from model name
                metadata={
                    **metadata_base,
...
async def _call_messages_handler(
    ...
    **kwargs,
    ...
    """
    from love_engine.llms.anthropic.experimental_pass_through.messages.handler import (
        anthropic_messages,
    )
