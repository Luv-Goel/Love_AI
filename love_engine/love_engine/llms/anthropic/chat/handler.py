...
async def make_call(
    ...
    try:
        ...
        for exception in love_engine.LOVE_ENGINE_EXCEPTION_TYPES:
...
def make_sync_call(
    ...
    if client is None:
        client = love_engine.module_level_client  # re-use a module level client
    ...
    async def acompletion_stream_function(
        ...
        completion_stream, headers = await make_call(
            ...
            tool_name_reverse_map=(
                love_engine_params.get(ANTHROPIC_TOOL_NAME_REVERSE_MAP_KEY)
...
class ModelResponseIterator:
            ...
            if type_chunk == "content_block_delta":
                ...
                if content_block_start["content_block"]["type"] == "text":
                    ...
                    if content_type == "web_search_tool_result":
                        ...
                        # The full content comes in content_block_start, not in deltas
                        # Fixes: https://github.com/BerriAI/love_engine/issues/18137
                        self.web_search_results.append(
                            content_block_start["content_block"]
                        )
                        provider_specific_fields["web_search_results"] = (
    ...
    def _handle_accumulated_json_chunk(
        ...
        across TCP packets. See: https://github.com/BerriAI/love_engine/issues/17473
