...
from love_engine.llms.anthropic.chat.transformation import AnthropicConfig
...
from love_engine.llms.base_llm.guardrail_translation.utils import (
    effective_skip_system_message_for_guardrail,
    effective_skip_tool_message_for_guardrail,
    openai_messages_without_system,
    openai_messages_without_tool,
)
from love_engine.proxy.pass_through_endpoints.llm_provider_handlers.anthropic_passthrough_logging_handler import (
...
class AnthropicMessagesHandler(BaseTranslation):
    ...
    def __init__(self):
        super().__init__()
        self.adapter = LoveEngineAnthropicMessagesAdapter()
        ...
        if has_ended:
            ...
            built_response = (
                AnthropicPassthroughLoggingHandler._build_complete_streaming_response(
                    ...
                    love_engine_logging_obj=cast("LoveEngineLoggingObj", love_engine_logging_obj),
                    model="",
                )
            )
