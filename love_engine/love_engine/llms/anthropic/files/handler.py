...
from love_engine.types.utils import CallTypes, LlmProviders, ModelResponse
        ...
        try:
            ...
            model_response.choices = [
                love_engine.Choices(
                    finish_reason="stop",
                    index=0,
                    message=love_engine.Message(content="", role="assistant"),
                )
            ]  # type: ignore
            ...
            logging_obj = Logging(
                ...
                love_engine_call_id="batch_" + str(uuid.uuid4()),
                function_id="batch_processing",
                love_engine_trace_id=str(uuid.uuid4()),
