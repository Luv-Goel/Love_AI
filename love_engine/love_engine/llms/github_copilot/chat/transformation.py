...
from love_engine.types.llms.openai import AllMessageValues, ChatCompletionToolCallChunk
...
class GithubCopilotConfig(OpenAIConfig):
    ...
    def _transform_messages(
        ...
        if love_engine.disable_copilot_system_to_assistant:
    ...
    def transform_response(
        ...
        See: https://github.com/BerriAI/love_engine/issues/29391
        """
        try:
