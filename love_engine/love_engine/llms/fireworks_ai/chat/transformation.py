...
class FireworksAIConfig(OpenAIGPTConfig):
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            if param == "tool_choice":
                if value == "required":
                    # relevant issue: https://github.com/BerriAI/love_engine/issues/4416
    ...
    def _transform_messages_helper(
        self, messages: List[AllMessageValues], model: str, love_engine_params: dict
        ...
        disable_add_transform_inline_image_block = cast(
            Optional[bool],
            love_engine_params.get("disable_add_transform_inline_image_block")
            or love_engine.disable_add_transform_inline_image_block,
        )
    ...
    # Cached index of fireworks_ai/* entries from love_engine.model_cost. Building
    ...
    def _get_fireworks_index(cls) -> List[Tuple[str, dict]]:
        model_cost = love_engine.model_cost
    ...
    def _get_model_cost_capability(self, model: str, capability: str) -> Optional[bool]:
        ...
        for candidate_key in candidate_keys:
            model_info = love_engine.model_cost.get(candidate_key)
    ...
    def _handle_message_content_with_tool_calls(
        ...
        Relevant Issue: https://github.com/BerriAI/love_engine/issues/7209#issuecomment-2813208780
        """
        if (
