...
from love_engine.llms.langgraph.chat.sse_iterator import LangGraphSSEStreamIterator
...
class LangGraphConfig(BaseConfig):
    ...
    def transform_response(
        ...
        """
        Transform the LangGraph response to love_engine ModelResponse format.
        """
        try:
