...
from love_engine.types.utils import TextChoices
from love_engine.utils import CustomStreamWrapper, TextCompletionResponse
...
class CodestralTextCompletion:
    ...
    def output_parser(self, generated_text: str):
        ...
        Initial issue that prompted this - https://github.com/BerriAI/love_engine/issues/763
        """
    ...
    def process_text_completion_response(
        ...
        for choice in _original_choices:
            ...
            _choice = love_engine.utils.TextChoices(
    ...
    def completion(
        ...
        ## Load Config
        config = love_engine.CodestralTextCompletionConfig.get_config()
        ...
        ### SYNC STREAMING
        if stream is True:
            response = love_engine.module_level_client.post(
                completion_url,
                headers=headers,
    ...
    async def async_completion(
        ...
        async_handler = get_async_httpx_client(
            llm_provider=love_engine.LlmProviders.TEXT_COMPLETION_CODESTRAL,
