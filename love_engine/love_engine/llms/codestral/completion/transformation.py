...
import love_engine
from love_engine.llms.openai.completion.transformation import OpenAITextCompletionConfig
from love_engine.types.llms.databricks import GenericStreamingChunk
...
class CodestralTextCompletionConfig(OpenAITextCompletionConfig):
    ...
    def _chunk_parser(self, chunk_data: str) -> GenericStreamingChunk:
        ...
        chunk_data = (
            love_engine.CustomStreamWrapper._strip_sse_data_from_chunk(chunk_data) or ""
        )
        ...
        original_chunk = love_engine.ModelResponseStream(**chunk_data_dict)
