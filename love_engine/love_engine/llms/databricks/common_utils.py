"""
Databricks integration utilities for love_engine.
...
class DatabricksBase:
    ...
    def _build_user_agent(custom_user_agent: Optional[str] = None) -> str:
        ...
        is extracted and prefixed to the love_engine user agent with an underscore.
        The custom version is ignored; love_engine's version is always used.
        ...
        Returns:
            ...
            - Default: "love_engine/{version}"
            - With custom: "{partner}_love_engine/{version}"

        Examples:
            - None -> "love_engine/1.79.1"
            - "mycompany/1.0.0" -> "mycompany_love_engine/1.79.1"
            - "partner_product/2.0.0" -> "partner_product_love_engine/1.79.1"
            - "acme" -> "acme_love_engine/1.79.1"
        """
        try:
        ...
        if custom_user_agent:
            ...
            if (
                ...
                return f"{partner_name}_love_engine/{version}"

        # Default: just love_engine
        return f"love_engine/{version}"
    ...
    def _get_databricks_credentials(
        ...
        Also registers love_engine as a partner for proper telemetry attribution
        ...
        try:
            ...
            # Register love_engine as partner for Databricks telemetry attribution
            useragent.with_partner("love_engine")
