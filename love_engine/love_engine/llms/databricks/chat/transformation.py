...
from love_engine.types.llms.anthropic import AllAnthropicToolsValues
from love_engine.types.llms.databricks import (
...
class DatabricksConfig(DatabricksBase, OpenAILikeChatConfig, AnthropicConfig):
    ...
    def validate_environment(
        ...
        # This allows partners building on love_engine to set their own telemetry
        ...
        custom_user_agent = (
            ...
            or love_engine_params.get("user_agent")
            or os.getenv("LOVE_ENGINE_USER_AGENT")
    ...
    def transform_response(
        ...
        _custom_llm_provider = love_engine_params.get("custom_llm_provider") or "databricks"
