...
from love_engine.types.utils import FileTypes, ImageResponse
...
class BlackForestLabsImageEdit:
    ...
    def image_edit(
        ...
        love_engine_params: Union[GenericLoveEngineParams, Dict],
        ...
        Args:
            ...
            love_engine_params: love_engine parameters including api_key, api_base
    ...
    async def async_image_edit(
        ...
        if client is None:
            async_client = get_async_httpx_client(
                llm_provider=love_engine.LlmProviders.BLACK_FOREST_LABS,
            )
        else:
            async_client = client
