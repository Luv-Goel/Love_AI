...
# File-type inputs are preprocessed to this format in love_engine/ocr/main.py.
DocumentType = Dict[str, str]


class OCRPageDimensions(LoveEnginePydanticObjectBase):
...
class OCRPageImage(LoveEnginePydanticObjectBase):
...
class OCRPage(LoveEnginePydanticObjectBase):
...
class OCRUsageInfo(LoveEnginePydanticObjectBase):
...
class OCRResponse(LoveEnginePydanticObjectBase):
    """
...
class OCRRequestData(LoveEnginePydanticObjectBase):
...
class BaseOCRConfig:
    ...
    def transform_ocr_request(
        ...
        **kwargs,
        ...
        the preprocessing in love_engine/ocr/main.py.
