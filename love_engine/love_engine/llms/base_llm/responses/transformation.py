...
class BaseResponsesAPIConfig(ABC):
    ...
    def supports_native_file_search(self) -> bool:
        ...
        love_engine emulation (e.g. OpenAI, Azure OpenAI).
        """
        return False
    ...
    def should_fake_stream(
        ...
        """Returns True if love_engine should fake a stream for the given model and stream value"""
        return False
    ...
    def get_websocket_url(
        ...
        http_url = self.get_complete_url(
            api_base=api_base, love_engine_params=love_engine_params
        )
