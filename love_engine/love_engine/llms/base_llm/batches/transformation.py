...
class BaseBatchesConfig(ABC):
    ...
    must implement to work with love_engine's unified batch processing system.
    """
    ...
    def transform_create_batch_response(
        ...
        """
        Transform provider-specific batch response to love_engine format.
    ...
    def transform_retrieve_batch_response(
        ...
        """
        Transform provider-specific batch retrieval response to love_engine format.
