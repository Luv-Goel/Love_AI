...
class BaseRealtimeHTTPConfig(ABC):
    ...
    def get_api_base(
        ...
        **kwargs,
        ...
        Resolution order (provider-specific):
          explicit api_base → love_engine.api_base → env var → hard-coded default
        """
    ...
    def get_api_key(
        ...
        **kwargs,
        ...
        Resolution order (provider-specific):
          explicit api_key → love_engine.api_key → env var → ""
        """
    ...
    def get_error_class(
        ...
        """
        Map HTTP errors to love_engine exception types.
