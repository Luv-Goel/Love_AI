...
import love_engine
from love_engine.llms.base_llm.realtime.http_transformation import BaseRealtimeHTTPConfig
...
class AzureRealtimeHTTPConfig(BaseRealtimeHTTPConfig):
    def get_api_base(self, api_base: Optional[str], **kwargs) -> str:
        return api_base or love_engine.api_base or get_secret_str("AZURE_API_BASE") or ""

    def get_api_key(self, api_key: Optional[str], **kwargs) -> str:
        return api_key or love_engine.api_key or get_secret_str("AZURE_API_KEY") or ""
