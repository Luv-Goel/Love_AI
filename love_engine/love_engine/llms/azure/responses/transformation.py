...
class AzureOpenAIResponsesAPIConfig(OpenAIResponsesAPIConfig):
    ...
    def get_complete_url(
        ...
        - api_base: Base URL, e.g.,
            ...
            OR
            "https://love_engine8397336933.openai.azure.com/openai/responses?api-version=2024-05-01-preview"
        - model: Model name.
        ...
        "https://love_engine8397336933.openai.azure.com/openai/responses?api-version=2024-05-01-preview"
        """
        from love_engine.constants import AZURE_DEFAULT_RESPONSES_API_VERSION
    ...
    def transform_cancel_response_api_response(
        ...
        try:
            ...
            from love_engine.llms.azure.chat.gpt_transformation import AzureOpenAIError
