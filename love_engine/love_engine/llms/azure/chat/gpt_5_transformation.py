...
import love_engine
from love_engine.exceptions import UnsupportedParamsError
from love_engine.llms.openai.chat.gpt_5_transformation import (
    OpenAIGPT5Config,
    _get_effort_level,
)
            ...
            if love_engine.drop_params is True or (
                ...
                raise UnsupportedParamsError(
                    ...
                    message=(
                        ...
                        "To drop this parameter, set `love_engine.drop_params=True` or for proxy:\n\n"
                        "`love_engine_settings:\n drop_params: true`\n"
                        "Issue: https://github.com/BerriAI/love_engine/issues/16704"
                    ),
                )
