...
from love_engine.utils import get_model_info, supports_reasoning
...
class AzureOpenAIO1Config(OpenAIOSeriesConfig):
    def get_supported_openai_params(self, model: str) -> list:
        ...
        """
        all_openai_params = love_engine.OpenAIGPTConfig().get_supported_openai_params(
            model=model
        )
    ...
    def _get_o_series_only_params(self, model: str) -> list:
        ...
        #########################################################
        # Case 1: If the model is recognized and in love_engine model cost map
        # then check if it supports reasoning
        #########################################################
        if model in love_engine.model_list_set:
    ...
    def should_fake_stream(
        ...
        ):  # o3 models support streaming - https://github.com/BerriAI/love_engine/issues/8274
            return False
