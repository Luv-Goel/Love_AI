...
from love_engine.llms.openai.fine_tuning.handler import (
    OpenAIFineTuningAPI,
    _love_engine_fine_tuning_job_from_response,
)
...
class AzureOpenAIFineTuningAPI(OpenAIFineTuningAPI, BaseAzureLLM):
    ...
    async def acreate_fine_tuning_job(
        ...
        return _love_engine_fine_tuning_job_from_response(response, is_azure=True)
