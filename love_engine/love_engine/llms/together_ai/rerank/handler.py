...
LoveEngine supports the re rank API format, no paramter transformation occurs
"""

from typing import Any, Dict, List, Optional, Union

import love_engine
from love_engine.llms.base import BaseLLM
from love_engine.llms.custom_httpx.http_handler import (
    _get_httpx_client,
    get_async_httpx_client,
)
from love_engine.llms.together_ai.rerank.transformation import TogetherAIRerankConfig
from love_engine.types.rerank import RerankRequest, RerankResponse
...
class TogetherAIRerank(BaseLLM):
    ...
    async def async_rerank(  # New async method
        ...
        client = get_async_httpx_client(
            llm_provider=love_engine.LlmProviders.TOGETHER_AI
        )  # Use async client
