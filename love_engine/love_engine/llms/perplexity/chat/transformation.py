...
from love_engine.types.utils import Usage, PromptTokensDetailsWrapper
...
from love_engine.types.llms.openai import ChatCompletionAnnotation
from love_engine.types.llms.openai import ChatCompletionAnnotationURLCitation
...
class PerplexityChatConfig(OpenAIGPTConfig):
    ...
    def get_supported_openai_params(self, model: str) -> list:
        ...
        try:
            if love_engine.supports_web_search(
                model=model, custom_llm_provider=self.custom_llm_provider
            ):
    ...
    def _enhance_usage_with_perplexity_fields(
        ...
        and add them to the usage object using standard love_engine fields.
        """
