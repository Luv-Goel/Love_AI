...
class OpenAIGPT5Config(OpenAIGPTConfig):
    ...
    def get_supported_openai_params(self, model: str) -> list:
        ...
        from love_engine.utils import supports_tool_choice
    ...
    def map_openai_params(
        ...
        if effective_effort == "xhigh":
            ...
            if not self._supports_reasoning_effort_level(model, effective_effort):
                if love_engine.drop_params or drop_params:
        ...
        # Relevant issue: https://github.com/BerriAI/love_engine/issues/13381
        ################################################################
        if "max_tokens" in non_default_params:
            optional_params["max_completion_tokens"] = non_default_params.pop(
                "max_tokens"
        ...
        if "temperature" in non_default_params:
            ...
            if temperature_value is not None:
                ...
                if supports_none and (
                    ...
                    optional_params["temperature"] = temperature_value
                elif love_engine.drop_params or drop_params:
                    pass
                else:
                    raise love_engine.utils.UnsupportedParamsError(
                        message=(
