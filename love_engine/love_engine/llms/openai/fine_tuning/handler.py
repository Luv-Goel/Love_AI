...
# because LoveEngineFineTuningJob schema has no intermediate cancellation state.
...
def _love_engine_fine_tuning_job_from_response(
...
class OpenAIFineTuningAPI:
    ...
    async def acreate_fine_tuning_job(
        ...
        return _love_engine_fine_tuning_job_from_response(response)
