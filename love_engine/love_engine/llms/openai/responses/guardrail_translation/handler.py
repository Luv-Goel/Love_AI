...
from love_engine.llms.base_llm.guardrail_translation.base_translation import BaseTranslation
...
if TYPE_CHECKING:
    ...
    from love_engine.types.utils import ResponsesAPIResponse
...
class OpenAIResponsesHandler(BaseTranslation):
    ...
    def get_structured_messages(self, data: dict) -> Optional[List[AllMessageValues]]:
        ...
        if input_data is None:
            return None
        messages = (
            LoveEngineCompletionResponsesConfig.transform_responses_api_input_to_messages(
                input=input_data,
    ...
    def _extract_and_transform_tools(
        ...
        Uses the love_engine transformation function to convert Responses API tools
    ...
    def _remap_tools_to_responses_api_format(
        ...
        """
        return LoveEngineCompletionResponsesConfig.transform_chat_completion_tool_params_to_responses_api_tools(
    ...
    async def process_output_response(
        ...
        Args:
            response: love_engine ResponsesAPIResponse object
            guardrail_to_apply: The guardrail instance to apply
            love_engine_logging_obj: Optional logging object
        ...
        if texts_to_check or tool_calls_to_check:
            ...
            if "love_engine_metadata" not in request_data:
                user_metadata = self.transform_user_api_key_dict_to_metadata(
                    user_api_key_dict
                )
                if user_metadata:
                    request_data["love_engine_metadata"] = user_metadata
    ...
    async def process_output_streaming_response(
        ...
        # Accept both plain dicts and Pydantic models (BaseLoveEngineOpenAIResponseObject
