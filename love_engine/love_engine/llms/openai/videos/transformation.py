...
from love_engine.llms.openai.image_edit.transformation import ImageEditRequestUtils
from love_engine.secret_managers.main import get_secret_str
from love_engine.types.llms.openai import CreateVideoRequest
...
class OpenAIVideoConfig(BaseVideoConfig):
    ...
    def _decode_character_ids_in_create_video_request(self, request_dict: Dict) -> Dict:
        """
        Decode love_engine-managed encoded character ids for provider requests.
