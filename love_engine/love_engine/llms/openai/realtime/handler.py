...
This requires websockets, and is currently only supported on love_engine Proxy.
"""
...
from ....love_engine_core_utils.realtime_streaming import (
    RealTimeStreaming,
        ...
        try:
            ...
            if not openai_beta_realtime:
                verbose_logger.debug(
                    ...
                    "to the WebSocket headers sent to the love_engine proxy."
                )
            ...
            async with websockets.connect(  # type: ignore
                ...
                realtime_streaming = RealTimeStreaming(
                    ...
                    request_data={"love_engine_metadata": love_engine_metadata or {}},
