...
class VolcEngineResponsesAPIConfig(OpenAIResponsesAPIConfig):
    _SUPPORTED_OPTIONAL_PARAMS: List[str] = [
        ...
        "expire_at",
        "context_management",
        # LoveEngine-internal metadata (not sent to provider)
        "metadata",
    ...
    def validate_environment(
        ...
        elif isinstance(love_engine_params, dict):
            love_engine_params = GenericLoveEngineParams(**love_engine_params)
    ...
    def map_openai_params(
        ...
        # LoveEngine metadata is internal-only; don't send to provider
