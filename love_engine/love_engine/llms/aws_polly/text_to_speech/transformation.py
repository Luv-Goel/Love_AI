...
class AWSPollyTextToSpeechConfig(BaseTextToSpeechConfig, BaseAWSLLM):
    ...
    def dispatch_text_to_speech(
        ...
        **kwargs: Any,
        ...
        # Update love_engine_params with resolved values
        # Note: AWS credentials (aws_access_key_id, aws_secret_access_key, etc.)
        # are already in love_engine_params_dict via get_love_engine_params() in main.py
        love_engine_params_dict["aws_region_name"] = aws_region_name
    ...
    def get_complete_url(
        ...
        aws_region_name = love_engine_params.get("aws_region_name", self.DEFAULT_REGION)
    ...
    def _sign_polly_request(
        ...
        credentials = self.get_credentials(
            aws_access_key_id=love_engine_params.get("aws_access_key_id"),
            aws_secret_access_key=love_engine_params.get("aws_secret_access_key"),
            aws_session_token=love_engine_params.get("aws_session_token"),
            aws_region_name=aws_region_name,
            aws_session_name=love_engine_params.get("aws_session_name"),
            aws_profile_name=love_engine_params.get("aws_profile_name"),
            aws_role_name=love_engine_params.get("aws_role_name"),
            aws_web_identity_token=love_engine_params.get("aws_web_identity_token"),
            aws_sts_endpoint=love_engine_params.get("aws_sts_endpoint"),
            aws_external_id=love_engine_params.get("aws_external_id"),
        )
