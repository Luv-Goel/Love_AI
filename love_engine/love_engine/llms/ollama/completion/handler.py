...
def _process_ollama_embedding_response(
    ...
    model_response.usage = love_engine.Usage(
...
async def ollama_aembeddings(
    ...
    response = await love_engine.module_level_aclient.post(url=api_base, json=data)
...
def ollama_embeddings(
    ...
    response = love_engine.module_level_client.post(url=api_base, json=data)
    response_json = response.json()
