...
from love_engine.types.llms.openai import AllMessageValues, ChatCompletionUsageBlock
...
class OllamaConfig(BaseConfig):
    ...
    def get_api_key() -> Optional[str]:
        """Get API key from environment variables or love_engine configuration"""
        import os
    ...
    def transform_response(
        ...
        if request_data.get("format", "") == "json":
            ...
            if not response_text or not response_text.strip():
                ...
                message = love_engine.Message(content="")
    ...
    def transform_request(
        ...
        custom_prompt_dict = (
            love_engine_params.get("custom_prompt_dict") or love_engine.custom_prompt_dict
        )

        text_completion_request = love_engine_params.get("text_completion")
