...
import love_engine
from love_engine.constants import BEDROCK_EMBEDDING_PROVIDERS_LITERAL
from love_engine.llms.cohere.embed.handler import embedding as cohere_embedding
...
from love_engine.types.utils import EmbeddingResponse, LlmProviders
...
class BedrockEmbedding(BaseAWSLLM):
    ...
    def _transform_response(
        ...
        if (
            ...
            if provider == "twelvelabs":
                ...
                from love_engine.types.utils import Embedding, Usage
    ...
    async def _get_async_invoke_status(
        ...
        if logging_obj is not None:
            ...
            custom_curl = "\n\nGET Request Sent from love_engine:\n"
