...
from love_engine.types.utils import FileTypes, ImageObject, ImageResponse
...
def _supports_nova_canvas_image_edit_from_model_cost(model: str) -> bool:
    ...
    for name in candidates:
        ...
        if key is None:
            continue
        entry = _love_engine.model_cost.get(key) or {}
    ...
    def transform_image_edit_response(
        ...
        try:
            ...
            if cost_per_image is not None and model_response.data:
                model_response._hidden_params["additional_headers"][
                    "llm_provider-x-love_engine-response-cost"
...
def get_bedrock_image_edit_config_for_model(
    ...
    """
    from love_engine.llms.bedrock.image_edit.stability_transformation import (
