...
class BedrockFilesHandler(BaseAWSLLM):
    ...
    def _extract_s3_uri_from_file_id(self, file_id: str) -> str:
        ...
        2. Direct S3 URI: s3://bucket/love_engine-managed-prefix/path
        ...
        raise ValueError("file_id must be a managed love_engine S3 file id")
    ...
    def _get_configured_s3_bucket_name(self, love_engine_params: dict) -> str:
