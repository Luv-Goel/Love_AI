...
from love_engine.llms.bedrock.common_utils import BedrockError, get_bedrock_base_model
...
class BedrockTokenCounter(BaseTokenCounter):
    ...
    async def count_tokens(
        ...
        Args:
            ...
            deployment: Deployment configuration containing love_engine_params
