...
from love_engine.llms.bedrock.common_utils import get_bedrock_base_model
...
class BedrockCountTokensConfig(BaseAWSLLM):
    ...
    def get_bedrock_count_tokens_endpoint(
        ...
        """
        Construct the AWS Bedrock CountTokens API endpoint using existing love_engine functions.
        ...
        """
        # Use existing love_engine function to get the base model ID (removes region prefix)
