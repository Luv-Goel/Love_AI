...
from love_engine.llms.bedrock.image_generation.amazon_nova_canvas_transformation import (
    AmazonNovaCanvasConfig,
)
from love_engine.llms.bedrock.image_generation.amazon_stability1_transformation import (
    AmazonStabilityConfig,
)
from love_engine.llms.bedrock.image_generation.amazon_stability3_transformation import (
    AmazonStability3Config,
)
from love_engine.llms.bedrock.image_generation.amazon_titan_transformation import (
...
class BedrockImageGeneration(BaseAWSLLM):
    ...
    def get_config_class(cls, model: str | None) -> BedrockImageConfigClass:
        if AmazonTitanImageGenerationConfig._is_titan_model(model):
            ...
            return love_engine.AmazonStabilityConfig
    ...
    def _prepare_request(
        ...
        Args:
            ...
            logging_obj (LoveEngineLogging): The logging object to use for logging
