...
class BaseAWSLLM:
    ...
    def get_credentials(
        ...
        if self._is_auth_with_web_identity_token(
            ...
            if aws_session_name is None:
                aws_session_name = f"love_engine-session-{int(datetime.now().timestamp())}"
    ...
    def get_bedrock_model_id(
        ...
        if model_id is not None:
            ...
            model_id = model
            # Strip love_engine routing prefixes (e.g. "bedrock/", "invoke/",
            ...
            from love_engine.llms.bedrock.common_utils import strip_bedrock_routing_prefix
    ...
    def _get_aws_region_name(
        ...
        if aws_region_name is None:
            ...
            if (
                ...
                and love_engine_aws_region_name is not None
                and isinstance(love_engine_aws_region_name, str)
            ):
