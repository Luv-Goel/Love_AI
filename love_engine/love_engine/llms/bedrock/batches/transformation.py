...
class BedrockBatchesConfig(BaseAWSLLM, BaseBatchesConfig):
    ...
    def transform_create_batch_request(
        ...
        output_bucket = love_engine_params.get("s3_output_bucket_name") or os.getenv(
        ...
        # Get IAM role ARN
        role_arn = (
            love_engine_params.get("aws_batch_role_arn")
        ...
        if not role_arn:
            raise ValueError(
                ...
                "Set 'aws_batch_role_arn' in love_engine_params or AWS_BATCH_ROLE_ARN env var"
            )
        ...
        job_name = self.common_utils.generate_unique_job_name(model, prefix="love_engine")
        output_key = f"love_engine-batch-outputs/{job_name}/"
        ...
        s3_encryption_key_id = love_engine_params.get(
    ...
    def transform_create_batch_response(
        ...
        """
        Transform Bedrock batch creation response to love_engine format.
        """
        try:
        ...
        # Get original request data from love_engine_params if available
        original_request = love_engine_params.get("original_batch_request", {})

        # Create love_engine batch object
        return LoveEngineBatch(
    ...
    def transform_retrieve_batch_response(
        ...
        """
        Transform Bedrock batch retrieval response to love_engine format.
        """
        from love_engine.types.llms.bedrock import BedrockGetBatchResponse
