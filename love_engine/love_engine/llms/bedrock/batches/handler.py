...
class BedrockBatchesHandler:
    ...
    def _handle_model_invocation_job_status(
        ...
        **kwargs,
        ...
        ``love_engine/batches/main.py`` for the dispatch.
        ...
        Args:
            ...
            logging_obj: Optional love_engine logging object.
        ...
        Returns:
            ``LoveEngineBatch`` shaped like an OpenAI Batch resource. Note that
        ...
        # `output_file_id` field on the LoveEngineBatch itself does carry None
