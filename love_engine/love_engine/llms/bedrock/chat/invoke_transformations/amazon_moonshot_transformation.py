...
from love_engine.llms.moonshot.chat.transformation import MoonshotChatConfig
from love_engine.types.llms.openai import AllMessageValues
from love_engine.types.utils import Choices
...
class AmazonMoonshotConfig(AmazonInvokeConfig, MoonshotChatConfig):
    ...
    def _get_model_id(self, model: str) -> str:
        """
        Extract the actual model ID from the love_engine model name.
