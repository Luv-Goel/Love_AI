...
from love_engine.utils import get_base64_str
...
class AmazonTwelveLabsPegasusConfig(AmazonInvokeConfig, BaseConfig):
    ...
    def transform_response(
        ...
        """
        Transform TwelveLabs Pegasus response to love_engine format.
        ...
        # Extract finish reason and map to love_engine format
