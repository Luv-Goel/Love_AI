...
from love_engine.llms.bedrock.chat.invoke_handler import make_call, make_sync_call
...
from love_engine.utils import CustomStreamWrapper
...
class AmazonInvokeConfig(BaseConfig, BaseAWSLLM):
    ...
    def transform_request(
        ...
        custom_prompt_dict: dict = love_engine_params.pop("custom_prompt_dict", None) or {}
        hf_model_name = love_engine_params.get("hf_model_name", None)
        ...
        if provider == "cohere":
            ...
            transformed_request = (
                love_engine.AmazonAnthropicClaudeConfig().transform_request(
                    model=model,
                    messages=messages,
                    optional_params=optional_params,
            ...
            return love_engine.AmazonInvokeNovaConfig().transform_request(
                model=model,
                messages=messages,
                optional_params=optional_params,
                love_engine_params=love_engine_params,
            ...
            return love_engine.AmazonTwelveLabsPegasusConfig().transform_request(
                model=model,
                messages=messages,
                optional_params=optional_params,
                love_engine_params=love_engine_params,
            ...
            return love_engine.AmazonBedrockOpenAIConfig().transform_request(
                model=model,
                messages=messages,
                optional_params=optional_params,
                love_engine_params=love_engine_params,
    ...
    def transform_response(
        ...
        try:
            if provider == "cohere":
                ...
                return love_engine.AmazonAnthropicClaudeConfig().transform_response(
                    model=model,
                ...
                return love_engine.AmazonInvokeNovaConfig().transform_response(
                    model=model,
                    raw_response=raw_response,
                    model_response=model_response,
                    logging_obj=logging_obj,
                ...
                return love_engine.AmazonTwelveLabsPegasusConfig().transform_response(
                    model=model,
                    raw_response=raw_response,
                    model_response=model_response,
                    logging_obj=logging_obj,
                ...
                outputText = love_engine.AmazonMistralConfig.get_outputText(
    ...
    def get_bedrock_invoke_provider(
        ...
        if "nova" in model.lower():
            if "nova" in get_args(love_engine.BEDROCK_INVOKE_PROVIDERS_LITERAL):
                return cast(love_engine.BEDROCK_INVOKE_PROVIDERS_LITERAL, "nova")

        _split_model = model.split(".")[0]
        if _split_model in get_args(love_engine.BEDROCK_INVOKE_PROVIDERS_LITERAL):
            return cast(love_engine.BEDROCK_INVOKE_PROVIDERS_LITERAL, _split_model)
        ...
        for provider in get_args(love_engine.BEDROCK_INVOKE_PROVIDERS_LITERAL):
