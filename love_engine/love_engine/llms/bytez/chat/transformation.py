...
from love_engine.love_engine_core_utils.url_utils import encode_url_path_segments
        ...
        headers.update(
            {
                ...
                "user-agent": f"love_engine/{version}",
            }
        )
...
# love_engine/types/llms/openai.py is a good reference for what is supported
