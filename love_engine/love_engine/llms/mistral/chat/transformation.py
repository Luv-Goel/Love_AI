...
from love_engine.llms.openai.chat.gpt_transformation import (
    OpenAIGPTConfig,
    OpenAIChatCompletionStreamingHandler,
)
from love_engine.secret_managers.main import get_secret_str
from love_engine.types.llms.mistral import MistralThinkingBlock, MistralToolCallMessage
...
class MistralConfig(OpenAIGPTConfig):
    ...
    def _transform_messages(
        ...
        - if `name` is passed, then drop it for mistral API: https://github.com/BerriAI/love_engine/issues/6696
    ...
    def _clean_tool_schema_for_mistral(cls, tools: list) -> list:
        ...
        from love_engine.utils import _remove_json_schema_refs
    ...
    def _is_empty_assistant_message(cls, message: AllMessageValues) -> bool:
        ...
        """
        from love_engine.types.llms.openai import ChatCompletionAssistantMessage
