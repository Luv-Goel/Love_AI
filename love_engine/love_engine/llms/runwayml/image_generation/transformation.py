...
class RunwayMLImageGenerationConfig(BaseImageGenerationConfig):
    ...
    def transform_image_generation_response(
        ...
        """
        Transform the image generation response to the love_engine image response.
    ...
    async def async_transform_image_generation_response(
        ...
        """
        Async transform the image generation response to the love_engine image response.
