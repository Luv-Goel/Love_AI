...
class ParallelAISearchConfig(BaseSearchConfig):
    ...
    def transform_search_request(
        ...
        **kwargs,
        ...
        # instead to keep v1beta's default tier (processor 'base') and love_engine's
    ...
    def transform_search_response(
        ...
        **kwargs,
        ...
        """
        Transform Parallel AI v1 API response to love_engine unified SearchResponse format.

        Parallel AI -> love_engine mappings:
