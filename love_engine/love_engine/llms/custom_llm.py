...
from love_engine.utils import EmbeddingResponse, ImageResponse, ModelResponse

from .base import BaseLLM

if TYPE_CHECKING:
    from love_engine import CustomStreamWrapper
...
class CustomLLM(BaseLLM):
    ...
    async def aimage_generation(
        ...
        api_key: Optional[
            str
        ],  # dynamically set api_key - https://docs.love_engine.ai/docs/set_keys#api_key
        api_base: Optional[
            str
        ],  # dynamically set api_base - https://docs.love_engine.ai/docs/set_keys#api_base
        optional_params: dict,
        logging_obj: Any,
        timeout: Optional[Union[float, httpx.Timeout]] = None,
        client: Optional[AsyncHTTPHandler] = None,
