...
class AzureAIAgentsConfig(BaseConfig):
    ...
    def transform_response(
        ...
        """
        Transform the Azure Agents response to love_engine ModelResponse format.
        """
    ...
    def completion(
        ...
        See: https://learn.microsoft.com/en-us/azure/ai-foundry/agents/quickstart
        """
        from love_engine.llms.azure.common_utils import get_azure_ad_token
        from love_engine.llms.azure_ai.agents.handler import azure_ai_agents_handler
        ...
        if api_key is None:
            ...
            # Create a GenericLoveEngineParams with the scope override for Azure Foundry Agents
            azure_auth_params = dict(love_engine_params) if love_engine_params else {}
            azure_auth_params["azure_scope"] = "https://ai.azure.com/.default"
            api_key = get_azure_ad_token(GenericLoveEngineParams(**azure_auth_params))
