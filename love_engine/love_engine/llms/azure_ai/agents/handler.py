...
from love_engine.llms.azure_ai.agents.transformation import (
    AzureAIAgentsConfig,
    AzureAIAgentsError,
)
...
class AzureAIAgentsHandler:
    ...
    def _build_model_response(
        ...
        from love_engine.types.utils import Choices, Message, Usage
    ...
    async def acompletion(
        ...
        if client is None:
            client = get_async_httpx_client(
                llm_provider=love_engine.LlmProviders.AZURE_AI,
                params={"ssl_verify": love_engine_params.get("ssl_verify", None)},
            )
    ...
    async def acompletion_stream(
        ...
        # Use love_engine's async HTTP client for streaming
        client = get_async_httpx_client(
            llm_provider=love_engine.LlmProviders.AZURE_AI,
            params={"ssl_verify": love_engine_params.get("ssl_verify", None)},
        )
