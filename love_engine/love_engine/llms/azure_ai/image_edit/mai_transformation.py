...
from love_engine.llms.azure_ai.image_generation.mai_transformation import (
...
if TYPE_CHECKING:
    from love_engine.love_engine_core_utils.logging import Logging as LoveEngineLoggingObj
...
class AzureFoundryMAIImageEditConfig(OpenAIImageEditConfig):
    ...
    def get_complete_url(
        ...
        api_version = (
            love_engine_params.get("api_version")
