...
from love_engine.llms.openai.common_utils import drop_params_from_unprocessable_entity_error
from love_engine.llms.openai.openai import OpenAIConfig
from love_engine.llms.xai.chat.transformation import XAIChatConfig
...
from love_engine.types.utils import ModelResponse, ProviderField
from love_engine.utils import _add_path_to_api_base, supports_tool_choice
...
class AzureAIStudioConfig(OpenAIConfig):
    ...
    def validate_environment(
        ...
        if api_key:
            ...
            love_engine_params_obj = GenericLoveEngineParams(
                **(love_engine_params if isinstance(love_engine_params, dict) else {})
            )
            headers = BaseAzureLLM._base_validate_azure_environment(
                headers=headers, love_engine_params=love_engine_params_obj
            )
    ...
    def get_complete_url(
        ...
        - api_base: Base URL, e.g.,
            "https://love_engine8397336933.services.ai.azure.com"
            OR
            "https://love_engine8397336933.services.ai.azure.com/models/chat/completions?api-version=2024-05-01-preview"
        - model: Model name.
        ...
        api_version = cast(Optional[str], love_engine_params.get("api_version"))
    ...
    def should_retry_llm_api_inside_llm_translation_on_http_error(
        self, e: httpx.HTTPStatusError, love_engine_params: dict
    ) -> bool:
        should_drop_params = love_engine_params.get("drop_params") or love_engine.drop_params
    ...
    def transform_request_on_unprocessable_entity_error(
        ...
        if (
            ...
            love_engine.remove_index_from_tool_calls(
                messages=_messages,
            )
        elif (
            AzureFoundryErrorStrings.SET_EXTRA_PARAMETERS_TO_PASS_THROUGH.value
