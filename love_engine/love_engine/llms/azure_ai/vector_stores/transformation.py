...
class AzureAIVectorStoreConfig(BaseVectorStoreConfig, BaseAzureLLM):
    ...
    def validate_environment(
        ...
        basic_headers = self._base_validate_azure_environment(headers, love_engine_params)
    ...
    def get_complete_url(
        ...
        # Get search service name from love_engine_params
        search_service_name = love_engine_params.get("azure_search_service_name")

        if not search_service_name:
            raise ValueError(
                "Azure AI Search service name is required. "
                "Provide it via love_engine_params['azure_search_service_name'] or api_base parameter"
            )
    ...
    def transform_search_vector_store_request(
        ...
        if not embedding_model:
            raise ValueError(
                "embedding_model is required in love_engine_params for Azure AI Search. "
        ...
        if not embedding_config:
            raise ValueError(
                "embedding_config is required in love_engine_params for Azure AI Search. "
        ...
        vector_field = love_engine_params.get("azure_search_vector_field", "contentVector")
        ...
        love_engine_logging_obj.model_call_details["top_k"] = top_k
