...
from love_engine.llms.anthropic.common_utils import AnthropicError
...
class AzureAIAnthropicCountTokensHandler(AzureAIAnthropicCountTokensConfig):
    ...
    async def handle_count_tokens_request(
        ...
        Args:
            ...
            love_engine_params: Optional love_engine parameters
            timeout: Optional timeout for the request (defaults to love_engine.request_timeout)
        ...
        try:
            ...
            # Use love_engine's async httpx client
            async_client = get_async_httpx_client(
                llm_provider=love_engine.LlmProviders.AZURE_AI
            )

            # Use provided timeout or fall back to love_engine.request_timeout
            request_timeout = (
                timeout if timeout is not None else love_engine.request_timeout
            )
