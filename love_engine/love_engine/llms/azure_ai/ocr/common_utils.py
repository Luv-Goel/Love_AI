...
def get_azure_ai_ocr_config(model: str) -> Optional["BaseOCRConfig"]:
    ...
    """
    from love_engine.llms.azure_ai.ocr.document_intelligence.transformation import (
        AzureDocumentIntelligenceOCRConfig,
    )
    from love_engine.llms.azure_ai.ocr.transformation import AzureAIOCRConfig
