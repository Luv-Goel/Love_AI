...
from love_engine.constants import DEFAULT_DATAFORSEO_LOCATION_CODE
...
class DataForSEOSearchConfig(BaseSearchConfig):
    ...
    def transform_search_response(
        ...
        **kwargs,
        ...
        """
        Transform DataForSEO SERP API response to love_engine unified SearchResponse format.

        DataForSEO → love_engine mappings:
