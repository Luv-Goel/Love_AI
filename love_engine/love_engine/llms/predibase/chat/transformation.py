...
class PredibaseConfig(BaseConfig):
    ...
    def transform_response(
        ...
        prompt_tokens = 0
        try:
            prompt_tokens = love_engine.token_counter(messages=messages)
        except Exception:
    ...
    def transform_request(
        ...
        custom_prompt_dict = love_engine_params.get("custom_prompt_dict", {})
    ...
    def get_complete_url(
        ...
        tenant_id = love_engine_params.get("predibase_tenant_id") or love_engine_params.get(
            "tenant_id"
        )
