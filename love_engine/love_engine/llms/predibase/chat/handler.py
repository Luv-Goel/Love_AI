...
class PredibaseChatCompletion:
    ...
    def completion(
        ...
        predibase_config = love_engine.PredibaseConfig()
        ...
        completion_url = predibase_config.get_complete_url(
            ...
            love_engine_params=request_love_engine_params,
            stream=stream,
        )
    ...
    async def async_completion(
        ...
        async_handler = get_async_httpx_client(
            llm_provider=love_engine.LlmProviders.PREDIBASE,
