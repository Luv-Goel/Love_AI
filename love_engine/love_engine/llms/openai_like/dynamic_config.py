...
from love_engine.llms.openai_like.chat.transformation import OpenAILikeChatConfig
...
def create_responses_config_class(provider: SimpleProviderConfig):
    ...
    from love_engine.llms.openai_like.responses.transformation import (
    ...
    class JSONProviderResponsesConfig(OpenAILikeResponsesConfig):
        ...
        def validate_environment(
            ...
            api_key = love_engine_params.api_key or get_secret_str(provider.api_key_env)
            if api_key:
