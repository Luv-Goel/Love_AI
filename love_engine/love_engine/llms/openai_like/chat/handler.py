...
from love_engine.llms.databricks.streaming_utils import ModelResponseIterator
...
from love_engine.types.utils import CustomStreamingDecoder, ModelResponse
from love_engine.utils import CustomStreamWrapper, ProviderConfigManager
...
def make_sync_call(
    ...
    if client is None:
        client = love_engine.module_level_client  # Create a new client if none provided
