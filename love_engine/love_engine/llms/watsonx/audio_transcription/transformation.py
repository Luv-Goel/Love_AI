...
from love_engine.love_engine_core_utils.audio_utils.utils import process_audio_file
from love_engine.types.llms.openai import (
    AllMessageValues,
    OpenAIAudioTranscriptionOptionalParams,
)
from love_engine.types.llms.watsonx import WatsonXAudioTranscriptionRequestBody
...
class IBMWatsonXAudioTranscriptionConfig(
    ...
    def get_complete_url(
        ...
        api_version = (
            ...
            or love_engine.WATSONX_DEFAULT_API_VERSION
        )
