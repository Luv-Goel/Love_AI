...
from love_engine.love_engine_core_utils.prompt_templates import factory as ptf
...
from love_engine.types.llms.watsonx import WatsonXAPIParams, WatsonXCredentials
...
async def _aconvert_watsonx_messages_core(
    ...
    from love_engine.types.llms.watsonx import WatsonXModelPattern
...
class IBMWatsonXMixin:
    ...
    def _add_api_version_to_url(self, url: str, api_version: Optional[str]) -> str:
        api_version = api_version or love_engine.WATSONX_DEFAULT_API_VERSION
