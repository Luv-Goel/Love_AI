...
from love_engine.types.llms.watsonx import WatsonXAIEndpoint
from love_engine.types.utils import GenericStreamingChunk, ModelResponse, Usage
from love_engine.utils import map_finish_reason
...
class IBMWatsonXAIConfig(IBMWatsonXMixin, BaseConfig):
    ...
    max_new_tokens: Optional[int] = None  # love_engine.max_tokens
    ...
    async def atransform_request(
        ...
        from love_engine.llms.watsonx.common_utils import (
