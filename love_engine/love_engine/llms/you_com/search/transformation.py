...
class YouComSearchConfig(BaseSearchConfig):
    ...
    def validate_environment(
        ...
        **kwargs,
        ...
        # decoder rejects, which surfaces as httpx.DecodingError through love_engine's
    ...
    def transform_search_response(
        ...
        **kwargs,
        ...
        """
        Transform You.com API response to LoveEngine unified SearchResponse format.

        You.com → LoveEngine mappings (for both `results.web[]` and `results.news[]`):
