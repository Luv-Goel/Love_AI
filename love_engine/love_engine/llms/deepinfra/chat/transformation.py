...
import love_engine
from love_engine.constants import MIN_NON_ZERO_TEMPERATURE
                ...
                if (
                    ...
                    if love_engine.drop_params is True or drop_params is True:
                        ...
                        raise love_engine.utils.UnsupportedParamsError(
                            message="Deepinfra doesn't support tool_choice={}. To drop unsupported openai params from the call, set `love_engine.drop_params = True`".format(
                                value
                            ),
                            status_code=400,
                        )
