"""
Prompt Injection Handler for love_engine Skills
...
from love_engine.proxy._types import LOVE_ENGINE_SkillsTable
...
class SkillPromptInjectionHandler:
    ...
    def extract_skill_content(self, skill: LOVE_ENGINE_SkillsTable) -> Optional[str]:
        """
        ...
        Args:
            skill: The skill from love_engine database
    ...
    def extract_all_files(self, skill: LOVE_ENGINE_SkillsTable) -> Dict[str, bytes]:
        """
    ...
    def convert_skill_to_tool(self, skill: LOVE_ENGINE_SkillsTable) -> Dict[str, Any]:
        """
        Convert a love_engine skill to an OpenAI-style tool.
    ...
    def convert_skill_to_anthropic_tool(
        self, skill: LOVE_ENGINE_SkillsTable
    ) -> Dict[str, Any]:
        """
        Convert a love_engine skill to an Anthropic-style tool (messages API format).
