...
class HuggingFaceEmbeddingConfig(BaseConfig):
    ...
    hf_task: Optional[hf_tasks] = (
        None  # love_engine-specific param, used to know the api spec to use when calling huggingface api
    )
    ...
    def transform_request(
        ...
        task = love_engine_params.get("task", None)
        ## VALIDATE API FORMAT
        ...
        ## Load Config
        config = love_engine.HuggingFaceEmbeddingConfig.get_config()
