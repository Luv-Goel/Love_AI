...
from love_engine.types.rerank import OptionalRerankParams, RerankRequest, RerankResponse
...
class CohereRerankConfig(BaseRerankConfig):
    ...
    def validate_environment(
        ...
        if api_key is None:
            raise ValueError(
                "Cohere API key is required. Please set 'COHERE_API_KEY' or 'CO_API_KEY' or 'love_engine.cohere_key'"
            )
    ...
    def transform_rerank_response(
        ...
        No transformation required, love_engine follows cohere API response format
        """
        try:
