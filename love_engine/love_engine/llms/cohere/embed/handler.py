...
from love_engine.types.llms.bedrock import CohereEmbeddingRequest
...
def validate_environment(api_key, headers: dict):
    ...
    if "request-source" not in existing_keys_lower:
        headers["Request-Source"] = "unspecified:love_engine"
...
async def async_embedding(
    ...
    input: list,
    model_response: love_engine.utils.EmbeddingResponse,
    ...
    if client is None:
        client = get_async_httpx_client(
            llm_provider=love_engine.LlmProviders.COHERE,
