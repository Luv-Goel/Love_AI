...
import love_engine.types.utils
from love_engine._logging import _redact_string, verbose_logger
from love_engine.anthropic_beta_headers_manager import update_headers_with_filtered_beta
from love_engine.constants import REALTIME_WEBSOCKET_MAX_MESSAGE_SIZE_BYTES
from love_engine.love_engine_core_utils.realtime_streaming import RealTimeStreaming
...
from love_engine.llms.base_llm.ocr.transformation import BaseOCRConfig, OCRResponse
...
from love_engine.llms.base_llm.search.transformation import BaseSearchConfig, SearchResponse
from love_engine.llms.base_llm.skills.transformation import BaseSkillsAPIConfig
from love_engine.llms.base_llm.text_to_speech.transformation import BaseTextToSpeechConfig
...
from love_engine.types.files import TwoStepFileUploadConfig
from love_engine.types.integrations.custom_logger import (
    AgenticLoopPlan,
    AgenticLoopRequestPatch,
)
from love_engine.types.llms.anthropic_messages.anthropic_response import (
...
from love_engine.types.responses.main import DeleteResponseResult
...
from love_engine.types.vector_store_files import (
...
def _google_genai_streaming_hidden_params(
    *,
    ...
    _model_info: Dict[str, Any] = dict(
        getattr(love_engine_params, "model_info", None) or {}
    )
...
class BaseLLMHTTPHandler:
        ...
        for i in range(max(max_retry_on_unprocessable_entity_error, 1)):
            try:
                ...
                should_retry = provider_config.should_retry_llm_api_inside_llm_translation_on_http_error(
                    e=e, love_engine_params=love_engine_params
                )
    ...
    async def async_completion(
        ...
        if client is None:
            ...
            async_httpx_client = get_async_httpx_client(
                llm_provider=love_engine.LlmProviders(custom_llm_provider),
                params={"ssl_verify": love_engine_params.get("ssl_verify", None)},
    ...
    def completion(
        ...
        provider_config = (
            ...
            or ProviderConfigManager.get_provider_chat_config(
                model=model, provider=love_engine.LlmProviders(custom_llm_provider)
            )
        )
        ...
        if love_engine_params.get("_websearch_interception_converted_stream", False):
    ...
    def make_sync_call(
        ...
        if client is None or not isinstance(client, HTTPHandler):
            sync_httpx_client = _get_httpx_client(
                {
                    "ssl_verify": love_engine_params.get("ssl_verify", None),
                }
            )
        else:
            sync_httpx_client = client
    ...
    def _prepare_ocr_request(
        ...
        Returns: (headers, complete_url, data, files)
        """
        from love_engine.llms.base_llm.ocr.transformation import OCRRequestData
    ...
    async def _async_post_anthropic_messages_with_http_error_retry(
        ...
        love_engine_params_dict = dict(love_engine_params)
        optional_params_dict = dict(love_engine_params)
            ...
            try:
                ...
                should_retry = (
                    provider_config.should_retry_anthropic_messages_on_http_error(
                        e=e, love_engine_params=love_engine_params_dict
                    )
                )
    ...
    async def async_anthropic_messages_handler(
        ...
        if client is None or not isinstance(client, AsyncHTTPHandler):
            async_httpx_client = get_async_httpx_client(
                llm_provider=love_engine.LlmProviders.ANTHROPIC
            )
        else:
            async_httpx_client = client
        ...
        provider_specific_header = cast(
            Optional[love_engine.types.utils.ProviderSpecificHeader],
        ...
        additional_drop_params = love_engine_params.get("additional_drop_params")
        ...
        headers, signed_json_body = anthropic_messages_provider_config.sign_request(
            ...
            optional_params=dict(
                love_engine_params
            ),  # dynamic aws_* params are passed under love_engine_params
            request_data=request_body,
            api_base=request_url,
            api_key=api_key,
            stream=stream,
        ...
        if stream:
            ...
            from love_engine.llms.anthropic.experimental_pass_through.messages.agentic_streaming_iterator import (
    ...
    def response_api_handler(
        ...
        # with the same info as chat, including love_engine_params.
        ...
        request_context["love_engine_params"] = dict(love_engine_params)
        ...
        headers, signed_body = responses_api_provider_config.sign_request(
            headers=headers,
            optional_params=dict(love_engine_params),
            request_data=data,
            api_base=api_base,
    ...
    async def async_delete_response_api_handler(
        ...
        headers = responses_api_provider_config.validate_environment(
            headers=extra_headers or {}, model="None", love_engine_params=love_engine_params
        )
    ...
    def create_file(
        ...
        if (
            ...
            try:
                ...
                if initial_response_data:
                    love_engine_params["initial_file_response"] = initial_response_data
            except Exception as e:
                raise self._handle_error(
                    e=e,
                    provider_config=provider_config,
        ...
        # Store the upload URL in love_engine_params for the transformation method
        ...
        love_engine_params_with_url = dict(love_engine_params)
        if "upload_url" not in love_engine_params:
            love_engine_params_with_url["upload_url"] = api_base

        return provider_config.transform_create_file_response(
            model=None,
            raw_response=upload_response,
            logging_obj=logging_obj,
            love_engine_params=love_engine_params_with_url,
        )
    ...
    def create_batch(
        ...
        love_engine_params_with_request = {
            **love_engine_params,
        ...
        return provider_config.transform_create_batch_response(
            ...
            logging_obj=logging_obj,
            love_engine_params=love_engine_params_with_request,
        )
    ...
    def compact_response_api_handler(
        ...
        headers = responses_api_provider_config.validate_environment(
            headers=extra_headers or {}, model=model, love_engine_params=love_engine_params
        )
    ...
    def _has_agentic_completion_hook(logging_obj: Any) -> bool:
        ...
        String entries in ``love_engine.callbacks`` (e.g. ``"datadog"``) are
    ...
    async def _execute_anthropic_agentic_plan(
        ...
        from love_engine.anthropic_interface import messages as anthropic_messages
        ...
        internal_keys = {"love_engine_logging_obj"}
        kwargs_for_followup = {
            k: v
        ...
        if callback is not None:
            try:
                ...
                _call_id = getattr(logging_obj, "love_engine_call_id", "unknown")
                verbose_logger.exception(
                    "love_engine.AgenticHookError: Exception in "
    ...
    async def _execute_chat_completion_agentic_plan(
        ...
        return await love_engine.acompletion(
    ...
    async def _call_agentic_completion_hooks(
        ...
        callbacks = love_engine.callbacks + (logging_obj.dynamic_success_callbacks or [])
        ...
        for callback in callbacks:
            ...
            try:
                ...
                _call_id = getattr(logging_obj, "love_engine_call_id", "unknown")
                verbose_logger.exception(
                    "love_engine.AgenticHookError: Exception in agentic completion hooks "
                    "[call_id=%s model=%s]: %s",
                    _call_id,
                    model,
                    str(e),
        ...
        if websearch_converted_stream:
            ...
            from love_engine._logging import verbose_logger
            from love_engine.llms.anthropic.experimental_pass_through.messages.fake_stream_iterator import (
    ...
    async def _call_agentic_chat_completion_hooks(
        ...
        for callback in callbacks:
            ...
            try:
                ...
                verbose_logger.exception(
                    f"love_engine.AgenticHookError: Exception in chat completion agentic hooks: {str(e)}"
                )
    ...
    async def async_realtime(
        ...
        try:
            ...
            async with websockets.connect(  # type: ignore
                ...
                if love_engine_metadata:
                    _request_data["love_engine_metadata"] = love_engine_metadata
                ...
                if not provider_config.requires_session_configuration():
                    synthetic_session = provider_config.transform_session_created_event(
                        model=model,
                        logging_session_id=logging_obj.love_engine_trace_id,
    ...
    async def _async_realtime_session_post(
        ...
        if client is None or not isinstance(client, AsyncHTTPHandler):
            async_httpx_client = get_async_httpx_client(
                llm_provider=love_engine.LlmProviders.OPENAI,
            )
        else:
            async_httpx_client = client
        ...
        **kwargs: Any,
        ...
        try:
            ...
            async with websockets.connect(  # type: ignore
                ...
                try:
                    import love_engine as _love_engine
                    ...
                    _ws_guardrail_callbacks = [
                        cb
                        for cb in _love_engine.callbacks
    ...
    def image_generation_handler(
        ...
        model_response: ImageResponse = (
            image_generation_provider_config.transform_image_generation_response(
                model=model,
                raw_response=response,
                model_response=love_engine.ImageResponse(),
                logging_obj=logging_obj,
                request_data=data,
                optional_params=image_generation_optional_request_params,
                love_engine_params=dict(love_engine_params),
    ...
    def video_generation_handler(
        ...
        headers = video_generation_provider_config.validate_environment(
            api_key=api_key or love_engine_params.get("api_key", None),
    ...
    async def async_vector_store_search_handler(
        ...
        headers = vector_store_provider_config.validate_environment(
            headers=extra_headers or {}, love_engine_params=love_engine_params
        )
        ...
        all_optional_params: Dict[str, Any] = dict(love_engine_params)
    ...
    def generate_content_handler(
        ...
        When _is_async=True, returns a coroutine instead of making the call directly.
        """
        from love_engine.google_genai.streaming_iterator import (
        ...
        try:
            if stream:
                ...
                return GoogleGenAIGenerateContentStreamingIterator(
                    ...
                    logging_obj=logging_obj,
                    generate_content_provider_config=generate_content_provider_config,
                    love_engine_metadata=love_engine_metadata or {},
                    custom_llm_provider=custom_llm_provider,
                    request_body=data,
