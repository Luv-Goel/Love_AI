...
## love_engine versions of the OpenAI Exception Types
...
from love_engine.types.utils import LoveEngineCommonStrings
...
class RateLimitErrorCategory(str, enum.Enum):
    ...
    Use these values to switch on the rate limit source, e.g.::
        ...
        try:
            ...
            if e.category == RateLimitErrorCategory.LOVE_ENGINE_RATE_LIMIT:
                ...  # love_engine's own limiter (key/team/user/model RPM/TPM/budget)
    ...
    LOVE_ENGINE_RATE_LIMIT = "love_engine_rate_limit"
    """love_engine's own rate limiter (key/team/user/model RPM/TPM, budget, parallel-requests, etc.) blocked the request."""

    LOVE_ENGINE_BATCH_RATE_LIMIT = "love_engine_batch_rate_limit"
    """love_engine's own batch rate limiter (token/request budget across a batch input file) blocked the request."""
...
class RateLimitType(str, enum.Enum):
    ...
    love_engine's own limiters), while *type* tells them **which limit dimension**
...
def _get_minimal_error_response() -> httpx.Response:
    ...
    if _MINIMAL_ERROR_RESPONSE is None:
        _MINIMAL_ERROR_RESPONSE = httpx.Response(
            status_code=400,
            request=httpx.Request(method="GET", url="https://love_engine.ai"),
        )
...
class AuthenticationError(openai.AuthenticationError):  # type: ignore
    def __init__(
        ...
        love_engine_debug_info: Optional[str] = None,
        max_retries: Optional[int] = None,
        num_retries: Optional[int] = None,
    ):
        self.status_code = 401
        self.message = "love_engine.AuthenticationError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
        self.num_retries = num_retries
        self.response = response or httpx.Response(
            status_code=self.status_code,
            request=httpx.Request(
                method="GET", url="https://love_engine.ai"
            ),  # mock request object
        )
        super().__init__(
    ...
    def __str__(self):
        ...
        if self.num_retries:
            _message += f" love_engine Retried: {self.num_retries} times"
        if self.max_retries:
            _message += f", love_engine Max Retries: {self.max_retries}"
        return _message
...
class NotFoundError(openai.NotFoundError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.NotFoundError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class BadRequestError(openai.BadRequestError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.BadRequestError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class ImageFetchError(BadRequestError):
    def __init__(
        ...
        super().__init__(
            ...
            response=response,
            love_engine_debug_info=love_engine_debug_info,
...
class UnprocessableEntityError(openai.UnprocessableEntityError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.UnprocessableEntityError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class Timeout(openai.APITimeoutError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.Timeout: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class PermissionDeniedError(openai.PermissionDeniedError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.PermissionDeniedError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class RateLimitError(openai.RateLimitError):  # type: ignore
    ...
    Every rate-limit condition surfaced by love_engine — whether it originated from
    an upstream LLM provider, a vendor batch endpoint, or one of love_engine's own
    ...
    def __init__(
        ...
        self.message = "love_engine.RateLimitError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class ContextWindowExceededError(BadRequestError):  # type: ignore
    def __init__(
        ...
        super().__init__(
            ...
            response=response,
            love_engine_debug_info=self.love_engine_debug_info,
        )  # Call the base class constructor with the parameters it needs

        # set after, to make it clear the raised error is a context window exceeded error
        self.message = "love_engine.ContextWindowExceededError: {}".format(self.message)
...
class RejectedRequestError(BadRequestError):  # type: ignore
    def __init__(
        ...
        self.status_code = 400
        self.message = "love_engine.RejectedRequestError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.love_engine_debug_info = love_engine_debug_info
...
class ContentPolicyViolationError(BadRequestError):  # type: ignore
    ...
    def __init__(
        ...
        self.status_code = 400
        self.message = "love_engine.ContentPolicyViolationError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.love_engine_debug_info = love_engine_debug_info
...
class ServiceUnavailableError(openai.APIStatusError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.ServiceUnavailableError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class BadGatewayError(openai.APIStatusError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.BadGatewayError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class InternalServerError(openai.InternalServerError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.InternalServerError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class APIError(openai.APIError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.APIError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class APIConnectionError(openai.APIConnectionError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.APIConnectionError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.status_code = 500
        self.love_engine_debug_info = love_engine_debug_info
...
class APIResponseValidationError(openai.APIResponseValidationError):  # type: ignore
    def __init__(
        ...
        self.message = "love_engine.APIResponseValidationError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        request = httpx.Request(method="POST", url="https://api.openai.com/v1")
...
class JSONSchemaValidationError(APIResponseValidationError):
    def __init__(
        ...
        self.schema = schema
        self.model = model
        message = "love_engine.JSONSchemaValidationError: model={}, returned an invalid response={}, for schema={}.\nAccess raw response with `e.raw_response`".format(
...
class UnsupportedParamsError(BadRequestError):
    def __init__(
        ...
        self.status_code = 400
        self.message = "love_engine.UnsupportedParamsError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.love_engine_debug_info = love_engine_debug_info
...
class BudgetExceededError(Exception):
    def __init__(
        ...
        self.category: str = RateLimitErrorCategory.LOVE_ENGINE_RATE_LIMIT.value
...
class MockException(openai.APIError):
    ...
    def __init__(
        ...
        self.status_code = status_code
        self.message = "love_engine.MockException: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.love_engine_debug_info = love_engine_debug_info
        self.max_retries = max_retries
...
class LoveEngineUnknownProvider(BadRequestError):
    def __init__(self, model: str, custom_llm_provider: Optional[str] = None):
        self.message = LoveEngineCommonStrings.llm_provider_not_provided.value.format(
...
class MidStreamFallbackError(ServiceUnavailableError):  # type: ignore
    def __init__(
        ...
        self.message = f"love_engine.MidStreamFallbackError: {message}"
        self.model = model
        self.llm_provider = llm_provider
