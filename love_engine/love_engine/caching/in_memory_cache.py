...
from love_engine.constants import MAX_SIZE_PER_ITEM_IN_MEMORY_CACHE_IN_KB
...
class InMemoryCache(BaseCache):
    def __init__(
        ...
        default_ttl: Optional[
            int
        ] = 600,  # default ttl is 10 minutes. At maximum love_engine rate limiting logic requires objects to be in memory for 1 minute
    ...
    def evict_cache(self):
        ...
        # https://www.geekslove_smitheks.org/diagnosing-and-fixing-memory-leaks-in-python/
