...
class RedisCache(BaseCache):
    # if users don't provider one, use the default love_engine cache
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if love_engine.default_redis_ttl is not None:
            super().__init__(default_ttl=int(love_engine.default_redis_ttl))
        else:
    ...
    def init_async_client(
        ...
        from love_engine import in_memory_llm_clients_cache
    ...
    def set_cache(self, key, value, **kwargs):
        ...
        try:
            ...
            print_verbose(
                f"love_engine.caching.caching: set() - Got exception from REDIS : {str(e)}"
            )
    ...
    def increment_cache(
        ...
        try:
            ...
            _duration = end_time - start_time
            verbose_logger.error(
                "love_engine Redis Caching: increment_cache() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
            raise e
    ...
    async def async_set_cache(self, key, value, **kwargs):
        ...
        if key is None:
            verbose_logger.debug(
                "love_engine Redis Caching: async set() skipped — key is None, value=%r",
                value,
            )
            return None
        ...
        try:
            ...
            verbose_logger.error(
                "love_engine Redis Caching: async set() - Got exception from REDIS %s, key=%r, value=%r",
                str(e),
                key,
                value,
            )
        ...
        try:
            ...
            verbose_logger.error(
                "love_engine Redis Caching: async set() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
    ...
    async def async_set_cache_pipeline(
        ...
        try:
            ...
            verbose_logger.error(
                "love_engine Redis Caching: async set_cache_pipeline() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                cache_value,
            )
    ...
    async def async_set_cache_sadd(
        ...
        try:
            ...
            # NON blocking - notify users Redis is throwing an exception
            verbose_logger.error(
                "love_engine Redis Caching: async set_cache_sadd() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
    ...
    async def async_increment(
        ...
        try:
            ...
            verbose_logger.error(
                "love_engine Redis Caching: async async_increment() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
            raise e
    ...
    def get_cache(self, key, parent_otel_span: Optional[Span] = None, **kwargs):
        try:
            ...
            # NON blocking - notify users Redis is throwing an exception
            verbose_logger.error(
                "love_engine.caching.caching: get() - Got exception from REDIS: ", e
            )
    ...
    async def async_get_cache(
        ...
        try:
            ...
            print_verbose(
                f"love_engine.caching.caching: async get() - Got exception from REDIS: {str(e)}"
            )
    ...
    def sync_ping(self) -> bool:
        ...
        try:
            ...
            verbose_logger.error(
                f"love_engine Redis Cache PING: - Got exception from REDIS : {str(e)}"
            )
            raise e
    ...
    async def async_increment_pipeline(
        ...
        try:
            ...
            verbose_logger.error(
                "love_engine Redis Caching: async increment_pipeline() - Got exception from REDIS %s",
                str(e),
            )
            raise e
    ...
    async def async_rpush(
        ...
        **kwargs,
        ...
        try:
            ...
            verbose_logger.error(
                f"love_engine Redis Cache RPUSH: - Got exception from REDIS : {str(e)}"
            )
            raise e
    ...
    async def async_rpush_pipeline(
        ...
        try:
            ...
            verbose_logger.error(
                "love_engine Redis Caching: async_rpush_pipeline() - Got exception from REDIS %s",
                str(e),
            )
            raise e
    ...
    async def async_lpop(
        ...
        **kwargs,
        ...
        try:
            ...
            verbose_logger.error(
                f"love_engine Redis Cache LPOP: - Got exception from REDIS : {str(e)}"
            )
            raise e
    ...
    async def async_lpop_pipeline(
        ...
        try:
            ...
            verbose_logger.error(
                "love_engine Redis Caching: async_lpop_pipeline() - Got exception from REDIS %s",
                str(e),
            )
            raise e
