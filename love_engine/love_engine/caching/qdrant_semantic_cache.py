...
from love_engine.constants import QDRANT_SCALAR_QUANTILE, QDRANT_VECTOR_SIZE
...
class QdrantSemanticCache(BaseCache):
    CACHE_KEY_FIELD_NAME = "love_engine_cache_key"
    ...
    async def _get_async_embedding(self, prompt: str, **kwargs) -> Any:
        ...
        return await love_engine.aembedding(
            model=self.embedding_model,
            input=prompt,
            cache={"no-store": True, "no-cache": True},
        )
