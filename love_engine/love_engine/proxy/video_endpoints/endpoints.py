...
from love_engine.proxy.image_endpoints.endpoints import batch_to_bytesio
from love_engine.proxy.video_endpoints.utils import (
...
async def video_status(
    ...
    # This allows the router to automatically inject love_engine_params from the model config
