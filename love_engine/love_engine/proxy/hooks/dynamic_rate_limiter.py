    ...
    async def async_set_cache_sadd(self, model: str, value: List):
        ...
        try:
            ...
            verbose_proxy_logger.exception(
                "love_engine.proxy.hooks.dynamic_rate_limiter.py::async_set_cache_sadd(): Exception occured - {}".format(
                    str(e)
                )
            )
            raise e
...
class _PROXY_DynamicRateLimitHandler(CustomLogger):
        ...
        try:
            ...
            if (
                ...
                verbose_proxy_logger.error(
                    "Priority Reservation not set. priority={}, but love_engine.priority_reservation is {}.".format(
                        priority, love_engine.priority_reservation
                    )
                )
            ...
            verbose_proxy_logger.exception(
                "love_engine.proxy.hooks.dynamic_rate_limiter.py::check_available_usage: Exception occurred - {}".format(
                    str(e)
                )
            )
    ...
    async def async_post_call_success_hook(
        ...
        try:
            if isinstance(response, ModelResponse):
                ...
                response._hidden_params["additional_headers"] = (
                    {  # Add additional response headers - easier debugging
                        "x-love_engine-model_group": model_info["model_name"],
                        "x-ratelimit-remaining-love_engine-project-tokens": available_tpm,
                        "x-ratelimit-remaining-love_engine-project-requests": available_rpm,
            ...
            verbose_proxy_logger.exception(
                "love_engine.proxy.hooks.dynamic_rate_limiter.py::async_post_call_success_hook(): Exception occured - {}".format(
                    str(e)
                )
            )
            return response
