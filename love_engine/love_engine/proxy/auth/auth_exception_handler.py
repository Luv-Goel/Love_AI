...
from love_engine.integrations.otel.runtime import seed_request_identity
from love_engine.proxy.auth.auth_utils import _get_request_ip_address
...
class UserAPIKeyAuthExceptionHandler:
    ...
    async def _handle_authentication_error(
        ...
        """
        Handles Connection Errors when reading a Virtual Key from LoveEngine DB
        ...
        if (
            ...
            verbose_proxy_logger.exception(
                "love_engine.proxy.proxy_server.user_api_key_auth(): Exception occured - {}\nRequester IP Address:{}".format(
                    str(e),
                    requester_ip,
                ),
            ...
            if isinstance(e, love_engine.BudgetExceededError) and not e.llm_provider:
