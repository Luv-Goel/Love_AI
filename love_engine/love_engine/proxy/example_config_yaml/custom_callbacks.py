...
# this file is to test love_engine/proxy
...
# This file includes the custom callbacks for LoveEngine Proxy
...
class MyCustomHandler(CustomLogger):
    def __init__(self):
        ...
        print_verbose(f"{blue_color_code}Initialized LoveEngine custom logger")
        try:
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        response_cost = love_engine.completion_cost(completion_response=response_obj)
...
# need to set love_engine.callbacks = [customHandler] # on the proxy

# love_engine.success_callback = [async_on_succes_logger]
