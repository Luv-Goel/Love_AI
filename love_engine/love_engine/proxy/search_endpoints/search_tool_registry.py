...
from love_engine.repositories.table_repositories import SearchToolsRepository
from love_engine.types.search import SearchTool
...
class SearchToolRegistry:
    ...
    async def add_search_tool_to_db(
        ...
        try:
            ...
            love_engine_params: str = safe_dumps(
                dict(search_tool.get("love_engine_params", {}))
            )
