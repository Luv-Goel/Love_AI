...
def get_prompt_initializer_from_integrations():
    ...
    try:
        ...
        for item in os.listdir(integrations_dir):
            ...
            module_path = f"love_engine.integrations.{item}"
            try:
                # Import the module
...
class InMemoryPromptRegistry:
    ...
    def initialize_prompt(
        ...
        love_engine_params_data = prompt.love_engine_params
        ...
        prompt_integration = love_engine_params.prompt_integration
        ...
        if initializer:
            custom_prompt_callback = initializer(love_engine_params, prompt)
            ...
            love_engine.logging_callback_manager.add_love_engine_callback(custom_prompt_callback)  # type: ignore
        else:
    ...
    def delete_prompts_by_base_id(self, base_prompt_id: str) -> list[str]:
        ...
        """
        from love_engine.proxy.prompts.prompt_endpoints import get_base_prompt_id
