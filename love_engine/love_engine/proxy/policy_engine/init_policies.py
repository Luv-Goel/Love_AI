...
from love_engine.types.proxy.policy_engine import PolicyValidationResponse
...
def _print_policies_on_startup(
    ...
    print(  # noqa: T201
        f"{_green_color_code}\nLoveEngine Policy Engine: Loaded {len(policies_config)} policies{_reset_color_code}\n"
    )
    sys.stdout.flush()
