...
async def handle_update_object_permission_common(
    ...
    4. Upserts to the LOVE_ENGINE_ObjectPermissionTable
    ...
    # We need to update the entity at the object_permission_id level in the LOVE_ENGINE_ObjectPermissionTable
    #########################################################
    ...
    #########################################################
    # Commit the update to the LOVE_ENGINE_ObjectPermissionTable
    #########################################################
...
async def _set_object_permission(
    ...
    """
    Creates the LOVE_ENGINE_ObjectPermissionTable record for the key/team.
...
async def _resolve_team_allowed_mcp_servers(
    team_object_permission: "LOVE_ENGINE_ObjectPermissionTable",
