...
from love_engine.ocr.main import convert_file_document_to_url_document, get_mime_type
...
async def _parse_ocr_request(request: Request) -> Dict[str, Any]:
    ...
    # JSON. These IDs are not scoped to the LoveEngine proxy user/key, so an
