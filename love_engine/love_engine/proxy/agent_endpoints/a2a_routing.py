...
async def route_a2a_agent_request(
    ...
    """
    Route A2A agent requests directly to love_engine with injected API base.
    ...
    from love_engine.proxy.route_llm_request import (
    ...
    # Inject API base and route to love_engine
