...
from love_engine.types.agents import AgentConfig, AgentResponse, PatchAgentRequest
...
class AgentRegistry:
    ...
    async def add_agent_to_db(
        ...
        try:
            ...
            # Serialize love_engine_params
            love_engine_params_obj: Any = agent.get("love_engine_params", {})
    ...
    async def patch_agent_in_db(
        ...
        try:
            ...
            if augment_agent.get("love_engine_params"):
                update_data["love_engine_params"] = safe_dumps(
                    augment_agent.get("love_engine_params")
                )
