...
from love_engine.repositories.table_repositories import MemoryRepository
from love_engine.repositories.team_repository import TeamRepository
from love_engine.types.memory_management import (
    LOVE_ENGINE_MemoryRow,
    MemoryCreateRequest,
...
def _row_to_model(row: Any) -> LOVE_ENGINE_MemoryRow:
    return LOVE_ENGINE_MemoryRow(
...
@router.post(
    ...
    response_model=LOVE_ENGINE_MemoryRow,
)
