...
The committed JSON is generated by `python -m love_engine.proxy._lazy_openapi_snapshot`
...
def generate_snapshot() -> Dict[str, Dict]:
    ...
    from love_engine.proxy._lazy_features import LAZY_FEATURES
    from love_engine.proxy.proxy_server import app, ensure_unique_openapi_operation_ids
