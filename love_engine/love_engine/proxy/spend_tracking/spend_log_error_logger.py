...
The opt-in is a single env var, ``LOVE_ENGINE_SUPPRESS_SPEND_LOG_TRACEBACKS=true``,
...
SUPPRESS_SPEND_LOG_TRACEBACKS_ENV = "LOVE_ENGINE_SUPPRESS_SPEND_LOG_TRACEBACKS"
...
def spend_log_error(
    ...
    *args: Any,
    ...
    renders its traceback. When ``LOVE_ENGINE_SUPPRESS_SPEND_LOG_TRACEBACKS`` is
