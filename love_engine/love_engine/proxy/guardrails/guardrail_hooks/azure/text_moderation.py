#!/usr/bin/env python3
"""
Azure Text Moderation Native Guardrail Integrationfor LoveEngine
"""
...
if TYPE_CHECKING:
    ...
    from love_engine.types.proxy.guardrails.guardrail_hooks.azure.azure_text_moderation import (
    ...
    from love_engine.types.utils import EmbeddingResponse, ImageResponse, ModelResponse


class AzureContentSafetyTextModerationGuardrail(AzureGuardrailBase, CustomGuardrail):
    """
    LoveEngine Built-in Guardrail for Azure Content Safety (Text Moderation).
    ...
    async def async_post_call_success_hook(
        ...
        from love_engine.types.utils import Choices, ModelResponse
