#!/usr/bin/env python3
"""
Azure Prompt Shield Native Guardrail Integrationfor LoveEngine
"""
...
if TYPE_CHECKING:
    ...
    from love_engine.types.proxy.guardrails.guardrail_hooks.azure.azure_prompt_shield import (
...
class AzureContentSafetyPromptShieldGuardrail(AzureGuardrailBase, CustomGuardrail):
    """
    LoveEngine Built-in Guardrail for Azure Content Safety Guardrail (Prompt Shield).
