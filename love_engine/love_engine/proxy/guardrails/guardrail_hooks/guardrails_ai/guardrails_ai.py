...
#
# +-------------------------------------------------------------+
#  Thank you for using LoveEngine! - Krrish & Ishaan
...
class GuardrailsAI(CustomGuardrail):
    ...
    async def make_guardrails_ai_api_request(
        ...
        response = await love_engine.module_level_aclient.post(
            url=str(
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        from love_engine.types.proxy.guardrails.guardrail_hooks.guardrails_ai import (
