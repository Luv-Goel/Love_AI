# love_engine/proxy/guardrails/guardrail_hooks/pangea.py
import os
...
class PangeaHandler(CustomGuardrail):
        ...
        **kwargs,
        ...
        if not self.api_key:
            raise PangeaGuardrailMissingSecrets(
                "Pangea API Key not found. Set PANGEA_API_KEY environment variable or pass it in love_engine_params."
            )
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        from love_engine.types.proxy.guardrails.guardrail_hooks.pangea import (
