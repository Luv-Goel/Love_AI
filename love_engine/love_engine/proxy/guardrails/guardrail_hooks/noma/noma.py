# +-------------------------------------------------------------+
#
#           Noma Security Guardrail Integration for LoveEngine
#                       https://noma.security
#
# +-------------------------------------------------------------+
...
import love_engine
from love_engine import DualCache, ModelResponse
...
class NomaGuardrail(CustomGuardrail):
    """
    Noma Security Guardrail for LoveEngine
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._responses_transform_handler = LoveEngineResponsesTransformationHandler()
        ...
        self.default_application_id = "love_engine"
    ...
    async def _process_llm_response_check(
        ...
        for choice in response.choices:
            if isinstance(choice, love_engine.Choices) and choice.message.content:
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        from love_engine.types.proxy.guardrails.guardrail_hooks.noma import (
