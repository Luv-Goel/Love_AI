"""
Custom code guardrail for LoveEngine.
...
with access to LoveEngine-provided primitives for common guardrail operations.
...
class CustomCodeGuardrail(CustomGuardrail):
    ...
    - Access to LoveEngine primitives (regex_match, json_parse, etc.)
