...
class CatoNetworksGuardrail(CustomGuardrail):
        ...
        return (
            {
                ...
                "x-cato-love_engine-hook": hook,
                # Used by Cato Networks to track LoveEngine version and provide backward compatibility.
                "x-cato-love_engine-version": love_engine_version,
            }
            # Used by Cato Networks to track together single call input and output
            | ({"x-cato-call-id": love_engine_call_id} if love_engine_call_id else {})
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        from love_engine.types.proxy.guardrails.guardrail_hooks.cato_networks import (
