...
if TYPE_CHECKING:
    from love_engine.types.proxy.guardrails.guardrail_hooks.base import (
...
# LoveEngine marks MCP guardrail calls with these call_type values; the proxy
...
class CiscoAIDefenseGuardrail(_CiscoAIDefenseMcpMixin, CustomGuardrail):
    ...
    def _build_headers(self) -> Dict[str, str]:
        return {
            ...
            "User-Agent": f"love_engine/{love_engine_version}",
        }
    ...
    def _build_metadata(
        ...
        if love_engine_call_id:
            metadata["client_transaction_id"] = str(love_engine_call_id)
    ...
    def _finalize_inspection(
        ...
        ``response_obj`` is the LoveEngine response object (or MCP tool-call
