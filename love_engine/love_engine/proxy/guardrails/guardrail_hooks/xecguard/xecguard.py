"""
XecGuard guardrail integration for LoveEngine.
...
class XecGuardGuardrail(CustomGuardrail):
    ...
    async def async_logging_hook(
        ...
        if (
            ...
            in kwargs["love_engine_params"]["metadata"]
            and kwargs["love_engine_params"]["metadata"][
    ...
    def _extract_grounding_documents(request_data: dict) -> List[dict]:
        metadata = request_data.get("metadata") or request_data.get("love_engine_metadata")
