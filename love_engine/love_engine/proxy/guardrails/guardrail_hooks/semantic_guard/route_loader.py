...
from love_engine.constants import DEFAULT_SEMANTIC_GUARD_SIMILARITY_THRESHOLD
...
class SemanticGuardRouteLoader:
    ...
    def build_semantic_router(
        cls,
        routes: List["Route"],
        love_engine_router: "Router",
        embedding_model: str,
        global_threshold: float,
    ) -> "SemanticRouter":
        """Build the SemanticRouter with LoveEngineRouterEncoder."""
        from semantic_router.routers import SemanticRouter
        ...
        encoder = LoveEngineRouterEncoder(
            love_engine_router_instance=love_engine_router,
