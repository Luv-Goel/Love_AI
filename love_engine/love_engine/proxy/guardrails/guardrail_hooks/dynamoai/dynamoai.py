...
from love_engine.types.proxy.guardrails.guardrail_hooks.dynamoai import (
    DynamoAIProcessedResult,
    DynamoAIRequest,
    DynamoAIResponse,
)
from love_engine.types.utils import CallTypesLiteral, GuardrailStatus, ModelResponseStream
...
class DynamoAIGuardrails(CustomGuardrail):
    """
    DynamoAI Guardrails integration for LoveEngine.
    ...
    def __init__(
        self,
        guardrail_name: str = "love_engine_test",
