#!/usr/bin/env python3
"""
OpenAI Moderation Guardrail Integration for LoveEngine
"""
...
if TYPE_CHECKING:
    from love_engine.types.llms.openai import OpenAIModerationResponse
...
class OpenAIModerationGuardrail(OpenAIGuardrailBase, CustomGuardrail):
    """
    LoveEngine Built-in Guardrail for OpenAI Content Moderation.
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        ...
        """
        from love_engine.types.proxy.guardrails.guardrail_hooks.openai.openai_moderation import (
