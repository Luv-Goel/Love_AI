"""
Unified Guardrail, leveraging LoveEngine's /applyGuardrail endpoint
...
from love_engine.cost_calculator import _infer_call_type
...
from love_engine.love_engine_core_utils.api_route_to_call_types import get_call_types_for_route
from love_engine.llms import load_guardrail_translation_mappings
...
def _ensure_love_engine_metadata(data: dict, user_api_key_dict: UserAPIKeyAuth) -> None:
    """Populate data['love_engine_metadata'] from user_api_key_dict if absent."""
    if "love_engine_metadata" not in data:
        from love_engine.llms.base_llm.guardrail_translation.base_translation import (
            BaseTranslation,
        )
        ...
        if user_metadata:
            data["love_engine_metadata"] = user_metadata
...
class UnifiedLLMGuardrails(CustomLogger):
    ...
    async def async_pre_call_hook(
        ...
        _ensure_love_engine_metadata(data, user_api_key_dict)
    ...
    async def async_post_call_success_hook(
        ...
        if call_type is None:
            love_engine_logging_obj = data.get("love_engine_logging_obj")
            logging_call_type = (
                getattr(love_engine_logging_obj, "call_type", None)
    ...
    async def async_post_call_streaming_iterator_hook(
        ...
        See Aim guardrail implementation for an example - https://github.com/BerriAI/love_engine/blob/d0e022cfacb8e9ebc5409bb652059b6fd97b45c0/love_engine/proxy/guardrails/guardrail_hooks/aim.py#L168
            ...
            if chunk_counter % sampling_rate == 0:
                ...
                try:
                    await endpoint_translation.process_output_streaming_response(
                        ...
                        guardrail_to_apply=guardrail_to_apply,
                        love_engine_logging_obj=request_data.get("love_engine_logging_obj"),
                        user_api_key_dict=user_api_key_dict,
