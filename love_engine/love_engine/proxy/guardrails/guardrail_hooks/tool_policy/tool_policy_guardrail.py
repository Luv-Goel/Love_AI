...
Reads input_policy / output_policy from LOVE_ENGINE_ToolTable and enforces them.
...
from love_engine.proxy.guardrails.tool_name_extraction import extract_request_tool_names
...
def _get_request_route_from_data(request_data: dict) -> Optional[str]:
    ...
    if route:
        return route
    meta = request_data.get("metadata") or request_data.get("love_engine_metadata") or {}
