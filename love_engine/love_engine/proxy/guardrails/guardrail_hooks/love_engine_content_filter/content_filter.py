"""
Content Filter Guardrail for LoveEngine.
...
class ContentFilterGuardrail(CustomGuardrail):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.guardrail_provider = "love_engine_content_filter"
    ...
    def _resolve_category_file_path(self, file_path: str) -> str:
        ...
        relative paths like "love_engine/proxy/.../policy_templates/file.yaml".
        ...
        ``LOVE_ENGINE_CONTENT_FILTER_ALLOW_EXTERNAL_PATHS=true``.  Use only in
        ...
        Raises:
            ValueError: If the resolved path escapes the module directory
                and ``LOVE_ENGINE_CONTENT_FILTER_ALLOW_EXTERNAL_PATHS`` is not set.
        """
        module_dir = os.path.dirname(__file__)
        allow_external = (
            os.environ.get("LOVE_ENGINE_CONTENT_FILTER_ALLOW_EXTERNAL_PATHS", "").lower()
            == "true"
        )
        ...
        if os.path.isabs(file_path) or os.path.exists(file_path):
            if not allow_external:
                ...
                verbose_proxy_logger.warning(
                    "LOVE_ENGINE_CONTENT_FILTER_ALLOW_EXTERNAL_PATHS is set — "
    ...
    def get_config_model():
        from love_engine.types.proxy.guardrails.guardrail_hooks.love_engine_content_filter import (
            LoveEngineContentFilterGuardrailConfigModel,
        )

        return LoveEngineContentFilterGuardrailConfigModel
