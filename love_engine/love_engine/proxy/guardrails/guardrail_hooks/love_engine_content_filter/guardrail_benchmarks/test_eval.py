...
Run all evals:
  pytest love_engine/proxy/guardrails/guardrail_hooks/love_engine_content_filter/guardrail_benchmarks/test_eval.py -v -s
...
class _LlmJudgeChecker:
    """Uses an LLM via love_engine.completion() to classify messages."""
...
def _llm_judge(model: str = "gpt-4o-mini"):
    """LLM-as-judge using love_engine.completion(). Requires API key env var."""
