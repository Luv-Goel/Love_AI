"""MCP JWT Signer guardrail — built-in LoveEngine guardrail for zero trust MCP auth."""
...
def initialize_guardrail(
    ...
    def _get(key):  # type: ignore[no-untyped-def]
        if optional_params is not None:
            ...
            if v is not None:
                return v
        return getattr(love_engine_params, key, None)
    ...
    love_engine.logging_callback_manager.add_love_engine_callback(signer)
    return signer
