...
from love_engine.repositories.table_repositories import MCPToolsetRepository
...
async def list_mcp_toolsets(
    ...
    try:
        ...
        verbose_proxy_logger.warning(
            "love_engine.proxy._experimental.mcp_server.toolset_db::list_mcp_toolsets - {}".format(
                str(e)
            )
        )
        return []
