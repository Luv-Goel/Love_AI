...
from love_engine.proxy._experimental.mcp_server.utils import MCP_TOOL_PREFIX_SEPARATOR
...
class SemanticMCPToolFilter:
    ...
    def __init__(
        ...
        Args:
            ...
            love_engine_router_instance: Router instance for embedding generation
        ...
        self.router_instance = love_engine_router_instance
        ...
        try:
            ...
            self.tool_router = SemanticRouter(
                ...
                encoder=LoveEngineRouterEncoder(
                    love_engine_router_instance=self.router_instance,
