...
def _resolve_proxy_base_url_env() -> Optional[str]:
    ...
    if _warned_invalid_proxy_base_url != configured:
        verbose_logger.warning(
            ...
            "Set it to a full URL like https://love_engine.example.com.",
            configured,
        )
...
def _build_trusted_redirect_rejection_message(
    ...
    leaking internal network topology (e.g. ``http://love_engine-internal:4000``)
...
def _raise_trusted_redirect_uri_rejected(
    ...
    hint = (
        ...
        "HTTPS origin (e.g. https://love_engine.example.com), or enable "
