"""
DB helpers for LOVE_ENGINE_ToolTable — the global tool registry.
...
from love_engine.proxy._types import ToolDiscoveryQueueItem
...
from love_engine.repositories.table_repositories import ToolRepository
...
def _row_to_model(row: Union[dict, Any]) -> LOVE_ENGINE_ToolTableRow:
    """Convert a Prisma model instance or dict to LOVE_ENGINE_ToolTableRow."""
    ...
    return LOVE_ENGINE_ToolTableRow(
...
async def get_tool(
    prisma_client: "PrismaClient",
    tool_name: str,
) -> Optional[LOVE_ENGINE_ToolTableRow]:
