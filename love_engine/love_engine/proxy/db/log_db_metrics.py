...
from love_engine._service_logger import ServiceTypes
    ...
    async def wrapper(*args, **kwargs):
        ...
        try:
            ...
            if "PROXY" not in func.__name__:
                ...
                # in love_engine custom callbacks kwargs is passed as arg[0]
                # https://docs.love_engine.ai/docs/observability/custom_callback#callback-functions
                args is not None
                and len(args) > 1
