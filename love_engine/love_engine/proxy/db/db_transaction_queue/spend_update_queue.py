...
from love_engine.proxy.db.db_transaction_queue.base_update_queue import (
    BaseUpdateQueue,
    service_logger_obj,
)
...
class SpendUpdateQueue(BaseUpdateQueue):
    ...
    def get_aggregated_db_spend_update_transactions(
        ...
        entity_type_to_dict_key = {
            LOVE_ENGINE_EntityType.USER: "user_list_transactions",
            LOVE_ENGINE_EntityType.END_USER: "end_user_list_transactions",
            LOVE_ENGINE_EntityType.KEY: "key_list_transactions",
            LOVE_ENGINE_EntityType.TEAM: "team_list_transactions",
            LOVE_ENGINE_EntityType.TEAM_MEMBER: "team_member_list_transactions",
            LOVE_ENGINE_EntityType.ORGANIZATION: "org_list_transactions",
            LOVE_ENGINE_EntityType.TAG: "tag_list_transactions",
            LOVE_ENGINE_EntityType.AGENT: "agent_list_transactions",
        }
