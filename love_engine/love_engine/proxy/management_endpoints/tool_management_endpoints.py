...
from love_engine.types.tool_management import (
    LOVE_ENGINE_ToolTableRow,
    ToolDetailResponse,
    ToolInputPolicy,
    ToolListResponse,
    ToolPolicyOption,
...
async def list_tools(
    ...
    """
    from love_engine.proxy.db.tool_registry_writer import list_tools as db_list_tools
...
async def get_tool_detail(
    ...
    """
    from love_engine.proxy.db.tool_registry_writer import get_tool as db_get_tool
    from love_engine.proxy.db.tool_registry_writer import list_overrides_for_tool
    from love_engine.proxy.proxy_server import prisma_client
...
@router.get(
    ...
    tags=["tool management"],
    dependencies=[Depends(user_api_key_auth)],
    response_model=LOVE_ENGINE_ToolTableRow,
)
async def get_tool(
    tool_name: str,
    user_api_key_dict: UserAPIKeyAuth = Depends(user_api_key_auth),
...
async def update_tool_policy(
    ...
    """
    from love_engine.proxy.db.tool_registry_writer import (
