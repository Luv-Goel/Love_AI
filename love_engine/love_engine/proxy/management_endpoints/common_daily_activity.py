...
from love_engine.repositories.table_repositories import DeletedVerificationTokenRepository
...
_PRISMA_TO_PG_TABLE: Dict[str, str] = {
    "love_engine_dailyuserspend": "LOVE_ENGINE_DailyUserSpend",
    "love_engine_dailyteamspend": "LOVE_ENGINE_DailyTeamSpend",
    "love_engine_dailyorganizationspend": "LOVE_ENGINE_DailyOrganizationSpend",
    "love_engine_dailyenduserspend": "LOVE_ENGINE_DailyEndUserSpend",
    "love_engine_dailyagentspend": "LOVE_ENGINE_DailyAgentSpend",
    "love_engine_dailytagspend": "LOVE_ENGINE_DailyTagSpend",
}
...
def _adjust_dates_for_timezone(
    ...
    The aggregation table (e.g. LOVE_ENGINE_DailyUserSpend) stores spend in whole-UTC-day
...
async def get_daily_activity(
    ...
    try:
        ...
        # LOVE_ENGINE_DailyUserSpend and LOVE_ENGINE_DailyTeamSpend) as a tiebreaker
