...
from love_engine.repositories.table_repositories import DailyTagSpendRepository
...
async def get_distinct_user_agent_tags(
    ...
    try:
        ...
        FROM "LOVE_ENGINE_DailyTagSpend" dts
...
async def get_daily_active_users(
    ...
    try:
        ...
        FROM "LOVE_ENGINE_DailyTagSpend" dts
        INNER JOIN "LOVE_ENGINE_VerificationToken" vt ON dts.api_key = vt.token
        {where_clause}
...
async def get_tag_summary(
    ...
    try:
        ...
        FROM "LOVE_ENGINE_DailyTagSpend" dts
        LEFT JOIN "LOVE_ENGINE_VerificationToken" vt ON dts.api_key = vt.token
        {where_clause}
        GROUP BY dts.tag
