...
Example: `spend_logs_row_count` is used to store the number of rows in the `LOVE_ENGINE_SpendLogs` table.
"""

from typing import Any, Literal

from love_engine.proxy._types import ProxyStateVariables
