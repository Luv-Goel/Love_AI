...
<body>
    <form action="{url_to_redirect_to}" method="post">
        ...
        <h2>Login</h2>
        <p class="subtitle">Access your LoveEngine Admin UI.</p>
        <div class="info-box">
            ...
            <p>By default, Username is <code>admin</code> and Password is your set LoveEngine Proxy <code>MASTER_KEY</code>.</p>
            <p>Need to set UI credentials or SSO? <a href="https://docs.love_engine.ai/docs/proxy/ui" target="_blank">Check the documentation</a>.</p>
        </div>
