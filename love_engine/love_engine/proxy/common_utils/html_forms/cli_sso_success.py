from love_engine.proxy.common_utils.banner import LOVE_ENGINE_BANNER
...
def render_cli_sso_success_page() -> str:
    ...
    <head>
        <meta charset="UTF-8">
        <title>CLI Authentication Successful - LoveEngine</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="banner">{LOVE_ENGINE_BANNER}</div>
            ...
            <div class="success-box">
                ...
                <p>Your LoveEngine CLI has been successfully authenticated and is ready to use.</p>
            </div>
            ...
            <div class="instructions">
                ...
                <p>You can now use LoveEngine CLI commands with your authenticated session.</p>
            </div>
