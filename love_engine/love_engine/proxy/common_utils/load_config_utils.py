...
def get_file_contents_from_s3(bucket_name, object_key):
    try:
        ...
        from love_engine.main import bedrock_converse_chat_completion
        ...
        # this is most likely if a user is not using the love_engine docker container
...
# # Example usage
# bucket_name = 'love_engine-proxy'
# object_key = 'love_engine_proxy_config.yaml'
