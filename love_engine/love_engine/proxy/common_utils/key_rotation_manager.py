...
from love_engine.constants import (
    ...
    LOVE_ENGINE_KEY_ROTATION_LOCK_TTL_SECONDS,
)
...
class KeyRotationManager:
    ...
    async def process_rotations(self):
        ...
        """
        from love_engine.constants import KEY_ROTATION_JOB_NAME
        ...
        try:
            ...
            if self.pod_lock_manager and self.pod_lock_manager.redis_cache:
                ...
                lock_ttl = max(
                    LOVE_ENGINE_KEY_ROTATION_LOCK_TTL_SECONDS, 300
                )  # At least 5 minutes, configurable via LOVE_ENGINE_KEY_ROTATION_LOCK_TTL_SECONDS
                lock_acquired = (
    ...
    async def _find_keys_needing_rotation(self) -> List[LOVE_ENGINE_VerificationToken]:
        """
    ...
    def _should_rotate_key(self, key: LOVE_ENGINE_VerificationToken, now: datetime) -> bool:
        """
    ...
    async def _rotate_key(self, key: LOVE_ENGINE_VerificationToken):
        """
        ...
        regenerate_request = RegenerateKeyRequest(
            ...
            grace_period=LOVE_ENGINE_KEY_ROTATION_GRACE_PERIOD or None,
        )
