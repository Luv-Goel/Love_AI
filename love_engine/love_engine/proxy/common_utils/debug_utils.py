...
from love_engine.constants import PYTHON_GC_THRESHOLD
...
if os.environ.get("LOVE_ENGINE_PROFILE", "false").lower() == "true":
    try:
...
def _get_router_memory_stats(llm_router) -> Dict[str, Any]:
    """Get memory usage statistics for LoveEngine router."""
    love_engine_router_memory: Dict[str, Any] = {}
    try:
        if llm_router is not None:
            ...
            if hasattr(llm_router, "model_list") and llm_router.model_list:
                ...
                love_engine_router_memory["model_list"] = {
            ...
            if hasattr(llm_router, "model_names") and llm_router.model_names:
                ...
                love_engine_router_memory["model_names_set"] = {
            ...
            if hasattr(llm_router, "deployment_names") and llm_router.deployment_names:
                ...
                love_engine_router_memory["deployment_names"] = {
            ...
            if (
                ...
                love_engine_router_memory["deployment_latency_map"] = {
            ...
            if hasattr(llm_router, "fallbacks") and llm_router.fallbacks:
                ...
                love_engine_router_memory["fallbacks"] = {
            ...
            love_engine_router_memory["router_object"] = {
                "size_bytes": router_obj_size,
                "size_mb": round(router_obj_size / (1024 * 1024), 4),
            }

        else:
            love_engine_router_memory = {"note": "Router not initialized"}
    except Exception as e:
        verbose_proxy_logger.debug(f"Error getting router memory info: {e}")
        love_engine_router_memory = {"error": str(e)}

    return love_engine_router_memory
...
async def get_memory_details(
    ...
    love_engine_router_memory = _get_router_memory_stats(llm_router)
    ...
    return {
        ...
        "router_memory": love_engine_router_memory,
    }
