...
import love_engine
from love_engine.proxy._types import SpecialHeaders
...
class PrometheusAuthMiddleware:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        if love_engine.require_auth_for_metrics_endpoint is not False:
            ...
            try:
                await user_api_key_auth(
                    ...
                    or "",
                    custom_love_engine_key_header=request.headers.get(
                        SpecialHeaders.custom_love_engine_api_key.value
                    ),
                )
                ...
                body = json.dumps(
                    ...
                    f"`love_engine_settings.require_auth_for_metrics_endpoint: false` "
