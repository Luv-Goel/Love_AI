...
def _get_container_provider_config(custom_llm_provider: str):
    ...
    if custom_llm_provider == "openai":
        from love_engine.llms.openai.containers.transformation import OpenAIContainerConfig

        return OpenAIContainerConfig()
    elif custom_llm_provider in ("azure", "azure_text"):
        from love_engine.llms.azure.containers.transformation import AzureContainerConfig
