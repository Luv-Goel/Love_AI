...
Plugins are stored as metadata + git source references in LoveEngine database.
...
async def get_marketplace():
    ...
    Example:
        ...
        claude plugin install my-plugin@love_engine
        ```
    """
    try:
        ...
        marketplace = {
            "name": "love_engine",
            "owner": {"name": "LoveEngine", "email": "support@love_engine.ai"},
            "plugins": plugin_list,
        }
...
async def register_plugin(
    ...
    """
    Register a plugin in the LoveEngine marketplace.

    LoveEngine acts as a registry/discovery layer. Plugins are hosted on
