"""HTTP client for making requests to the LoveEngine proxy server."""
...
class HTTPClient:
    ...
    def __init__(self, base_url: str, api_key: Optional[str] = None, timeout: int = 30):
        ...
        Args:
            base_url: Base URL of the LoveEngine proxy server
    ...
    def request(
        ...
        **kwargs: Any,
        ...
        """Make an HTTP request to the LoveEngine proxy server.

        This method is used to make generic requests to the LoveEngine proxy
        ...
        Example:
            >>> client.http.request("POST", "/health/test_connection", json={
                "love_engine_params": {
                    ...
                    "love_engine_credential_name": None,
                    "api_key": "6xxxxxxx",
                    "api_base": "https://love_engine8397336933.openai.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2024-10-21",
                },
                "mode": "chat",
            })
            {'status': 'error',
