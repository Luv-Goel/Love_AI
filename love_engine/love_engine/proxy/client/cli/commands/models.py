...
def _get_model_info_obj_from_yaml(model: dict[str, Any]) -> ModelYamlInfo:
    ...
    model_params: dict[str, Any] = model["love_engine_params"]
...
@click.group()
def models() -> None:
    """Manage models on your LoveEngine proxy server"""
    pass
        ...
        column_configs: dict[str, dict[str, Any]] = {
            ...
            "upstream_model": {
                ...
                "get_value": lambda m: str(
                    m.get("love_engine_params", {}).get("model", "")
                ),
            },
            "credential_name": {
                ...
                "style": "yellow",
                "get_value": lambda m: str(
                    m.get("love_engine_params", {}).get("love_engine_credential_name", "")
                ),
            },
            "created_at": {
                "header": "Created At",
...
def _filter_model(model, model_regex, access_group_regex):
    ...
    model_params = model.get("love_engine_params")
...
@click.option(
    ...
    default=None,
    help="Only import models where love_engine_params.model matches the given regex.",
)
@click.option(
