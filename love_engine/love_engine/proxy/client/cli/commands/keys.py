...
@click.group()
def keys():
    """Manage API keys for the LoveEngine proxy server"""
    pass
...
@click.option(
    "--source-base-url",
    required=True,
    help="Base URL of the source LoveEngine proxy server to import keys from",
)
@click.option(
...
def import_keys(
    ...
    """Import API keys from another LoveEngine instance"""
