...
@click.group()
def http():
    """Make HTTP requests to the LoveEngine proxy server"""
    pass
...
def request(
    ...
    Examples:
        love_engine http request GET /models
        love_engine http request POST /chat/completions -j '{"model": "gpt-4", "messages": [{"role": "user", "content": "Hello"}]}'
        love_engine http request GET /health/test_connection -H "X-Custom-Header:value"
    """
