...
from love_engine.types.llms.vertex_ai import TokenCountDetailsResponse
...
async def google_stream_generate_content(
    ...
    data["_love_engine_skip_openai_stream_done"] = True
    data["_love_engine_raw_sse_stream"] = True
...
async def google_count_tokens(request: Request, model_name: str):
    ...
    ```
    """
    from love_engine.google_genai.adapters.transformation import GoogleGenAIAdapter
    from love_engine.proxy.common_utils.http_parsing_utils import _read_request_body
