...
from love_engine.proxy._types import PassThroughEndpointLoggingResultValues
...
from love_engine.types.utils import StandardPassThroughResponseObject
...
class PassThroughStreamingHandler:
    ...
    async def chunk_processor(
        ...
        cost_injection_active = (
            bool(getattr(love_engine, "include_cost_in_streaming_usage", False))
            and bool(model_name)
    ...
    async def _route_streaming_logging_to_handler(
        ...
        try:
            ...
            # and love_engine_params lacks an async flag (e.g. aanthropic_messages).
            await love_engine_logging_obj.dispatch_success_handlers(
    ...
    def _extract_model_for_cost_injection(
        ...
        if hasattr(love_engine_logging_obj, "model_call_details"):
            model = love_engine_logging_obj.model_call_details.get("model")
            if model:
                return model
