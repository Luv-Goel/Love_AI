...
from love_engine.proxy.pass_through_endpoints.llm_provider_handlers.openai_passthrough_logging_handler import (
    PassThroughEndpointLoggingTypedDict,
)
from love_engine.types.utils import LlmProviders, ModelResponse, Usage
...
class VertexAILivePassthroughLoggingHandler(BasePassthroughLoggingHandler):
    ...
    def _create_usage_object_from_metadata(
        ...
        """
        Create a LoveEngine Usage object from Live API usage metadata.
    ...
    def vertex_ai_live_passthrough_handler(
        ...
        **kwargs,
        ...
        Args:
            websocket_messages: List of WebSocket messages from the Live API
            logging_obj: LoveEngine logging object
        ...
        try:
            ...
            # Create Usage object for standard LoveEngine logging
