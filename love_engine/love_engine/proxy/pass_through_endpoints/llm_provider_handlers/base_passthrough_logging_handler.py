...
from love_engine.types.utils import LlmProviders, ModelResponse, TextCompletionResponse
...
class BasePassthroughLoggingHandler(ABC):
    ...
    def passthrough_chat_handler(
        ...
        **kwargs,
        ...
        love_engine_model_response: ModelResponse = provider_config.transform_response(
