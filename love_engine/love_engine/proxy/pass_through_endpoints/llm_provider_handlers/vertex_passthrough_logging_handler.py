...
if TYPE_CHECKING:
    from love_engine.types.utils import LoveEngineBatch
...
class VertexPassthroughLoggingHandler:
        ...
        **kwargs,
        ...
        if "predictLongRunning" in url_route:
            ...
            response_cost = love_engine.completion_cost(
                completion_response=love_engine_video_response,
                model=model,
                custom_llm_provider="vertex_ai",
            ...
            if not hasattr(love_engine_video_response, "_hidden_params"):
                love_engine_video_response._hidden_params = {}
            love_engine_video_response._hidden_params["response_cost"] = response_cost
            ...
            return {
                "result": love_engine_video_response,
                "kwargs": kwargs,
            }
            ...
            instance_of_vertex_llm = love_engine.VertexGeminiConfig()
            love_engine_model_response: ModelResponse = (
            ...
            kwargs = VertexPassthroughLoggingHandler._create_vertex_response_logging_payload_for_generate_content(
                love_engine_model_response=love_engine_model_response,
                model=model,
                kwargs=kwargs,
            ...
            from love_engine.llms.vertex_ai.vertex_ai_partner_models import (
            ...
            love_engine_prediction_response = ModelResponse()
            ...
            if vertex_publisher_or_api_spec is not None:
                ...
                love_engine_prediction_response = (
                    vertex_ai_partner_model_config.transform_response(
                        model=model,
                        raw_response=httpx_response,
                        model_response=love_engine_prediction_response,
                        logging_obj=logging_obj,
                        request_data={},
                        encoding=love_engine.encoding,
                        optional_params={},
            ...
            kwargs = VertexPassthroughLoggingHandler._create_vertex_response_logging_payload_for_generate_content(
                love_engine_model_response=love_engine_prediction_response,
            ...
            return {
                "result": love_engine_prediction_response,
                "kwargs": kwargs,
            }
        elif "search" in url_route:
            love_engine_vs_response = (
            ...
            response_cost = love_engine.completion_cost(
                completion_response=love_engine_vs_response,
            ...
            standard_pass_through_response_object: StandardPassThroughResponseObject = {
                "response": cast(dict, love_engine_vs_response),
            }

            kwargs["response_cost"] = response_cost
            kwargs["model"] = "vertex_ai/search_api"
            logging_obj.model_call_details.setdefault("love_engine_params", {})
            logging_obj.model_call_details["love_engine_params"][
                "base_model"
    ...
    def _handle_predict_response(
        ...
        from love_engine.llms.vertex_ai.image_generation.image_generation_handler import (
            VertexImageGeneration,
        )
        from love_engine.llms.vertex_ai.multimodal_embeddings.transformation import (
            VertexAIMultimodalEmbeddingConfig,
        )
        from love_engine.types.utils import PassthroughCallTypes
        ...
        love_engine_prediction_response: Union[
        ...
        if vertex_image_generation_class.is_image_generation_response(_json_response):
            ...
            love_engine_prediction_response = (
                vertex_multimodal_config.transform_embedding_response(
                    model=model,
                    raw_response=httpx_response,
                    model_response=love_engine.EmbeddingResponse(),
                    logging_obj=logging_obj,
                    api_key="",
                    request_data={},
                    optional_params={},
            ...
            love_engine_prediction_response = (
                love_engine.vertexAITextEmbeddingConfig.transform_vertex_response_to_openai(
                    response=_json_response,
                    model=model,
                    model_response=love_engine.EmbeddingResponse(),
                )
            )
        if isinstance(love_engine_prediction_response, love_engine.EmbeddingResponse):
            love_engine_prediction_response.model = model
        ...
        logging_obj.custom_llm_provider = "vertex_ai"
        response_cost = love_engine.completion_cost(
            completion_response=love_engine_prediction_response,
            model=model,
            custom_llm_provider="vertex_ai",
        )
    ...
    def _handle_embed_content_response(
        ...
        from love_engine.llms.vertex_ai.gemini_embeddings.batch_embed_content_transformation import (
        ...
        model_response = love_engine.EmbeddingResponse()
        if is_batch:
            love_engine_embedding_response = process_batch_embed_response(
                input=input_text,
            ...
            love_engine_embedding_response = process_embed_content_response(
                input=input_text,
                model_response=model_response,
                model=model,
        ...
        love_engine_embedding_response.model = model
        logging_obj.model = model
        logging_obj.model_call_details["model"] = model
        ...
        response_cost = love_engine.completion_cost(
            completion_response=love_engine_embedding_response,
            model=model,
        ...
        return {
            "result": love_engine_embedding_response,
            "kwargs": kwargs,
        }
    ...
    def _handle_logging_vertex_collected_chunks(
        ...
        """
        Takes raw chunks from Vertex passthrough endpoint and logs them in love_engine callbacks

        - Builds complete response from chunks
        - Creates standard logging object
        - Logs in love_engine callbacks
        """
        kwargs: Dict[str, Any] = {}
        ...
        kwargs = VertexPassthroughLoggingHandler._create_vertex_response_logging_payload_for_generate_content(
            love_engine_model_response=complete_streaming_response,
            model=model,
            kwargs=kwargs,
            start_time=start_time,
            end_time=end_time,
    ...
    def _build_complete_streaming_response(
        ...
        if "generateContent" in url_route or "streamGenerateContent" in url_route:
            ...
            from love_engine.llms.anthropic.chat.handler import ModelResponseIterator
    ...
    def extract_model_name_from_vertex_path(vertex_model_path: str) -> str:
        ...
        Returns:
            The extracted model name for use with LoveEngine
        """
    ...
    def _get_custom_llm_provider_from_url(url: str) -> str:
        ...
        if parsed_url.hostname and parsed_url.hostname.endswith(
            ...
            return love_engine.LlmProviders.GEMINI.value
        return love_engine.LlmProviders.VERTEX_AI.value
    ...
    def _create_vertex_response_logging_payload_for_generate_content(
        love_engine_model_response: Union[ModelResponse, TextCompletionResponse],
        model: str,
        kwargs: dict,
        start_time: datetime,
        end_time: datetime,
        ...
        # set love_engine_call_id to logging response object
        love_engine_model_response.id = logging_obj.love_engine_call_id
        logging_obj.model = love_engine_model_response.model or model
        logging_obj.model_call_details["model"] = logging_obj.model
        logging_obj.model_call_details["custom_llm_provider"] = custom_llm_provider
        return kwargs
    ...
    def batch_prediction_jobs_handler(
        ...
        **kwargs,
        ...
        from love_engine.llms.vertex_ai.batches.transformation import (
        ...
        try:
            ...
            if httpx_response.status_code == 200 and "name" in _json_response:
                # Transform Vertex AI response to LoveEngine batch format
                love_engine_batch_response = VertexAIBatchTransformation.transform_vertex_ai_batch_response_to_openai_batch_response(
                    response=_json_response
                )
                ...
                # Format: base64(love_engine_proxy;model_id:{};llm_batch_id:{})
                actual_model_id = (
                ...
                unified_id_string = (
                    SpecialEnums.LOVE_ENGINE_MANAGED_BATCH_COMPLETE_STR.value.format(
                ...
                VertexPassthroughLoggingHandler._store_batch_managed_object(
                    ...
                    batch_object=love_engine_batch_response,
                ...
                love_engine_model_response = ModelResponse()
                love_engine_model_response.id = str(uuid.uuid4())
                love_engine_model_response.model = model_name
                love_engine_model_response.object = "batch_prediction_job"
                love_engine_model_response.created = int(start_time.timestamp())

                # Add batch-specific metadata to indicate this is a pending batch job
                love_engine_model_response.choices = [
                    Choices(
                        finish_reason="stop",
                        index=0,
                        message={
                ...
                love_engine_model_response = ModelResponse()
                love_engine_model_response.id = str(uuid.uuid4())
                love_engine_model_response.model = "vertex_ai_batch"
                love_engine_model_response.object = "batch_prediction_job"
                love_engine_model_response.created = int(start_time.timestamp())
        ...
        **kwargs,
        ...
        try:
            ...
            if managed_files_hook is not None and hasattr(
                ...
                _request_metadata = (kwargs.get("love_engine_params", {}) or {}).get(
                    "metadata", {}
                ) or {}
                ...
                user_api_key_dict = UserAPIKeyAuth(
                    ...
                    team_alias=None,
                    user_role=LoveEngineUserRoles.CUSTOMER,  # Use proper enum value
                    user_email=None,
                    max_budget=None,
