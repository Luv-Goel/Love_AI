...
from love_engine.types.passthrough_endpoints.vertex_ai import VertexPassThroughCredentials
...
class PassthroughEndpointRouter:
    ...
    def get_vector_store_credentials(
        ...
        vector_store_to_run: Optional[LOVE_ENGINE_ManagedVectorStore] = (
            love_engine.vector_store_registry.get_love_engine_managed_vector_store_from_registry(
