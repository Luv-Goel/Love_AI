...
from love_engine.proxy.utils import handle_exception_on_proxy, jsonify_object
from love_engine.repositories.credentials_repository import CredentialsRepository
from love_engine.types.utils import CreateCredentialItem, CredentialItem
...
async def delete_credential(
    ...
    try:
        ...
        ## DELETE FROM LOVE_ENGINE ##
        love_engine.credential_list = [
            cred
            for cred in love_engine.credential_list
    ...
    try:
        ...
        if existing_in_memory is not None:
            ...
            if new_name != credential_name:
                love_engine.credential_list = [
                    c
                    for c in love_engine.credential_list
