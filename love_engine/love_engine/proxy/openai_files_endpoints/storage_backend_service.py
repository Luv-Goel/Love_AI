...
from love_engine._uuid import uuid as uuid_module
from love_engine.llms.base_llm.files.storage_backend_factory import get_storage_backend
...
from love_engine.types.llms.openai import OpenAIFileObject, OpenAIFilesPurpose
...
class StorageBackendFileService:
    ...
    def _create_unified_file_id(
        ...
        """
        unified_file_id_str = (
            SpecialEnums.LOVE_ENGINE_MANAGED_FILE_COMPLETE_STR.value.format(
                file_type,
