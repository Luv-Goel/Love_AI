...
import love_engine
from love_engine import CreateFileRequest, get_secret_str
from love_engine._logging import verbose_proxy_logger
from love_engine.llms.base_llm.files.transformation import BaseFileEndpoints
...
from love_engine.proxy.utils import ProxyLogging, is_known_model
from love_engine.repositories.table_repositories import ManagedFileRepository
...
async def route_create_file(
    ...
    if target_storage and target_storage != "default":
        ...
        from love_engine.proxy.openai_files_endpoints.storage_backend_service import (
    ...
    if model is not None:
        ...
        response = await love_engine.acreate_file(
    ...
    # EXISTING: Deprecated loadbalancing approach (for backwards compatibility when not using managed files)
        ...
        love_engine.enable_loadbalancing_on_batch_endpoints is True
        and is_router_model
        ...
        response = await love_engine.acreate_file(**_create_file_request, custom_llm_provider=custom_llm_provider)  # type: ignore
...
async def create_file(
    ...
    love_engine_metadata: Optional[str] = Form(default=None),
    ...
    try:
        ...
        extracted_love_engine_metadata: Optional[Dict[str, Any]] = (
            extract_nested_form_metadata(
                form_data=form_data_dict, prefix="love_engine_metadata["
            )
        )
        ...
        # Add love_engine_metadata to data if provided (from form field)
        if extracted_love_engine_metadata is not None:
            data["love_engine_metadata"] = extracted_love_engine_metadata
        ...
        if love_engine.enable_loadbalancing_on_batch_endpoints is True:
        ...
        verbose_proxy_logger.exception(
            "love_engine.proxy.proxy_server.create_file(): Exception occured - {}".format(
                str(e)
            )
        )
...
async def get_file_content(
    ...
    try:
        ...
        ## check if file_id is a love_engine managed file
        ...
        if is_base64_unified_file_id:
            ...
            if hasattr(managed_files_obj, "prisma_client") and getattr(
                ...
                if db_file and db_file.storage_backend and db_file.storage_url:
                    ...
                    from love_engine.llms.base_llm.files.storage_backend_factory import (
                        get_storage_backend,
                    )
            ...
            from love_engine.proxy.openai_files_endpoints.file_content_streaming_handler import (
            ...
            if should_route:
                ...
                response = await love_engine.afile_content(
        ...
        verbose_proxy_logger.exception(
            "love_engine.proxy.proxy_server.retrieve_file_content(): Exception occured - {}".format(
                str(e)
            )
        )
...
async def get_file(
    ...
    try:
        ...
        if should_route:
            ...
            response = await love_engine.afile_retrieve(**data)  # type: ignore
        ...
        ## EXISTING: check if file_id is a love_engine managed file
            ...
            response = await love_engine.afile_retrieve(
        ...
        verbose_proxy_logger.error(
            "love_engine.proxy.proxy_server.retrieve_file(): Exception occured - {}".format(
                str(e)
            )
        )
        verbose_proxy_logger.debug(traceback.format_exc())
...
async def delete_file(
    ...
    try:
        ...
        if should_route:
            ...
            response = await love_engine.afile_delete(
                custom_llm_provider=credentials["custom_llm_provider"],  # type: ignore
                **data,
            )  # type: ignore
        ...
        verbose_proxy_logger.exception(
            "love_engine.proxy.proxy_server.delete_file(): Exception occured - {}".format(
                str(e)
            )
        )
        if isinstance(e, HTTPException):
...
async def list_files(
    ...
    try:
        ...
        if should_route:
            ...
            response = await love_engine.afile_list(
                custom_llm_provider=credentials["custom_llm_provider"],  # type: ignore
                purpose=purpose,
                **data,  # type: ignore
            )
        ...
        verbose_proxy_logger.error(
            "love_engine.proxy.proxy_server.list_files(): Exception occured - {}".format(
                str(e)
            )
        )
        verbose_proxy_logger.debug(traceback.format_exc())
