...
from love_engine.containers.utils import decode_managed_container_id_for_request
    ...
    def endpoint_func(
        ...
        **kwargs,
        ...
        try:
            ...
            love_engine_logging_obj: LoveEngineLoggingObj = kwargs.pop("love_engine_logging_obj")
            ...
            # Strip love_engine-managed container IDs before calling the provider API
