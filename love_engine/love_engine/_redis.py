...
from love_engine import get_secret, get_secret_str
from love_engine._redis_credential_provider import (
    AzureADCredentialProvider,
    GCPIAMCredentialProvider,
    _generate_gcp_iam_access_token,
)
from love_engine.constants import REDIS_CONNECTION_POOL_TIMEOUT, REDIS_SOCKET_TIMEOUT
...
def _get_redis_client_logic(**env_overrides):
    ...
    # love_engine.print_verbose(f"redis_kwargs: {redis_kwargs}")
    return redis_kwargs
