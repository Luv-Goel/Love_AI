...
from love_engine.compression.message_stubbing import (
    extract_key,
    stub_message,
    truncate_message,
)
from love_engine.compression.retrieval_tool import build_retrieval_tool
from love_engine.compression.scoring.bm25 import bm25_score_messages
from love_engine.love_engine_core_utils.token_counter import token_counter
from love_engine.types.compression import CompressedResult
...
def compress(
    ...
    Parameters:
        ...
        call_type: The love_engine call type whose message schema these messages
        ...
        embedding_model_params: Optional kwargs forwarded to
            ``love_engine.embedding()`` when ``embedding_model`` is set.
        compression_cache: Passed through to ``love_engine.embedding()`` for
    ...
    if embedding_model:
        from love_engine.compression.scoring.embedding_scorer import (
