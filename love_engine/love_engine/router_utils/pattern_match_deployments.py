...
class PatternMatchRouter:
    ...
    doc: https://docs.love_engine.ai/docs/proxy/configs#provider-specific-wildcard-routing
    ...
    def _return_pattern_matched_deployments(
        ...
        for deployment in deployments:
            ...
            new_deployment["love_engine_params"]["model"] = (
                PatternMatchRouter.set_deployment_model_name(
                    matched_pattern=matched_pattern,
                    love_engine_deployment_love_engine_model=deployment["love_engine_params"][
                        "model"
                    ],
                )
            )
    ...
    def set_deployment_model_name(
        ...
        love_engine_deployment_love_engine_model: str,
    ) -> str:
        """
        ...
        if "*" not in love_engine_deployment_love_engine_model:
            return love_engine_deployment_love_engine_model

        wildcard_count = love_engine_deployment_love_engine_model.count("*")
        ...
        # Replace the corresponding wildcards in the love_engine model pattern with extracted segments
        for segment in dynamic_segments:
            love_engine_deployment_love_engine_model = love_engine_deployment_love_engine_model.replace(
                "*", segment, 1
            )
