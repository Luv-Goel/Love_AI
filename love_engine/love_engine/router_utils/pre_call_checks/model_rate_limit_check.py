...
When enabled via `enforce_model_rate_limits: true` in love_engine_settings,
...
class ModelRateLimitingCheck(CustomLogger):
    ...
    def _get_deployment_limits(
        ...
        # Check love_engine_params
        if tpm is None:
            tpm = deployment.get("love_engine_params", {}).get("tpm")
        if rpm is None:
            rpm = deployment.get("love_engine_params", {}).get("rpm")
    ...
    def pre_call_check(self, deployment: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            model_id = deployment.get("model_info", {}).get("id")
            model_name = deployment.get("love_engine_params", {}).get("model")
                    ...
                    raise love_engine.RateLimitError(
                        ...
                        response=httpx.Response(
                            ...
                            request=httpx.Request(
                                ...
                                url="https://github.com/BerriAI/love_engine",
                            ),
                        ),
                    )
        ...
        except love_engine.RateLimitError:
            raise
