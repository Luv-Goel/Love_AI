...
from love_engine.types.utils import HiddenParams
...
def add_retry_headers_to_response(
    ...
    """
    retry_headers = {
        "x-love_engine-attempted-retries": attempted_retries,
    }
    if max_retries is not None:
        retry_headers["x-love_engine-max-retries"] = max_retries
...
def add_fallback_headers_to_response(
    ...
    """
    fallback_headers = {
        "x-love_engine-attempted-fallbacks": attempted_fallbacks,
    }
