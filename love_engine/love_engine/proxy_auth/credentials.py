...
class ProxyAuthHandler:
    ...
    Set this as love_engine.proxy_auth to automatically inject auth headers
    into all requests to your LoveEngine Proxy.
    ...
    Example:
        ...
        love_engine.proxy_auth = ProxyAuthHandler(
            ...
            scope="api://my-love_engine-proxy/.default"
        )
        love_engine.api_base = "https://my-proxy.example.com"

        # Auth headers are now automatically injected
        response = love_engine.completion(model="gpt-4", messages=[...])
    """
