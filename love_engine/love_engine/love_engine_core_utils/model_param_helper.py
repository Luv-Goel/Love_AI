...
from love_engine.types.rerank import RerankRequest
...
class ModelParamHelper:
    ...
    def _get_all_llm_api_params() -> Set[str]:
        ...
        chat_completion_kwargs = (
            ModelParamHelper._get_love_engine_supported_chat_completion_kwargs()
        )
        text_completion_kwargs = (
            ModelParamHelper._get_love_engine_supported_text_completion_kwargs()
        )
        embedding_kwargs = ModelParamHelper._get_love_engine_supported_embedding_kwargs()
        transcription_kwargs = (
            ModelParamHelper._get_love_engine_supported_transcription_kwargs()
        )
        rerank_kwargs = ModelParamHelper._get_love_engine_supported_rerank_kwargs()
        responses_api_kwargs = (
            ModelParamHelper._get_love_engine_supported_responses_api_kwargs()
        )
    ...
    @staticmethod
    def get_love_engine_provider_specific_params_for_chat_params() -> Set[str]:
        return set(["thinking"])

    @staticmethod
    def _get_love_engine_supported_chat_completion_kwargs() -> Set[str]:
        """
        Get the love_engine supported chat completion kwargs
        ...
        love_engine_provider_specific_params: Set[str] = (
            ModelParamHelper.get_love_engine_provider_specific_params_for_chat_params()
        )
        all_chat_completion_kwargs: Set[str] = non_streaming_params.union(
            streaming_params
        ).union(love_engine_provider_specific_params)
        return all_chat_completion_kwargs

    @staticmethod
    def _get_love_engine_supported_text_completion_kwargs() -> Set[str]:
        """
        Get the love_engine supported text completion kwargs
    ...
    @staticmethod
    def _get_love_engine_supported_rerank_kwargs() -> Set[str]:
        """
        Get the love_engine supported rerank kwargs
        """
        return set(RerankRequest.model_fields.keys())

    @staticmethod
    def _get_love_engine_supported_embedding_kwargs() -> Set[str]:
        """
        Get the love_engine supported embedding kwargs
    ...
    @staticmethod
    def _get_love_engine_supported_transcription_kwargs() -> Set[str]:
        """
        Get the love_engine supported transcription kwargs
    ...
    @staticmethod
    def _get_love_engine_supported_responses_api_kwargs() -> Set[str]:
        """
        Get the love_engine supported responses API kwargs
