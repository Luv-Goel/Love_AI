...
from love_engine.types.realtime import ALL_DELTA_TYPES

from .love_engine_logging import Logging as LoveEngineLogging
...
class RealTimeStreaming:
    def __init__(
        ...
        _logged_real_time_event_types = love_engine.logged_real_time_event_types
    ...
    def _enforce_transcription_session_model(self, message: str) -> str:
        ...
        a resolved LoveEngine model before opening the backend websocket. If a
