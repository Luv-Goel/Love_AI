"""
Utils used for love_engine.transcription() and love_engine.atranscription()
"""
...
from love_engine.types.files import get_file_mime_type_from_extension
...
def process_audio_file(audio_file: FileTypes) -> ProcessedAudioFile:
    ...
    # Determine content type using LoveEngine's file type utilities
