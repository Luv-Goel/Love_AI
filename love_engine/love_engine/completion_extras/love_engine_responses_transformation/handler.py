...
if TYPE_CHECKING:
    from love_engine import CustomStreamWrapper, LoveEngineLoggingObj, ModelResponse
...
class ResponsesToCompletionBridgeHandler:
    def __init__(self):
        from .transformation import LoveEngineResponsesTransformationHandler

        super().__init__()
        self.transformation_handler = LoveEngineResponsesTransformationHandler()

    @staticmethod
    def _resolve_stream_flag(optional_params: dict, love_engine_params: dict) -> bool:
        stream = optional_params.get("stream")
        if stream is None:
            stream = love_engine_params.get("stream", False)
        return bool(stream)
    ...
    def validate_input_kwargs(
        ...
        from love_engine import LoveEngineLoggingObj
        ...
        if love_engine_params is None or not isinstance(love_engine_params, dict):
            raise ValueError("love_engine_params is required")
        ...
        if logging_obj is None or not isinstance(logging_obj, LoveEngineLoggingObj):
    ...
    def completion(self, *args, **kwargs) -> Union[
        ...
        from love_engine import responses
        from love_engine.love_engine_core_utils.streaming_handler import CustomStreamWrapper
        ...
        love_engine_params = validated_kwargs["love_engine_params"]
        ...
        # `sanitized_love_engine_params`; overwriting it on the dict (rather
        ...
        stream = self._resolve_stream_flag(optional_params, love_engine_params)
    ...
    async def acompletion(
        ...
        from love_engine import aresponses
        from love_engine.love_engine_core_utils.streaming_handler import CustomStreamWrapper
        ...
        # keyword TypeError when `sanitized_love_engine_params` already
