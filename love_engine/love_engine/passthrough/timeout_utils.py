...
def resolve_pass_through_request_timeout(
    ...
    try:
        proxy_server = sys.modules.get("love_engine.proxy.proxy_server")
...
def resolve_llm_passthrough_timeout(
    ...
    Precedence: kwargs timeout/request_timeout -> love_engine_params timeout/request_timeout
    -> router_timeout -> general_settings.pass_through_request_timeout -> 600s default.
    """
    kwargs = kwargs or {}
    love_engine_params = love_engine_params or {}

    for source in (kwargs, love_engine_params):
