...
Canonical definitions for ``love_engine_teamtable`` (plus the shared Member and
...
class MemberBase(LoveEnginePydanticObjectBase):
...
class BudgetLimitEntry(LoveEnginePydanticObjectBase):
...
class LOVE_ENGINE_ModelTable(LoveEnginePydanticObjectBase):
    id: Optional[int] = None
    model_aliases: Optional[Union[str, dict]] = None
    created_by: str
    updated_by: str
    team: Optional["LOVE_ENGINE_TeamTable"] = None

    model_config = ConfigDict(protected_namespaces=())


class TeamBase(LoveEnginePydanticObjectBase):
...
class LOVE_ENGINE_TeamTable(TeamBase):
    ...
    love_engine_model_table: Optional[LOVE_ENGINE_ModelTable] = None
...
class LOVE_ENGINE_TeamTableCachedObj(LOVE_ENGINE_TeamTable):
    last_refreshed_at: Optional[float] = None


class LOVE_ENGINE_DeletedTeamTable(LOVE_ENGINE_TeamTable):
...
LOVE_ENGINE_ModelTable.model_rebuild()
