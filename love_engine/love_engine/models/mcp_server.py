...
Canonical definition for ``love_engine_mcpservertable``. Re-exported from
...
from love_engine.types.mcp import MCPAuthType, MCPCredentials, MCPTransportType
...
class MCPEnvVar(LoveEnginePydanticObjectBase):
    ...
    values are stored per-user in ``LOVE_ENGINE_MCPUserEnvVars`` and supplied by
    each user.
    """
...
class LOVE_ENGINE_MCPServerTable(LoveEnginePydanticObjectBase):
    """Represents a LOVE_ENGINE_MCPServerTable record"""
