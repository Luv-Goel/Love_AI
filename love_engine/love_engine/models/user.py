...
Canonical definition for ``love_engine_usertable``. Re-exported from
...
from love_engine.models.organization_membership import (
    LOVE_ENGINE_OrganizationMembershipTable,
)
from love_engine.types.llms.base import LoveEnginePydanticObjectBase


class LOVE_ENGINE_UserTable(LoveEnginePydanticObjectBase):
    user_id: str
    ...
    organization_memberships: Optional[List[LOVE_ENGINE_OrganizationMembershipTable]] = None
