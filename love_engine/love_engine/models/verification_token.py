...
Canonical definition for ``love_engine_verificationtoken``. Re-exported from
...
class LOVE_ENGINE_VerificationToken(LoveEnginePydanticObjectBase):
    ...
    love_engine_budget_table: Optional[dict] = None
...
class LOVE_ENGINE_DeletedVerificationToken(LOVE_ENGINE_VerificationToken):
