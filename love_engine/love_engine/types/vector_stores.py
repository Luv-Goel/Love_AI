...
class LOVE_ENGINE_VectorStoreConfig(TypedDict, total=False):
    """Parameters for initializing a vector store on LoveEngine proxy config.yaml"""

    vector_store_name: str
    love_engine_params: Optional[Dict[str, Any]]


class LOVE_ENGINE_ManagedVectorStore(TypedDict, total=False):
    """LoveEngine managed vector store object - this is is the object stored in the database"""
...
class LOVE_ENGINE_ManagedVectorStoreListResponse(TypedDict, total=False):
    """Response format for listing vector stores"""

    object: Literal["list"]  # Always "list"
    data: List[LOVE_ENGINE_ManagedVectorStore]
...
class IndexCreateLoveEngineParams(BaseModel):
...
class IndexCreateRequest(BaseModel):
    index_name: str
    love_engine_params: IndexCreateLoveEngineParams
...
class LOVE_ENGINE_ManagedVectorStoreIndex(BaseModel):
    """LoveEngine managed vector store index object - this is is the object stored in the database"""
