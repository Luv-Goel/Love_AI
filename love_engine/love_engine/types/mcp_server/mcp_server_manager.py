...
from love_engine.types.mcp import MCPAuth, MCPAuthType, MCPTransportType
...
class MCPServer(BaseModel):
    ...
    # bypass LoveEngine API-key/SSO auth (and the pre-emptive 401) so the client
    ...
    # Resolved short-ID tool prefix when LOVE_ENGINE_USE_SHORT_MCP_TOOL_PREFIX is
