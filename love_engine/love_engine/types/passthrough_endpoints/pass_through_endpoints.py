...
LOVE_ENGINE_PASS_THROUGH_CUSTOM_BODY_STATE_KEY = "love_engine_pass_through_custom_body"
...
LOVE_ENGINE_PASS_THROUGH_RAW_BODY_STATE_KEY = "love_engine_pass_through_raw_body"
