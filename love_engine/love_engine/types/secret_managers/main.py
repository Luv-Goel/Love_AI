...
class KeyManagementSettings(LoveEnginePydanticObjectBase):
    hosted_keys: Optional[List] = None
    store_virtual_keys: Optional[bool] = False
    """
    If True, virtual keys created by love_engine will be stored in the secret manager
    """
    prefix_for_stored_virtual_keys: str = "love_engine/"
    """
