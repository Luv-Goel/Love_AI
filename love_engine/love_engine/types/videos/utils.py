...
from love_engine.types.videos.main import DecodedVideoId

VIDEO_ID_PREFIX = "video_"
CHARACTER_ID_PREFIX = "character_"
CHARACTER_ID_TEMPLATE = "love_engine:custom_llm_provider:{};model_id:{};character_id:{}"
...
def encode_video_id_with_provider(
    ...
    assembled_id = str(SpecialEnums.LOVE_ENGINE_MANAGED_VIDEO_COMPLETE_STR.value).format(
