...
class TeamListItem(LOVE_ENGINE_TeamTable):
...
class TeamListResponse(BaseModel):
    ...
    teams: List[Union[TeamListItem, LOVE_ENGINE_TeamTable, LOVE_ENGINE_DeletedTeamTable]]
    total: int
    page: int
    page_size: int
    total_pages: int
...
class TeamMemberInfoResponse(LOVE_ENGINE_TeamMembership):
