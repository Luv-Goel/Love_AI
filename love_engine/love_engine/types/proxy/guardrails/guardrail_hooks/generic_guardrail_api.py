...
from love_engine.types.utils import ChatCompletionMessageToolCall
...
class GenericGuardrailAPIRequest(BaseModel):
    ...
    love_engine_call_id: Optional[str] = None  # the call id of the individual LLM call
    love_engine_trace_id: Optional[str] = (
    ...
    love_engine_version: Optional[str] = Field(
        default=None,
        description="LoveEngine library version running this proxy.",
    )
