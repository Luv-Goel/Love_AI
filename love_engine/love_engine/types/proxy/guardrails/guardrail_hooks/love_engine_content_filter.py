...
class ContentFilterCategoryConfig(BaseLoveEngineOpenAIResponseObject):
    """
...
class LoveEngineContentFilterGuardrailConfigModel(GuardrailConfigModel):
    """
    Configuration model for LoveEngine Content Filter guardrail.
    ...
    def ui_friendly_name() -> str:
        return "LoveEngine Content Filter"
