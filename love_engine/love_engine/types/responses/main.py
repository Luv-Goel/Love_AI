...
class GenericResponseOutputItemContentAnnotation(BaseLoveEngineOpenAIResponseObject):
...
class OutputText(BaseLoveEngineOpenAIResponseObject):
...
class OutputFunctionToolCall(BaseLoveEngineOpenAIResponseObject):
...
class OutputImageGenerationCall(BaseLoveEngineOpenAIResponseObject):
...
class OutputCodeInterpreterCallLog(BaseLoveEngineOpenAIResponseObject):
...
class OutputCodeInterpreterCall(BaseLoveEngineOpenAIResponseObject):
...
class GenericResponseOutputItem(BaseLoveEngineOpenAIResponseObject):
    """
...
class DeleteResponseResult(BaseLoveEngineOpenAIResponseObject):
    """
