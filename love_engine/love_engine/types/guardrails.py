...
from love_engine.types.proxy.guardrails.guardrail_hooks.akto import (
    AktoConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.block_code_execution import (
    BlockCodeExecutionGuardrailConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.enkryptai import (
    EnkryptAIGuardrailConfigs,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.grayswan import (
    GraySwanGuardrailConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.ibm import (
    IBMGuardrailsBaseConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.love_engine_content_filter import (
    ContentFilterCategoryConfig,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.ovalix import (
    OvalixGuardrailConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.promptguard import (
    PromptGuardConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.xecguard import (
    XecGuardConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.qualifire import (
    QualifireGuardrailConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.tool_permission import (
    ToolPermissionGuardrailConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.hiddenlayer import (
    HiddenlayerGuardrailConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.qohash import (
    QostodianNexusConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.vigil_guard import (
    VigilGuardGuardrailConfigModel,
)
from love_engine.types.proxy.guardrails.guardrail_hooks.cisco_ai_defense import (
    CiscoAIDefenseGuardrailConfigModel,
)

"""
Pydantic object defining how to set guardrails on love_engine proxy
...
class SupportedGuardrailIntegrations(Enum):
    ...
    LOVE_ENGINE_CONTENT_FILTER = "love_engine_content_filter"
...
class PresidioPresidioConfigModelUserInterface(BaseModel):
    """Configuration parameters for the Presidio PII masking guardrail on LoveEngine UI"""
    ...
    output_parse_pii: Optional[bool] = Field(
        default=None,
        description="When True, LoveEngine will replace the masked text with the original text in the response",
...
class NomaGuardrailConfigModel(BaseModel):
    ...
    application_id: Optional[str] = Field(
        default=None,
        description="Application ID for Noma Security. Defaults to 'love_engine' if not provided",
    )
...
class BaseLoveEngineParams(
    ...
    skip_system_message_in_guardrail: Optional[bool] = Field(
        ...
        description=(
            ...
            "messages are included even if love_engine_settings sets a global skip. When "
            "None, use the global love_engine.skip_system_message_in_guardrail setting."
        ),
    )
    ...
    skip_tool_message_in_guardrail: Optional[bool] = Field(
        ...
        description=(
            ...
            "messages are included even if love_engine_settings sets a global skip. When "
            "None, use the global love_engine.skip_tool_message_in_guardrail setting."
        ),
    )
    ...
    def validate_sensitive_data_routing(self) -> "BaseLoveEngineParams":
...
class Guardrail(TypedDict, total=False):
    ...
    love_engine_params: Required[LoveEngineParams]
...
class GuardrailInfoResponse(BaseModel):
    ...
    guardrail_name: str
    love_engine_params: Optional[BaseLoveEngineParams] = None
