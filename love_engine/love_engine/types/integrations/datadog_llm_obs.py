...
from love_engine.types.integrations.custom_logger import StandardCustomLoggerInitParams
...
class DatadogLLMObsInitParams(StandardCustomLoggerInitParams):
    """
    Params for initializing a DatadogLLMObs logger on love_engine
    """
...
class DDLLMObsLatencyMetrics(TypedDict, total=False):
    ...
    love_engine_overhead_time_ms: float
