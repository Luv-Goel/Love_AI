...
class SlackAlertingArgs(LoveEnginePydanticObjectBase):
...
class DeploymentMetrics(LoveEnginePydanticObjectBase):
    """
...
class AlertTypeConfig(LoveEnginePydanticObjectBase):
