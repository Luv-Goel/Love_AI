...
class LoveEngineBatchCreateRequest(CreateBatchRequest, total=False):
    model: str
...
):  # love_engine wrapper on top of openai object for handling cached content
...
class ChatCompletionRequest(TypedDict, total=False):
    ...
    functions: List
    user: str
    metadata: dict  # love_engine specific param
...
class LoveEngineFineTuningJobCreate(FineTuningJobCreate):
...
class OutputTokensDetails(BaseLoveEngineOpenAIResponseObject):
...
class InputTokensDetails(BaseLoveEngineOpenAIResponseObject):
...
class ResponseAPIUsage(BaseLoveEngineOpenAIResponseObject):
    input_tokens: int
...
class ResponsesAPIResponse(BaseLoveEngineOpenAIResponseObject):
    id: str
    created_at: int
    ...
    def _serialize_output_filter_reasoning_nulls(cls, value, handler, _info):
        ...
        Issue: https://github.com/BerriAI/love_engine/issues/16824
        """
...
class ResponseCreatedEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_CREATED]
    response: ResponsesAPIResponse


class ResponseInProgressEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_IN_PROGRESS]
    response: ResponsesAPIResponse


class ResponseCompletedEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_COMPLETED]
    response: ResponsesAPIResponse
    _hidden_params: dict = PrivateAttr(default_factory=dict)


class ResponseFailedEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_FAILED]
    response: ResponsesAPIResponse


class ResponseIncompleteEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_INCOMPLETE]
    response: ResponsesAPIResponse


class ResponsePartAddedEvent(BaseLoveEngineOpenAIResponseObject):
...
class ReasoningSummaryTextDeltaEvent(BaseLoveEngineOpenAIResponseObject):
...
class ReasoningSummaryTextDoneEvent(BaseLoveEngineOpenAIResponseObject):
...
class ReasoningSummaryPartDoneEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.REASONING_SUMMARY_PART_DONE]
    item_id: str
    output_index: int
    sequence_number: int
    summary_index: int = 0
    part: BaseLoveEngineOpenAIResponseObject


class OutputItemAddedEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_ADDED]
    output_index: int
    item: Optional[BaseLoveEngineOpenAIResponseObject]


class OutputItemDoneEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_DONE]
    output_index: int
    sequence_number: int = 1
    item: BaseLoveEngineOpenAIResponseObject
...
class ContentPartAddedEvent(BaseLoveEngineOpenAIResponseObject):
...
class ContentPartDonePartOutputText(BaseLoveEngineOpenAIResponseObject):
    type: Literal["output_text"]
    text: str
    annotations: List[BaseLoveEngineOpenAIResponseObject]
    logprobs: Optional[List[OpenAIChatCompletionLogprobsContent]]


class ContentPartDonePartRefusal(BaseLoveEngineOpenAIResponseObject):
    type: Literal["refusal"]
    refusal: str


class ContentPartDonePartReasoningText(BaseLoveEngineOpenAIResponseObject):
...
class ContentPartDoneEvent(BaseLoveEngineOpenAIResponseObject):
...
class OutputTextDeltaEvent(BaseLoveEngineOpenAIResponseObject):
...
class OutputTextAnnotationAddedEvent(BaseLoveEngineOpenAIResponseObject):
...
class OutputTextDoneEvent(BaseLoveEngineOpenAIResponseObject):
...
class RefusalDeltaEvent(BaseLoveEngineOpenAIResponseObject):
...
class RefusalDoneEvent(BaseLoveEngineOpenAIResponseObject):
...
class FunctionCallArgumentsDeltaEvent(BaseLoveEngineOpenAIResponseObject):
...
class FunctionCallArgumentsDoneEvent(BaseLoveEngineOpenAIResponseObject):
...
class FileSearchCallInProgressEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class FileSearchCallSearchingEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class FileSearchCallCompletedEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class WebSearchCallInProgressEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class WebSearchCallSearchingEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class WebSearchCallCompletedEvent(BaseLoveEngineOpenAIResponseObject):
...
class MCPListToolsInProgressEvent(BaseLoveEngineOpenAIResponseObject):
...
class MCPListToolsCompletedEvent(BaseLoveEngineOpenAIResponseObject):
...
class MCPListToolsFailedEvent(BaseLoveEngineOpenAIResponseObject):
...
# MCP Call Events
class MCPCallInProgressEvent(BaseLoveEngineOpenAIResponseObject):
...
class MCPCallArgumentsDeltaEvent(BaseLoveEngineOpenAIResponseObject):
...
class MCPCallArgumentsDoneEvent(BaseLoveEngineOpenAIResponseObject):
...
class MCPCallCompletedEvent(BaseLoveEngineOpenAIResponseObject):
...
class MCPCallFailedEvent(BaseLoveEngineOpenAIResponseObject):
...
class ImageGenerationPartialImageEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.IMAGE_GENERATION_PARTIAL_IMAGE]
    partial_image_index: int
    b64_json: str


class ErrorEventError(BaseLoveEngineOpenAIResponseObject):
...
class ErrorEvent(BaseLoveEngineOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.ERROR]
    sequence_number: int
    error: ErrorEventError


class GenericEvent(BaseLoveEngineOpenAIResponseObject):
    type: str
...
class OpenAIModerationResult(BaseLoveEngineOpenAIResponseObject):
...
class OpenAIModerationResponse(BaseLoveEngineOpenAIResponseObject):
    """
