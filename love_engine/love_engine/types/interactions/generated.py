...
# ============================================================
# LoveEngine-specific types (added manually after generation)
# ============================================================
#
...
class InteractionsAPIResponse(BaseLoveEngineOpenAIResponseObject):
    """
    Response from the Interactions API.

    Wraps the API response with LoveEngine-specific hidden params.
...
class InteractionsAPIStreamingResponse(BaseLoveEngineOpenAIResponseObject):
    """
...
class DeleteInteractionResult(BaseLoveEngineOpenAIResponseObject):
...
class CancelInteractionResult(BaseLoveEngineOpenAIResponseObject):
