...
if TYPE_CHECKING:
    ...
    class GenerateContentResponse(GoogleGenAIGenerateContentResponse, BaseLoveEngineOpenAIResponseObject):  # type: ignore[misc, valid-type]
        _hidden_params: dict = {}
        pass
    ...
    class GenerateContentResponse(BaseLoveEngineOpenAIResponseObject):  # type: ignore[misc]
        def __init__(self, **kwargs):  # type: ignore
            super().__init__(**kwargs)
