...
from love_engine.interactions.streaming_iterator import (
...
class _BaseHTTPHandler:
    """
    Shared HTTP infrastructure for love_engine handler classes.
    ...
    def _async_client(
        ...
        # GenericLoveEngineParams.get uses getattr; an unset field is None, not the default.
        custom_llm_provider = love_engine_params.get("custom_llm_provider") or "gemini"
...
class InteractionsHTTPHandler(_BaseHTTPHandler):
    ...
    def create_interaction(
        ...
        api_base = interactions_api_config.get_complete_url(
            api_base=love_engine_params.api_base or "",
            model=model,
            agent=agent,
