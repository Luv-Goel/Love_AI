"""
love_engine Agents API - Main Module

Usage:
    import love_engine

    # Create
    response = love_engine.interactions.agents.create(
        name="waverunner",
    ...
    # List
    response = love_engine.interactions.agents.list(api_key="...", custom_llm_provider="gemini")

    # Get
    response = love_engine.interactions.agents.get(name="waverunner", api_key="...")

    # Delete
    result = love_engine.interactions.agents.delete(name="waverunner", api_key="...")

    # List versions
    result = love_engine.interactions.agents.list_versions(name="waverunner", api_key="...")
...
import love_engine
from love_engine.interactions.agents.http_handler import agents_http_handler
from love_engine.interactions.agents.utils import get_provider_agents_api_config
...
from love_engine.types.interactions import InteractionEnvironment
...
def _make_logging_obj(
    ...
    return love_engine_logging_obj
...
def create(
    ...
    **kwargs,
    ...
    Args:
        ...
        **kwargs: Forwarded to GenericLoveEngineParams (api_key, api_base, etc.).
    """
    local_vars = locals()
    custom_llm_provider = (
