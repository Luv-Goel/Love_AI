...
class LoveEngineResponsesInteractionsConfig:
        ...
        **kwargs,
        ...
        if input is not None:
            responses_request["input"] = (
                LoveEngineResponsesInteractionsConfig._transform_interactions_input_to_responses_input(
                    input
                )
            )
        ...
        if isinstance(input, list):
            ...
            for turn in input:
                if isinstance(turn, dict):
                    ...
                    transformed_content = (
                        LoveEngineResponsesInteractionsConfig._transform_content_array(
                            content
                        )
                    )
        ...
        if isinstance(input, dict):
            return cast(
                ...
                [
                    {
                        "role": "user",
                        "content": LoveEngineResponsesInteractionsConfig._transform_content_array(
                            input.get("content", [])
