...
class LoveEngineResponsesInteractionsStreamingIterator:
    """
    ...
    def __init__(
        self,
        model: str,
        love_engine_custom_stream_wrapper: BaseResponsesAPIStreamingIterator,
        ...
        self.model = model
        self.responses_stream_iterator = love_engine_custom_stream_wrapper
        self.request_input = request_input
        self.optional_params = optional_params
        self.custom_llm_provider = custom_llm_provider
        self.love_engine_metadata = love_engine_metadata or {}
        self.finished = False
        self.collected_text = ""
        ...
        self._use_legacy: bool = love_engine.use_legacy_interactions_schema
