...
def create_eval(
    ...
    **kwargs,
    ...
    try:
        ...
        api_base = love_engine_params.api_base or DEFAULT_OPENAI_API_BASE
...
def update_eval(
    ...
    **kwargs,
    ...
    try:
        ...
        # Filter metadata to exclude internal love_engine fields
        if metadata is not None:
            # List of internal love_engine metadata keys that should NOT be sent to OpenAI
            internal_keys = {
                "headers",
                "requester_metadata",
                "user_api_key_hash",
