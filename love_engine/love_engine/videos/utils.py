...
from love_engine.utils import filter_out_love_engine_params
...
class VideoGenerationRequestUtils:
    ...
    def get_requested_video_generation_optional_param(
        ...
        base_params = filter_out_love_engine_params(kwargs=base_params_raw)

        cleaned_kwargs = filter_out_love_engine_params(
        ...
        if merged_extra_body:
            merged_extra_body = filter_out_love_engine_params(kwargs=merged_extra_body)
            if merged_extra_body:
