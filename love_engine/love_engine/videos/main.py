...
import love_engine
from love_engine.constants import DEFAULT_VIDEO_ENDPOINT_MODEL
...
from love_engine.types.utils import CallTypes, FileTypes
from love_engine.types.videos.main import (
    CharacterObject,
    VideoCreateOptionalRequestParams,
    VideoObject,
)
from love_engine.types.videos.utils import decode_video_id_with_provider
from love_engine.utils import ProviderConfigManager, client
from love_engine.videos.utils import VideoGenerationRequestUtils
...
def video_generation(
    ...
    **kwargs,
    ...
    try:
        ...
        love_engine_logging_obj.call_type = CallTypes.create_video.value
...
def video_content(
    ...
    **kwargs,
    ...
    Example:
        ...
        video_bytes = love_engine.video_content(
            video_id="video_123"
        )
...
def video_remix(
    ...
    **kwargs,
    ...
    try:
        ...
        love_engine_logging_obj.call_type = CallTypes.video_remix.value
...
def video_list(
    ...
    **kwargs,
    ...
    try:
        ...
        love_engine_logging_obj.call_type = CallTypes.video_list.value
...
def video_status(
    ...
    **kwargs,
    ...
    Example:
        ...
        # Get video status
        video_status = love_engine.video_status(
            video_id="video_123"
        )
    ...
    try:
        ...
        love_engine_logging_obj.call_type = CallTypes.video_retrieve.value
    ...
    **kwargs,
    ...
    try:
        ...
        love_engine_logging_obj.update_environment_variables(
            ...
            love_engine_params={"love_engine_call_id": love_engine_call_id, **request_params},
            custom_llm_provider=custom_llm_provider,
        )

        love_engine_logging_obj.call_type = CallTypes.video_create_character.value
...
def video_get_character(
    ...
    **kwargs,
    ...
    try:
        ...
        love_engine_logging_obj.call_type = CallTypes.video_get_character.value
...
def video_edit(
    ...
    **kwargs,
    ...
    try:
        ...
        love_engine_logging_obj.call_type = CallTypes.video_edit.value
...
def video_extension(
    ...
    **kwargs,
    ...
    try:
        ...
        love_engine_logging_obj.call_type = CallTypes.video_extension.value
