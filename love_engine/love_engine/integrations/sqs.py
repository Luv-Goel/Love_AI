...
class SQSLogger(CustomBatchLogger, BaseAWSLLM):
        ...
        **kwargs,
        ...
        try:
            verbose_logger.debug(
                f"in init sqs logger - sqs_callback_params {love_engine.aws_sqs_callback_params}"
            )
    ...
    def _init_sqs_params(
        ...
        love_engine.aws_sqs_callback_params = love_engine.aws_sqs_callback_params or {}

        # read in .env variables - example os.environ/AWS_BUCKET_NAME
        for key, value in love_engine.aws_sqs_callback_params.items():
            if isinstance(value, str) and value.startswith("os.environ/"):
                love_engine.aws_sqs_callback_params[key] = love_engine.get_secret(value)

        self.sqs_queue_url = (
            love_engine.aws_sqs_callback_params.get("sqs_queue_url") or sqs_queue_url
        )
        self.sqs_region_name = (
            love_engine.aws_sqs_callback_params.get("sqs_region_name") or sqs_region_name
        )
        self.sqs_api_version = (
            love_engine.aws_sqs_callback_params.get("sqs_api_version") or sqs_api_version
        )
        self.sqs_use_ssl = (
            love_engine.aws_sqs_callback_params.get("sqs_use_ssl", True) or sqs_use_ssl
        )
        self.sqs_verify = (
            love_engine.aws_sqs_callback_params.get("sqs_verify") or sqs_verify
        )
        self.sqs_endpoint_url = (
            love_engine.aws_sqs_callback_params.get("sqs_endpoint_url") or sqs_endpoint_url
        )
        self.sqs_aws_access_key_id = (
            love_engine.aws_sqs_callback_params.get("sqs_aws_access_key_id")
            or sqs_aws_access_key_id
        )

        self.sqs_aws_secret_access_key = (
            love_engine.aws_sqs_callback_params.get("sqs_aws_secret_access_key")
            or sqs_aws_secret_access_key
        )

        self.sqs_aws_session_token = (
            love_engine.aws_sqs_callback_params.get("sqs_aws_session_token")
            or sqs_aws_session_token
        )

        self.sqs_aws_session_name = (
            love_engine.aws_sqs_callback_params.get("sqs_aws_session_name")
            or sqs_aws_session_name
        )

        self.sqs_aws_profile_name = (
            love_engine.aws_sqs_callback_params.get("sqs_aws_profile_name")
            or sqs_aws_profile_name
        )

        self.sqs_aws_role_name = (
            love_engine.aws_sqs_callback_params.get("sqs_aws_role_name")
            or sqs_aws_role_name
        )

        self.sqs_aws_web_identity_token = (
            love_engine.aws_sqs_callback_params.get("sqs_aws_web_identity_token")
            or sqs_aws_web_identity_token
        )

        self.sqs_aws_sts_endpoint = (
            love_engine.aws_sqs_callback_params.get("sqs_aws_sts_endpoint")
            or sqs_aws_sts_endpoint
        )
        self.sqs_strip_base64_files = (
            love_engine.aws_sqs_callback_params.get("sqs_strip_base64_files", False)
            or sqs_strip_base64_files
        )

        self.sqs_aws_use_application_level_encryption = (
            love_engine.aws_sqs_callback_params.get(
                "sqs_aws_use_application_level_encryption", False
            )
            or sqs_aws_use_application_level_encryption
        )
        self.sqs_app_encryption_key_b64 = (
            love_engine.aws_sqs_callback_params.get("sqs_app_encryption_key_b64")
            or sqs_app_encryption_key_b64
        )
        self.sqs_app_encryption_aad = (
            love_engine.aws_sqs_callback_params.get("sqs_app_encryption_aad")
            or sqs_app_encryption_aad
        )
        self.app_crypto: Optional["AppCrypto"] = None
        if self.sqs_aws_use_application_level_encryption:
            from love_engine.love_engine_core_utils.app_crypto import AppCrypto
        ...
        self.sqs_config = (
            love_engine.aws_sqs_callback_params.get("sqs_config") or sqs_config
        )
