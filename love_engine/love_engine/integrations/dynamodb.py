...
class DyanmoDBLogger:
    ...
    def __init__(self):
        ...
        if love_engine.dynamodb_table_name is None:
            raise ValueError(
                "love_engine Error, trying to use DynamoDB but not table name passed. Create a table and set `love_engine.dynamodb_table_name=<your-table>`"
            )
        self.table_name = love_engine.dynamodb_table_name
