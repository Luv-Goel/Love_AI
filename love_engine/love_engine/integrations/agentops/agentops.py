"""
AgentOps integration for love_engine - Provides OpenTelemetry tracing for LLM calls
"""
...
class AgentOps(OpenTelemetry):
    ...
    Example usage:
        ...
        love_engine.success_callback = ["agentops"]
    ...
    def __init__(
        ...
        resource_attrs = {
            "service.name": config.service_name or "love_engine",
