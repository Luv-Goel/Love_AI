...
This is the PubSub logger for GCS PubSub, this sends love_engine SpendLogs Payloads to GCS PubSub.
...
class GcsPubSubLogger(CustomBatchLogger):
    ...
    async def construct_request_headers(self) -> Dict[str, str]:
        ...
        from love_engine import vertex_chat_completion
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if love_engine.gcs_pub_sub_use_v1 is True:
