...
class GenericAPILogger(CustomBatchLogger):
    ...
    def _get_headers(self, headers: Optional[dict] = None):
        ...
        # 2. Update with love_engine generic headers if available
        if love_engine.generic_logger_headers:
            headers_dict.update(love_engine.generic_logger_headers)
    ...
    def _should_retry_exception(self, exception: Exception) -> bool:
        if isinstance(exception, (love_engine.Timeout, httpx.TransportError)):
            return True
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if love_engine.generic_api_use_v1 is True:
