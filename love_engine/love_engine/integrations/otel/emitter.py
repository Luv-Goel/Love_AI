...
from love_engine.integrations.otel.mappers.base import AttributeMapper, SpanData
...
from love_engine.integrations.otel.plumbing.providers import to_otel_span_kind
from love_engine.integrations.otel.model.semconv import Error, ExceptionEvent
...
class SpanEmitter:
    ...
    def finish_span(
        ...
        *,
        ...
        # span-level health signal love_engine doesn't actually evaluate. Only a
