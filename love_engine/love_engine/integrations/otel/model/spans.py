...
class LoveEngineSpanKind(str, Enum):
    SERVER = "server"
    CLIENT = "client"
    INTERNAL = "internal"
    PRODUCER = "producer"
...
class SpanSpec:
    role: SpanRole
    kind: LoveEngineSpanKind
    parent: SpanRole | None


SPAN_REGISTRY: dict[SpanRole, SpanSpec] = {
    SpanRole.PROXY_REQUEST: SpanSpec(
        SpanRole.PROXY_REQUEST, LoveEngineSpanKind.SERVER, parent=None
    ),
    SpanRole.LLM_CALL: SpanSpec(
        SpanRole.LLM_CALL, LoveEngineSpanKind.CLIENT, parent=SpanRole.PROXY_REQUEST
    ),
    ...
    SpanRole.MCP_TOOL_CALL: SpanSpec(
        SpanRole.MCP_TOOL_CALL, LoveEngineSpanKind.CLIENT, parent=SpanRole.PROXY_REQUEST
    ),
    SpanRole.GUARDRAIL: SpanSpec(
        SpanRole.GUARDRAIL, LoveEngineSpanKind.INTERNAL, parent=SpanRole.PROXY_REQUEST
    ),
    SpanRole.DB_CALL: SpanSpec(
        SpanRole.DB_CALL, LoveEngineSpanKind.CLIENT, parent=SpanRole.PROXY_REQUEST
    ),
    SpanRole.SERVICE: SpanSpec(
        SpanRole.SERVICE, LoveEngineSpanKind.INTERNAL, parent=SpanRole.PROXY_REQUEST
    ),
}
...
# redis-backed spend queues. Any service not mapped here is love_engine-internal work
