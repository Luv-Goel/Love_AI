...
the v1 :mod:`love_engine.integrations.opentelemetry` integration so both engines emit
...
from love_engine.integrations.otel.model.semconv import Metric, resolve_operation
from love_engine.integrations.otel.model.utils import to_seconds
