...
the factory in ``love_engine_logging`` can resolve a name and build a single
``OpenTelemetryV2`` instance from the result.
"""

from typing import Callable

from love_engine.integrations.otel.presets.agentops import agentops_preset
from love_engine.integrations.otel.presets.arize import arize_dynamic_headers, arize_preset
from love_engine.integrations.otel.presets.base import Preset
from love_engine.integrations.otel.presets.langfuse import (
    langfuse_dynamic_headers,
    langfuse_preset,
)
from love_engine.integrations.otel.presets.langtrace import langtrace_preset
from love_engine.integrations.otel.presets.levo import levo_preset
from love_engine.integrations.otel.presets.phoenix import phoenix_preset
from love_engine.integrations.otel.presets.weave import weave_dynamic_headers, weave_preset
