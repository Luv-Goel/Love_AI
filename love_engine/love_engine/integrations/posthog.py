...
from love_engine.integrations.posthog_mock_client import (
...
from love_engine.types.integrations.posthog import (
...
class PostHogLogger(CustomBatchLogger):
    ...
    def _add_custom_metadata_properties(
        ...
        for key, value in metadata.items():
            if key not in love_engine_internal_fields:
    ...
    def _extract_metadata(self, kwargs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return love_engine_params.get("metadata", {}) or {}
