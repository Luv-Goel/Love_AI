...
from love_engine.types.integrations.datadog_metrics import (
    DatadogMetricPoint,
    DatadogMetricSeries,
    ...
    def _add_metrics_from_log(
        ...
        if start_time_dt and end_time_dt:
            ...
            series_total_latency: DatadogMetricSeries = {
                "metric": "love_engine.request.total_latency",
                "type": 3,  # gauge
        ...
        if api_call_start_time and end_time_dt:
            ...
            series_llm_latency: DatadogMetricSeries = {
                "metric": "love_engine.llm_api.latency",
                "type": 3,  # gauge
        ...
        series_count: DatadogMetricSeries = {
            "metric": "love_engine.llm_api.request_count",
            "type": 1,  # count
    ...
    async def async_health_check(self) -> IntegrationHealthCheckStatus:
        ...
        try:
            ...
            test_metric_series: DatadogMetricSeries = {
                "metric": "love_engine.health_check",
                "type": 3,  # Gauge
