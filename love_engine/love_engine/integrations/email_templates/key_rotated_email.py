...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                <p><strong>Your love_engine API key has been rotated</strong> as part of our ongoing commitment to security best practices.</p>
...
&nbsp;&nbsp;]<br>
            ...
            <a href="https://docs.love_engine.ai/docs/proxy/user_keys" class="btn" style="color: #ffffff;">View Documentation</a>
