# used for /metrics endpoint on love_engine Proxy
#### What this does ####
...
import love_engine
from love_engine._logging import print_verbose, verbose_logger
from love_engine.exceptions import (
    validate_rate_limit_category,
    validate_rate_limit_type,
)
from love_engine.integrations.custom_logger import CustomLogger
from love_engine.integrations.prometheus_helpers import (
    PrometheusLabelFactoryContext,
    _get_cached_end_user_id_for_cost_tracking,
)
from love_engine.integrations.prometheus_helpers.bounded_prometheus_series_tracker import (
...
from love_engine.proxy._types import (
    LOVE_ENGINE_DeletedVerificationToken,
...
from love_engine.types.integrations.prometheus import *
from love_engine.types.integrations.prometheus import (
...
class PrometheusLogger(CustomLogger):
    ...
    def get_instance() -> Optional["PrometheusLogger"]:
        """Find the PrometheusLogger instance from love_engine.callbacks, if registered."""
        import love_engine

        for cb in love_engine.callbacks:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            # (e.g. ``love_engine.prometheus_emit_stream_label``,
            # ``love_engine.prometheus_emit_rate_limit_labels``) that can be
            ...
            _custom_buckets = love_engine.prometheus_latency_buckets
            ...
            self.love_engine_proxy_failed_requests_metric = self._counter_factory(
                name="love_engine_proxy_failed_requests_metric",
                documentation="Total number of failed responses from proxy - the client did not get a success response from love_engine proxy",
                labelnames=self.get_labels_for_metric(
                    "love_engine_proxy_failed_requests_metric"
                ),
            )

            self.love_engine_proxy_total_requests_metric = self._counter_factory(
                name="love_engine_proxy_total_requests_metric",
                documentation="Total number of requests made to the proxy server - track number of client side requests",
                labelnames=self.get_labels_for_metric(
                    "love_engine_proxy_total_requests_metric"
                ),
            )

            # request latency metrics
            self.love_engine_request_total_latency_metric = self._histogram_factory(
                "love_engine_request_total_latency_metric",
                "Total latency (seconds) for a request to love_engine",
                labelnames=self.get_labels_for_metric(
                    "love_engine_request_total_latency_metric"
                ),
            ...
            self.love_engine_llm_api_latency_metric = self._histogram_factory(
                "love_engine_llm_api_latency_metric",
                "Total latency (seconds) for a models LLM API call",
                labelnames=self.get_labels_for_metric("love_engine_llm_api_latency_metric"),
                buckets=self.latency_buckets,
            )

            self.love_engine_llm_api_time_to_first_token_metric = self._histogram_factory(
                "love_engine_llm_api_time_to_first_token_metric",
            ...
            # Counter for spend
            self.love_engine_spend_metric = self._counter_factory(
                "love_engine_spend_metric",
                "Total spend on LLM requests",
                labelnames=self.get_labels_for_metric("love_engine_spend_metric"),
            )

            # Counter for total_output_tokens
            self.love_engine_tokens_metric = self._counter_factory(
                "love_engine_total_tokens_metric",
                "Total number of input + output tokens from LLM requests",
                labelnames=self.get_labels_for_metric("love_engine_total_tokens_metric"),
            )

            self.love_engine_input_tokens_metric = self._counter_factory(
                "love_engine_input_tokens_metric",
                "Total number of input tokens from LLM requests",
                labelnames=self.get_labels_for_metric("love_engine_input_tokens_metric"),
            )

            self.love_engine_output_tokens_metric = self._counter_factory(
                "love_engine_output_tokens_metric",
                "Total number of output tokens from LLM requests",
                labelnames=self.get_labels_for_metric("love_engine_output_tokens_metric"),
            )
            ...
            self.love_engine_input_cached_tokens_metric = self._counter_factory(
                "love_engine_input_cached_tokens_metric",
            ...
            self.love_engine_input_cache_creation_tokens_metric = self._counter_factory(
                "love_engine_input_cache_creation_tokens_metric",
            ...
            self.love_engine_input_audio_tokens_metric = self._counter_factory(
                "love_engine_input_audio_tokens_metric",
            ...
            self.love_engine_output_reasoning_tokens_metric = self._counter_factory(
                "love_engine_output_reasoning_tokens_metric",
            ...
            self.love_engine_output_audio_tokens_metric = self._counter_factory(
                "love_engine_output_audio_tokens_metric",
            ...
            self.love_engine_remaining_team_budget_metric = self._gauge_factory(
                "love_engine_remaining_team_budget_metric",
                "Remaining budget for team",
                labelnames=self.get_labels_for_metric(
                    "love_engine_remaining_team_budget_metric"
                ),
            ...
            # Max Budget for Team
            self.love_engine_team_max_budget_metric = self._gauge_factory(
                "love_engine_team_max_budget_metric",
                "Maximum budget set for team",
                labelnames=self.get_labels_for_metric("love_engine_team_max_budget_metric"),
            )

            # Team Budget Reset At
            self.love_engine_team_budget_remaining_hours_metric = self._gauge_factory(
                "love_engine_team_budget_remaining_hours_metric",
            ...
            self.love_engine_remaining_org_budget_metric = self._gauge_factory(
                "love_engine_remaining_org_budget_metric",
                "Remaining budget for org",
                labelnames=self.get_labels_for_metric(
                    "love_engine_remaining_org_budget_metric"
                ),
            ...
            # Max Budget for Org
            self.love_engine_org_max_budget_metric = self._gauge_factory(
                "love_engine_org_max_budget_metric",
                "Maximum budget set for org",
                labelnames=self.get_labels_for_metric("love_engine_org_max_budget_metric"),
            )

            # Org Budget Reset At
            self.love_engine_org_budget_remaining_hours_metric = self._gauge_factory(
                "love_engine_org_budget_remaining_hours_metric",
            ...
            self.love_engine_remaining_api_key_budget_metric = self._gauge_factory(
                "love_engine_remaining_api_key_budget_metric",
                "Remaining budget for api key",
                labelnames=self.get_labels_for_metric(
                    "love_engine_remaining_api_key_budget_metric"
                ),
            ...
            self.love_engine_api_key_max_budget_metric = self._gauge_factory(
                "love_engine_api_key_max_budget_metric",
            ...
            self.love_engine_api_key_budget_remaining_hours_metric = self._gauge_factory(
                "love_engine_api_key_budget_remaining_hours_metric",
            ...
            self.love_engine_remaining_user_budget_metric = self._gauge_factory(
                "love_engine_remaining_user_budget_metric",
                "Remaining budget for user",
                labelnames=self.get_labels_for_metric(
                    "love_engine_remaining_user_budget_metric"
                ),
            ...
            # Max Budget for User
            self.love_engine_user_max_budget_metric = self._gauge_factory(
                "love_engine_user_max_budget_metric",
                "Maximum budget set for user",
                labelnames=self.get_labels_for_metric("love_engine_user_max_budget_metric"),
            )

            self.love_engine_user_budget_remaining_hours_metric = self._gauge_factory(
                "love_engine_user_budget_remaining_hours_metric",
            ...
            ########################################
            # love_engine Virtual API KEY metrics
            ########################################

            # Remaining MODEL RPM limit for API Key
            self.love_engine_remaining_api_key_requests_for_model = self._gauge_factory(
                "love_engine_remaining_api_key_requests_for_model",
            ...
            self.love_engine_remaining_api_key_tokens_for_model = self._gauge_factory(
                "love_engine_remaining_api_key_tokens_for_model",
            ...
            self.love_engine_remaining_requests_metric = self._gauge_factory(
                "love_engine_remaining_requests_metric",
            ...
            self.love_engine_remaining_tokens_metric = self._gauge_factory(
                "love_engine_remaining_tokens_metric",
            ...
            self.love_engine_overhead_latency_metric = self._histogram_factory(
                "love_engine_overhead_latency_metric",
                "Latency overhead (milliseconds) added by love_engine processing",
                labelnames=self.get_labels_for_metric(
                    "love_engine_overhead_latency_metric"
                ),
                buckets=self.latency_buckets,
            ...
            self.love_engine_request_queue_time_metric = self._histogram_factory(
                "love_engine_request_queue_time_seconds",
            ...
            # Guardrail metrics
            self.love_engine_guardrail_latency_metric = self._histogram_factory(
                "love_engine_guardrail_latency_seconds",
                "Latency (seconds) for guardrail execution",
                labelnames=["guardrail_name", "status", "error_type", "hook_type"],
                buckets=self.latency_buckets,
            )

            self.love_engine_guardrail_errors_total = self._counter_factory(
                "love_engine_guardrail_errors_total",
                "Total number of errors encountered during guardrail execution",
                labelnames=["guardrail_name", "error_type", "hook_type"],
            )

            self.love_engine_guardrail_requests_total = self._counter_factory(
                "love_engine_guardrail_requests_total",
                "Total number of guardrail invocations",
                labelnames=["guardrail_name", "status", "hook_type"],
            )
            # llm api provider budget metrics
            self.love_engine_provider_remaining_budget_metric = self._gauge_factory(
                "love_engine_provider_remaining_budget_metric",
                "Remaining budget for provider - used when you set provider budget limits",
                labelnames=["api_provider"],
            )

            # Metric for deployment state
            self.love_engine_deployment_state = self._gauge_factory(
                "love_engine_deployment_state",
                "LLM Deployment Analytics - The state of the deployment: 0 = healthy, 1 = partial outage, 2 = complete outage",
                labelnames=self.get_labels_for_metric("love_engine_deployment_state"),
            )

            self.love_engine_deployment_tpm_limit = self._gauge_factory(
                "love_engine_deployment_tpm_limit",
                "Deployment TPM limit found in config",
                labelnames=self.get_labels_for_metric("love_engine_deployment_tpm_limit"),
            )

            self.love_engine_deployment_rpm_limit = self._gauge_factory(
                "love_engine_deployment_rpm_limit",
                "Deployment RPM limit found in config",
                labelnames=self.get_labels_for_metric("love_engine_deployment_rpm_limit"),
            )

            self.love_engine_deployment_cooled_down = self._counter_factory(
                "love_engine_deployment_cooled_down",
                "LLM Deployment Analytics - Number of times a deployment has been cooled down by love_engine load balancing logic. exception_status is the status of the exception that caused the deployment to be cooled down",
                # labelnames=_logged_llm_labels + [EXCEPTION_STATUS],
                labelnames=self.get_labels_for_metric("love_engine_deployment_cooled_down"),
            )

            self.love_engine_deployment_success_responses = self._counter_factory(
                name="love_engine_deployment_success_responses",
                documentation="LLM Deployment Analytics - Total number of successful LLM API calls via love_engine",
                labelnames=self.get_labels_for_metric(
                    "love_engine_deployment_success_responses"
                ),
            )
            self.love_engine_deployment_failure_responses = self._counter_factory(
                name="love_engine_deployment_failure_responses",
                ...
                labelnames=self.get_labels_for_metric(
                    "love_engine_deployment_failure_responses"
                ),
            )

            self.love_engine_deployment_total_requests = self._counter_factory(
                name="love_engine_deployment_total_requests",
                documentation="LLM Deployment Analytics - Total number of LLM API calls via love_engine - success + failure",
                labelnames=self.get_labels_for_metric(
                    "love_engine_deployment_total_requests"
                ),
            )

            # Deployment Latency tracking
            self.love_engine_deployment_latency_per_output_token = self._histogram_factory(
                name="love_engine_deployment_latency_per_output_token",
                documentation="LLM Deployment Analytics - Latency per output token",
                labelnames=self.get_labels_for_metric(
                    "love_engine_deployment_latency_per_output_token"
                ),
            )

            self.love_engine_deployment_successful_fallbacks = self._counter_factory(
                "love_engine_deployment_successful_fallbacks",
                "LLM Deployment Analytics - Number of successful fallback requests from primary model -> fallback model",
                self.get_labels_for_metric("love_engine_deployment_successful_fallbacks"),
            )

            self.love_engine_deployment_failed_fallbacks = self._counter_factory(
                "love_engine_deployment_failed_fallbacks",
                "LLM Deployment Analytics - Number of failed fallback requests from primary model -> fallback model",
                self.get_labels_for_metric("love_engine_deployment_failed_fallbacks"),
            )

            # Callback Logging Failure Metrics
            self.love_engine_callback_logging_failures_metric = self._counter_factory(
                name="love_engine_callback_logging_failures_metric",
                documentation="Total number of failures when emitting logs to callbacks (e.g. s3_v2, langfuse, etc)",
                labelnames=["callback_name"],
            )

            self.love_engine_llm_api_failed_requests_metric = self._counter_factory(
                name="love_engine_llm_api_failed_requests_metric",
                documentation="deprecated - use love_engine_proxy_failed_requests_metric",
                labelnames=self.get_labels_for_metric(
                    "love_engine_llm_api_failed_requests_metric"
                ),
            )

            self.love_engine_requests_metric = self._counter_factory(
                name="love_engine_requests_metric",
                documentation="deprecated - use love_engine_proxy_total_requests_metric. Total number of LLM calls to love_engine - track total per API Key, team, user",
                labelnames=self.get_labels_for_metric("love_engine_requests_metric"),
            )

            # Cache metrics
            self.love_engine_cache_hits_metric = self._counter_factory(
                name="love_engine_cache_hits_metric",
                documentation="Total number of love_engine cache hits",
                labelnames=self.get_labels_for_metric("love_engine_cache_hits_metric"),
            )

            self.love_engine_cache_misses_metric = self._counter_factory(
                name="love_engine_cache_misses_metric",
                documentation="Total number of love_engine cache misses",
                labelnames=self.get_labels_for_metric("love_engine_cache_misses_metric"),
            )

            self.love_engine_cached_tokens_metric = self._counter_factory(
                name="love_engine_cached_tokens_metric",
                documentation="Total tokens served from love_engine cache",
                labelnames=self.get_labels_for_metric("love_engine_cached_tokens_metric"),
            )

            # Provider prompt-caching metrics
            self.love_engine_provider_cache_read_input_tokens_metric = self._counter_factory(
                name="love_engine_provider_cache_read_input_tokens_metric",
                documentation="Total prompt/input tokens read from provider prompt cache (e.g. OpenAI/Anthropic/Gemini/Bedrock)",
                labelnames=self.get_labels_for_metric(
                    "love_engine_provider_cache_read_input_tokens_metric"
                ),
            )

            self.love_engine_provider_cache_creation_input_tokens_metric = self._counter_factory(
                name="love_engine_provider_cache_creation_input_tokens_metric",
                documentation="Total prompt/input tokens written to provider prompt cache (e.g. Anthropic/Bedrock)",
                labelnames=self.get_labels_for_metric(
                    "love_engine_provider_cache_creation_input_tokens_metric"
                ),
            )

            # User and Team count metrics
            self.love_engine_total_users_metric = self._gauge_factory(
                "love_engine_total_users",
                "Total number of users in love_engine",
                labelnames=[],
            )

            self.love_engine_teams_count_metric = self._gauge_factory(
                "love_engine_teams_count",
                "Total number of teams in love_engine",
                labelnames=[],
            )
            ...
            ########################################
            self.love_engine_managed_batch_created_total = self._counter_factory(
                name="love_engine_managed_batch_created_total",
            ...
            self.love_engine_managed_file_size_bytes = self._gauge_factory(
                "love_engine_managed_file_size_bytes",
            ...
            self.love_engine_managed_batch_duration_seconds = self._histogram_factory(
                "love_engine_managed_batch_duration_seconds",
            ...
            self.love_engine_managed_file_created_total = self._counter_factory(
                name="love_engine_managed_file_created_total",
            ...
            self.love_engine_managed_file_deleted_total = self._counter_factory(
                name="love_engine_managed_file_deleted_total",
                documentation="Total number of managed file deletions (success or blocked)",
                labelnames=["result"],
            )

            self.love_engine_check_batch_cost_jobs_polled = self._gauge_factory(
                "love_engine_check_batch_cost_jobs_polled",
                "Number of unprocessed batches found by the last CheckBatchCost poll",
                labelnames=[],
            )

            self.love_engine_check_batch_cost_jobs_processed_total = self._counter_factory(
                name="love_engine_check_batch_cost_jobs_processed_total",
                documentation="Total number of batches successfully cost-tracked by CheckBatchCost",
                labelnames=["model", "api_provider"],
            )

            self.love_engine_check_batch_cost_errors_total = self._counter_factory(
                name="love_engine_check_batch_cost_errors_total",
                documentation="Total number of errors in CheckBatchCost by error type",
                labelnames=["error_type"],
            )

            self.love_engine_check_batch_cost_last_run_timestamp = self._gauge_factory(
                "love_engine_check_batch_cost_last_run_timestamp",
    ...
    def _parse_prometheus_config(self) -> Dict[str, List[str]]:
        ...
        import love_engine
        from love_engine.types.integrations.prometheus import PrometheusMetricsConfig

        config = love_engine.prometheus_metrics_config
    ...
    def get_labels_for_metric(
        ...
        ``love_engine.prometheus_emit_rate_limit_labels``,
        ``love_engine.prometheus_emit_stream_label``) are flipped after the
    ...
    def _track_end_user_metric_series(
        ...
        max_series = love_engine.prometheus_end_user_metrics_max_series_per_metric
        ttl_seconds = love_engine.prometheus_end_user_metrics_ttl_seconds
        ...
        self._bounded_prometheus_series_tracker.track_series(
            ...
            cleanup_interval_seconds=love_engine.prometheus_end_user_metrics_cleanup_interval_seconds,
        )
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        love_engine_params = kwargs.get("love_engine_params", {}) or {}
        _metadata = love_engine_params.get("metadata") or {}
        get_end_user_id_for_cost_tracking = _get_cached_end_user_id_for_cost_tracking()

        end_user_id = get_end_user_id_for_cost_tracking(
            love_engine_params, service_type="prometheus"
        )
        ...
        enum_values = UserAPIKeyLabelValues(
            ...
            stream=(
                ...
                if love_engine.prometheus_emit_stream_label
                else None
            ),
        )
        ...
        if (
            ...
            from love_engine.proxy.utils import hash_token
        ...
        # increment love_engine_proxy_total_requests_metric for all successful requests
        ...
        PrometheusLogger._inc_labeled_counter(
            self,
            self.love_engine_proxy_total_requests_metric,
            "love_engine_proxy_total_requests_metric",
            enum_values,
            label_context=label_context,
        )
    ...
    def _increment_token_metrics(
        ...
        PrometheusLogger._inc_labeled_counter(
            self,
            self.love_engine_tokens_metric,
            "love_engine_total_tokens_metric",
            enum_values,
            label_context=label_context,
        ...
        PrometheusLogger._inc_labeled_counter(
            self,
            self.love_engine_input_tokens_metric,
            "love_engine_input_tokens_metric",
            enum_values,
            label_context=label_context,
        ...
        PrometheusLogger._inc_labeled_counter(
            self,
            self.love_engine_output_tokens_metric,
            "love_engine_output_tokens_metric",
            enum_values,
            label_context=label_context,
    ...
    def _increment_token_detail_metrics(
        ...
        detail_metrics: List[Tuple[Any, DEFINED_PROMETHEUS_METRICS, Any]] = [
            (
                self.love_engine_input_cached_tokens_metric,
                "love_engine_input_cached_tokens_metric",
                (
            ...
            (
                self.love_engine_input_cache_creation_tokens_metric,
                "love_engine_input_cache_creation_tokens_metric",
                (
            ...
            (
                self.love_engine_input_audio_tokens_metric,
                "love_engine_input_audio_tokens_metric",
                (
            ...
            (
                self.love_engine_output_reasoning_tokens_metric,
                "love_engine_output_reasoning_tokens_metric",
                (
            ...
            (
                self.love_engine_output_audio_tokens_metric,
                "love_engine_output_audio_tokens_metric",
                (
    ...
    def _increment_cache_metrics(
        ...
        if cache_hit is None:
            # Historically these metrics only tracked love_engine caching.
            ...
            PrometheusLogger._inc_labeled_counter(
                self,
                self.love_engine_cache_hits_metric,
                "love_engine_cache_hits_metric",
                enum_values,
                label_context=label_context,
            )
            ...
            if total_tokens > 0:
                PrometheusLogger._inc_labeled_counter(
                    self,
                    self.love_engine_cached_tokens_metric,
                    "love_engine_cached_tokens_metric",
                    enum_values,
                    label_context=label_context,
            ...
            PrometheusLogger._inc_labeled_counter(
                self,
                self.love_engine_cache_misses_metric,
                "love_engine_cache_misses_metric",
                enum_values,
                label_context=label_context,
            )

        # Provider prompt caching metrics are independent of love_engine cache_hit.
        ...
        if isinstance(usage_obj, dict):
            ...
            if provider_cache_read_tokens > 0:
                PrometheusLogger._inc_labeled_counter(
                    self,
                    self.love_engine_provider_cache_read_input_tokens_metric,
                    "love_engine_provider_cache_read_input_tokens_metric",
                    enum_values,
                    label_context=label_context,
            ...
            if provider_cache_creation_tokens > 0:
                PrometheusLogger._inc_labeled_counter(
                    self,
                    self.love_engine_provider_cache_creation_input_tokens_metric,
                    "love_engine_provider_cache_creation_input_tokens_metric",
                    enum_values,
                    label_context=label_context,
    ...
    def _increment_top_level_request_and_spend_metrics(
        ...
        PrometheusLogger._inc_labeled_counter(
            self,
            self.love_engine_requests_metric,
            "love_engine_requests_metric",
            enum_values,
            label_context=label_context,
        )
        PrometheusLogger._inc_labeled_counter(
            self,
            self.love_engine_spend_metric,
            "love_engine_spend_metric",
            enum_values,
            label_context=label_context,
    ...
    def _set_virtual_key_rate_limit_metrics(
        ...
        from love_engine.proxy.common_utils.callback_utils import (
            get_model_group_from_love_engine_kwargs,
        )

        # Set remaining rpm/tpm for API Key + model
        # see parallel_request_limiter.py - variables are set there
        model_group = get_model_group_from_love_engine_kwargs(kwargs)
        remaining_requests_variable_name = (
            f"love_engine-key-remaining-requests-{model_group}"
        )
        remaining_tokens_variable_name = f"love_engine-key-remaining-tokens-{model_group}"
        ...
        self.love_engine_remaining_api_key_requests_for_model.labels(**requests_labels).set(
            remaining_requests
        )
        ...
        self.love_engine_remaining_api_key_tokens_for_model.labels(**tokens_labels).set(
            remaining_tokens
        )
    ...
    def _set_latency_metrics(
        ...
        if (
            ...
            _ttft_labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_llm_api_time_to_first_token_metric"
                ),
                enum_values=enum_values,
                label_context=label_context,
            )
            self.love_engine_llm_api_time_to_first_token_metric.labels(
                **_ttft_labels
            ).observe(time_to_first_token_seconds)
            self._track_end_user_metric_series(
                self.love_engine_llm_api_time_to_first_token_metric,
                "love_engine_llm_api_time_to_first_token_metric",
                _ttft_labels,
            )
        else:
        ...
        if api_call_total_time_seconds is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_llm_api_latency_metric"
                ),
                enum_values=enum_values,
                label_context=label_context,
            )
            self.love_engine_llm_api_latency_metric.labels(**_labels).observe(
                api_call_total_time_seconds
            )
            self._track_end_user_metric_series(
                self.love_engine_llm_api_latency_metric,
                "love_engine_llm_api_latency_metric",
                _labels,
            )
        ...
        if total_time_seconds is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_request_total_latency_metric"
                ),
                enum_values=enum_values,
                label_context=label_context,
            )
            self.love_engine_request_total_latency_metric.labels(**_labels).observe(
                total_time_seconds
            )
            self._track_end_user_metric_series(
                self.love_engine_request_total_latency_metric,
                "love_engine_request_total_latency_metric",
                _labels,
            )

        # request queue time (time from arrival to processing start)
        _love_engine_params = kwargs.get("love_engine_params", {}) or {}
        queue_time_seconds = (_love_engine_params.get("metadata") or {}).get(
            "queue_time_seconds"
        )
        if queue_time_seconds is not None and queue_time_seconds >= 0:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_request_queue_time_seconds"
                ),
                enum_values=enum_values,
                label_context=label_context,
            )
            self.love_engine_request_queue_time_metric.labels(**_labels).observe(
                queue_time_seconds
            )
            self._track_end_user_metric_series(
                self.love_engine_request_queue_time_metric,
                "love_engine_request_queue_time_seconds",
                _labels,
            )
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            PrometheusLogger._inc_labeled_counter(
                self,
                self.love_engine_llm_api_failed_requests_metric,
                "love_engine_llm_api_failed_requests_metric",
                enum_values,
            )
    ...
    async def async_post_call_failure_hook(
        ...
        See :attr:`PrometheusMetricLabels.love_engine_proxy_failed_requests_metric`
        ...
        try:
            _tags = StandardLoggingPayloadSetup._get_request_tags(
                love_engine_params=request_data,
            ...
            PrometheusLogger._inc_labeled_counter(
                self,
                self.love_engine_proxy_failed_requests_metric,
                "love_engine_proxy_failed_requests_metric",
                enum_values,
    ...
    async def async_post_call_success_hook(
        ...
        Note: love_engine_proxy_total_requests_metric is NOT incremented here to avoid
    ...
    def _extract_deployment_failure_label_values(
        ...
        sources in request_kwargs. Falls back to love_engine_params metadata and
        user_api_key_auth when standard_logging_payload has None values.
        """
        standard_logging_payload = (
            request_kwargs.get("standard_logging_object", {}) or {}
        )
        _love_engine_params = request_kwargs.get("love_engine_params", {}) or {}
        ...
        _love_engine_params_metadata = _love_engine_params.get("metadata", {}) or {}

        # Extract user_api_key_auth if present (proxy injects this, skipped in merge)
        user_api_key_auth = _love_engine_params_metadata.get("user_api_key_auth")

        def _get_api_key_alias() -> Optional[str]:
            val = _metadata.get("user_api_key_alias")
            if val is not None:
                return val
            val = _love_engine_params_metadata.get("user_api_key_alias")
            if val is not None:
                return val
        ...
        def _get_team_id() -> Optional[str]:
            ...
            if val is not None:
                return val
            val = _love_engine_params_metadata.get("user_api_key_team_id")
            if val is not None:
                return val
            if user_api_key_auth is not None:
        ...
        def _get_team_alias() -> Optional[str]:
            ...
            if val is not None:
                return val
            val = _love_engine_params_metadata.get("user_api_key_team_alias")
            if val is not None:
                return val
            if user_api_key_auth is not None:
        ...
        def _get_hashed_api_key() -> Optional[str]:
            ...
            if val is not None:
                return val
            val = _love_engine_params_metadata.get("user_api_key_hash")
            if val is not None:
                return val
            if user_api_key_auth is not None:
        ...
        return {
            ...
            "client_ip": _metadata.get("requester_ip_address")
            or _love_engine_params_metadata.get("requester_ip_address"),
            "user_agent": _metadata.get("user_agent")
            or _love_engine_params_metadata.get("user_agent"),
        }
    ...
    def set_llm_deployment_failure_metrics(self, request_kwargs: dict):
        ...
        try:
            ...
            _love_engine_params = request_kwargs.get("love_engine_params", {}) or {}
            love_engine_model_name = request_kwargs.get("model", None)
            ...
            # Fallback: model_id from love_engine_metadata.model_info
            if model_id is None:
                _model_info = (
                    (_love_engine_params.get("love_engine_metadata") or {}).get("model_info")
                    or (_love_engine_params.get("metadata") or {}).get("model_info")
                    or {}
                )
                model_id = _model_info.get("id")

            # Fallback: model_group from love_engine_metadata
            if model_group is None:
                model_group = (_love_engine_params.get("love_engine_metadata") or {}).get(
                    "model_group"
                ) or (_love_engine_params.get("metadata") or {}).get("model_group")

            llm_provider = _love_engine_params.get("custom_llm_provider", None)
            ...
            # On love_engine-side rejects (no deployment picked), route request_kwargs["model"]
            # into requested_model and leave deployment-scoped labels empty.
            deployment_selected = bool(model_id)
            if deployment_selected:
                label_love_engine_model_name = love_engine_model_name
                label_model_id = model_id
                label_api_base = api_base
                label_api_provider = llm_provider
                label_requested_model = model_group or love_engine_model_name
            else:
                label_love_engine_model_name = ""
                label_model_id = ""
                label_api_base = ""
                label_api_provider = ""
                label_requested_model = love_engine_model_name or model_group or ""

            enum_values = UserAPIKeyLabelValues(
                love_engine_model_name=label_love_engine_model_name,
            ...
            """
            log these labels
            ["love_engine_model_name", "model_id", "api_base", "api_provider"]
            """
            # Only mark a deployment outage when one was actually picked.
            if deployment_selected:
                self.set_deployment_partial_outage(
                    love_engine_model_name=love_engine_model_name or "",
                    model_id=model_id,
                    api_base=api_base,
            ...
            if exception is not None:
                PrometheusLogger._inc_labeled_counter(
                    self,
                    self.love_engine_deployment_failure_responses,
                    "love_engine_deployment_failure_responses",
                    enum_values,
            ...
            PrometheusLogger._inc_labeled_counter(
                self,
                self.love_engine_deployment_total_requests,
                "love_engine_deployment_total_requests",
                enum_values,
                label_context=_deployment_label_ctx,
            )
    ...
    def _set_deployment_tpm_rpm_limit_metrics(
        ...
        model_info: dict,
        love_engine_params: dict,
        love_engine_model_name: Optional[str],
        ...
        """
        tpm = model_info.get("tpm") or love_engine_params.get("tpm")
        rpm = model_info.get("rpm") or love_engine_params.get("rpm")

        if tpm is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_deployment_tpm_limit"
                ),
                enum_values=UserAPIKeyLabelValues(
                    love_engine_model_name=love_engine_model_name,
                    model_id=model_id,
                    api_base=api_base,
                    api_provider=llm_provider,
                ),
            )
            self.love_engine_deployment_tpm_limit.labels(**_labels).set(tpm)

        if rpm is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_deployment_rpm_limit"
                ),
                enum_values=UserAPIKeyLabelValues(
                    love_engine_model_name=love_engine_model_name,
                    model_id=model_id,
            ...
            self.love_engine_deployment_rpm_limit.labels(**_labels).set(rpm)
    ...
    async def _async_set_router_remaining_metrics(
        ...
        """
        Populate ``love_engine_remaining_tokens_metric`` /
        ``love_engine_remaining_requests_metric`` from the router's internal usage
        ...
        try:
            ...
            if not already_have_tokens and remaining_tokens is not None:
                _labels = prometheus_label_factory(
                    supported_enum_labels=self.get_labels_for_metric(
                        metric_name="love_engine_remaining_tokens_metric"
                    ),
                    enum_values=enum_values,
                    label_context=label_context,
                )
                self.love_engine_remaining_tokens_metric.labels(**_labels).set(
                    remaining_tokens
                )
            ...
            if not already_have_requests and remaining_requests is not None:
                _labels = prometheus_label_factory(
                    supported_enum_labels=self.get_labels_for_metric(
                        metric_name="love_engine_remaining_requests_metric"
                    ),
                    enum_values=enum_values,
                    label_context=label_context,
                )
                self.love_engine_remaining_requests_metric.labels(**_labels).set(
                    remaining_requests
                )
        except Exception as e:
            verbose_logger.exception(
    ...
    def set_llm_deployment_success_metrics(
        ...
        try:
            ...
            api_base = standard_logging_payload["api_base"]
            _love_engine_params = request_kwargs.get("love_engine_params", {}) or {}
            _metadata = get_love_engine_metadata_from_kwargs(request_kwargs)
            love_engine_model_name = request_kwargs.get("model", None)
            llm_provider = _love_engine_params.get("custom_llm_provider", None)
            _model_info = _metadata.get("model_info") or {}
            model_id = _model_info.get("id", None)

            if _model_info or _love_engine_params:
            ...
            if love_engine_overhead_time_ms := standard_logging_payload[
                "hidden_params"
            ].get("love_engine_overhead_time_ms"):
                _labels = prometheus_label_factory(
                    supported_enum_labels=self.get_labels_for_metric(
                        metric_name="love_engine_overhead_latency_metric"
                    ),
                    enum_values=enum_values,
                    label_context=label_context,
                )
                self.love_engine_overhead_latency_metric.labels(**_labels).observe(
                    love_engine_overhead_time_ms / 1000
                )  # set as seconds
            ...
            """
            log these labels
            ["love_engine_model_name", "requested_model", model_id", "api_base", "api_provider"]
            """
            ...
            PrometheusLogger._inc_labeled_counter(
                self,
                self.love_engine_deployment_success_responses,
                "love_engine_deployment_success_responses",
                enum_values,
                label_context=label_context,
            )
            ...
            if output_tokens is not None and output_tokens > 0:
                ...
                _labels = prometheus_label_factory(
                    supported_enum_labels=self.get_labels_for_metric(
                        metric_name="love_engine_deployment_latency_per_output_token"
                    ),
                    enum_values=enum_values,
                    label_context=label_context,
                )
                self.love_engine_deployment_latency_per_output_token.labels(
                    **_labels
    ...
    def _record_guardrail_metrics(
        ...
        try:
            # Record latency
            self.love_engine_guardrail_latency_metric.labels(
            ...
            self.love_engine_guardrail_requests_total.labels(
                guardrail_name=guardrail_name,
                status=status,
                hook_type=hook_type,
            ).inc()
            ...
            if status == "error" and error_type:
                self.love_engine_guardrail_errors_total.labels(
                    guardrail_name=guardrail_name,
    ...
    def record_managed_batch_created(
        ...
        try:
            self.love_engine_managed_batch_created_total.labels(
                model=model,
    ...
    def record_managed_file_size(
        ...
        try:
            self.love_engine_managed_file_size_bytes.labels(
                purpose=purpose,
                file_type=file_type,
                model=model or "",
    ...
    def record_managed_batch_duration(
        ...
        try:
            self.love_engine_managed_batch_duration_seconds.labels(
                model=model or "",
                api_provider=api_provider or "",
    ...
    def record_managed_file_created(
        ...
        try:
            self.love_engine_managed_file_created_total.labels(
                model=model,
                api_provider=api_provider,
                user=user,
                user_email=user_email,
    ...
    def record_managed_file_deleted(self, result: str):
        ...
        try:
            self.love_engine_managed_file_deleted_total.labels(result=result).inc()
        except Exception as e:
    ...
    def record_check_batch_cost_run(
        ...
        try:
            self.love_engine_check_batch_cost_last_run_timestamp.set(time.time())
            self.love_engine_check_batch_cost_jobs_polled.set(jobs_polled)

            if processed_models:
                for model, api_provider in processed_models:
                    self.love_engine_check_batch_cost_jobs_processed_total.labels(
                        model=model or "",
                        api_provider=api_provider or "",
                    ).inc()
        except Exception as e:
    ...
    def record_check_batch_cost_error(self, error_type: str):
        try:
            self.love_engine_check_batch_cost_errors_total.labels(
                error_type=error_type,
            ).inc()
        except Exception as e:
    ...
    def _get_exception_class_name(exception: Exception) -> str:
        ...
        # original value.
        try:
            from love_engine.exceptions import BudgetExceededError
        except ImportError:
    ...
    def _extract_rate_limit_labels(
        ...
        exception that declares them (``love_engine.RateLimitError`` and bare-
    ...
    async def log_success_fallback_event(
        ...
        PrometheusLogger._inc_labeled_counter(
            self,
            self.love_engine_deployment_successful_fallbacks,
            "love_engine_deployment_successful_fallbacks",
            enum_values,
            label_context=PrometheusLabelFactoryContext(enum_values),
        )
    ...
    async def log_failure_fallback_event(
        ...
        PrometheusLogger._inc_labeled_counter(
            self,
            self.love_engine_deployment_failed_fallbacks,
            "love_engine_deployment_failed_fallbacks",
            enum_values,
            label_context=PrometheusLabelFactoryContext(enum_values),
        )

    def set_love_engine_deployment_state(
        self,
        state: int,
        love_engine_model_name: str,
        model_id: Optional[str],
        api_base: Optional[str],
        api_provider: str,
    ):
        ...
        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(
                metric_name="love_engine_deployment_state"
            ),
            enum_values=UserAPIKeyLabelValues(
                love_engine_model_name=love_engine_model_name,
                model_id=model_id,
        ...
        self.love_engine_deployment_state.labels(**_labels).set(state)
    ...
    def set_deployment_healthy(
        ...
        self.set_love_engine_deployment_state(
            0, love_engine_model_name, model_id, api_base, api_provider
        )
    ...
    def set_deployment_partial_outage(
        ...
        self.set_love_engine_deployment_state(
            1, love_engine_model_name, model_id, api_base, api_provider
        )
    ...
    def set_deployment_complete_outage(
        ...
        self.set_love_engine_deployment_state(
            2, love_engine_model_name, model_id, api_base, api_provider
        )
    ...
    def increment_deployment_cooled_down(
        ...
        """
        increment metric when love_engine.Router / load balancing logic places a deployment in cool down
        """
        self.love_engine_deployment_cooled_down.labels(
            _sanitize_prometheus_label_value(love_engine_model_name),
    ...
    def increment_callback_logging_failure(
        ...
        """
        self.love_engine_callback_logging_failures_metric.labels(
    ...
    def track_provider_remaining_budget(
        ...
        """
        self.love_engine_provider_remaining_budget_metric.labels(provider).set(
    ...
    async def _initialize_budget_metrics(
        ...
        """
        from love_engine.proxy.proxy_server import prisma_client
    ...
    async def _initialize_team_budget_metrics(self):
        ...
        ) -> Tuple[List[LOVE_ENGINE_TeamTable], Optional[int]]:
    ...
    async def _initialize_api_key_budget_metrics(self):
        ...
        """
        from love_engine.constants import UI_SESSION_TOKEN_TEAM_ID
        ...
        async def fetch_keys(page_size: int, page: int) -> Tuple[
            List[Union[str, UserAPIKeyAuth, LOVE_ENGINE_DeletedVerificationToken]],
            Optional[int],
        ]:
    ...
    async def _initialize_user_budget_metrics(self):
        ...
        async def fetch_users(
            page_size: int, page: int
        ) -> Tuple[List[LOVE_ENGINE_UserTable], Optional[int]]:
    ...
    async def _initialize_org_budget_metrics(self):
        ...
        async def fetch_orgs(page_size: int, page: int) -> Tuple[list, Optional[int]]:
            ...
            orgs = await OrganizationRepository(prisma_client).table.find_many(
                ...
                take=page_size,
                order={"created_at": "desc"},
                include={"love_engine_budget_table": True},
            )
    ...
    async def initialize_remaining_budget_metrics(self):
        ...
        """
        from love_engine.constants import PROMETHEUS_EMIT_BUDGET_METRICS_JOB_NAME
        from love_engine.proxy.proxy_server import proxy_logging_obj
    ...
    async def _initialize_user_and_team_count_metrics(self):
        ...
        Updates:
        - love_engine_total_users: Total count of users in the database
        - love_engine_teams_count: Total count of teams in the database
        """
        from love_engine.proxy.proxy_server import prisma_client
        ...
        try:
            ...
            self.love_engine_total_users_metric.set(total_users)
            verbose_logger.debug(
                f"Prometheus: set love_engine_total_users to {total_users}"
            )

            # Get total team count
            total_teams = await TeamRepository(prisma_client).table.count()
            self.love_engine_teams_count_metric.set(total_teams)
            verbose_logger.debug(
                f"Prometheus: set love_engine_teams_count to {total_teams}"
            )
        except Exception as e:
            verbose_logger.exception(
    ...
    async def _set_team_list_budget_metrics(self, teams: List[LOVE_ENGINE_TeamTable]):
        """Helper function to set budget metrics for a list of teams"""
        for team in teams:
            self._set_team_budget_metrics(team)

    async def _set_user_list_budget_metrics(self, users: List[LOVE_ENGINE_UserTable]):
    ...
    async def _set_org_list_budget_metrics(self, orgs: list):
        ...
        for org in orgs:
            budget_table = getattr(org, "love_engine_budget_table", None)
    ...
    async def _set_team_budget_metrics_after_api_request(
        ...
        - Assemble a LOVE_ENGINE_TeamTable object
    ...
    async def _assemble_team_object(
        ...
        - `budget_reset_at`
        """
        from love_engine.proxy.auth.auth_checks import get_team_object
        from love_engine.proxy.proxy_server import prisma_client, user_api_key_cache
    ...
    def _set_team_budget_metrics(
        ...
        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(
                metric_name="love_engine_remaining_team_budget_metric"
            ),
            enum_values=enum_values,
        )
        self.love_engine_remaining_team_budget_metric.labels(**_labels).set(
            self._safe_get_remaining_budget(
        ...
        if team.max_budget is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_team_max_budget_metric"
                ),
                enum_values=enum_values,
            )
            self.love_engine_team_max_budget_metric.labels(**_labels).set(team.max_budget)

        if team.budget_reset_at is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_team_budget_remaining_hours_metric"
                ),
                enum_values=enum_values,
            )
            self.love_engine_team_budget_remaining_hours_metric.labels(**_labels).set(
    ...
    async def _set_org_budget_metrics_after_api_request(
        ...
        from love_engine.proxy.auth.auth_checks import get_org_object
        from love_engine.proxy.proxy_server import prisma_client, user_api_key_cache
        ...
        budget_table = org_info.love_engine_budget_table
        max_budget = budget_table.max_budget if budget_table else None
        budget_reset_at = (
    ...
    def _set_org_budget_metrics(
        ...
        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(
                metric_name="love_engine_remaining_org_budget_metric"
            ),
            enum_values=enum_values,
        )
        self.love_engine_remaining_org_budget_metric.labels(**_labels).set(
            self._safe_get_remaining_budget(
                max_budget=max_budget,
                spend=spend,
            )
        ...
        if max_budget is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_org_max_budget_metric"
                ),
                enum_values=enum_values,
            )
            self.love_engine_org_max_budget_metric.labels(**_labels).set(max_budget)

        if budget_reset_at is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_org_budget_remaining_hours_metric"
                ),
                enum_values=enum_values,
            )
            self.love_engine_org_budget_remaining_hours_metric.labels(**_labels).set(
                self._get_remaining_hours_for_budget_reset(
                    budget_reset_at=budget_reset_at
                )
            )
    ...
    def _set_key_budget_metrics(self, user_api_key_dict: UserAPIKeyAuth):
        ...
        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(
                metric_name="love_engine_remaining_api_key_budget_metric"
            ),
            enum_values=enum_values,
        )
        self.love_engine_remaining_api_key_budget_metric.labels(**_labels).set(
            self._safe_get_remaining_budget(
        ...
        if user_api_key_dict.max_budget is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_api_key_max_budget_metric"
                ),
                enum_values=enum_values,
            )
            self.love_engine_api_key_max_budget_metric.labels(**_labels).set(
                user_api_key_dict.max_budget
            )

        if user_api_key_dict.budget_reset_at is not None:
            self.love_engine_api_key_budget_remaining_hours_metric.labels(**_labels).set(
                self._get_remaining_hours_for_budget_reset(
    ...
    async def _assemble_key_object(
        ...
        """
        from love_engine.proxy.auth.auth_checks import get_key_object
        from love_engine.proxy.proxy_server import prisma_client, user_api_key_cache
    ...
    async def _set_user_budget_metrics_after_api_request(
        ...
        - Assemble a LOVE_ENGINE_UserTable object
    ...
    async def _assemble_user_object(
        ...
        - `budget_reset_at`
        """
        from love_engine.proxy.auth.auth_checks import get_user_object
        from love_engine.proxy.proxy_server import prisma_client, user_api_key_cache

        _total_user_spend = (spend or 0) + response_cost
        user_object = LOVE_ENGINE_UserTable(
            user_id=user_id,
    ...
    def _set_user_budget_metrics(
        ...
        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(
                metric_name="love_engine_remaining_user_budget_metric"
            ),
            enum_values=enum_values,
        )
        self.love_engine_remaining_user_budget_metric.labels(**_labels).set(
            self._safe_get_remaining_budget(
        ...
        if user.max_budget is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_user_max_budget_metric"
                ),
                enum_values=enum_values,
            )
            self.love_engine_user_max_budget_metric.labels(**_labels).set(user.max_budget)

        if user.budget_reset_at is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(
                    metric_name="love_engine_user_budget_remaining_hours_metric"
                ),
                enum_values=enum_values,
            )
            self.love_engine_user_budget_remaining_hours_metric.labels(**_labels).set(
                self._get_remaining_hours_for_budget_reset(
    ...
    def initialize_budget_metrics_cron_job(scheduler: AsyncIOScheduler):
        ...
        """
        from love_engine.constants import PROMETHEUS_BUDGET_METRICS_REFRESH_INTERVAL_MINUTES
    ...
    *,
    ...
    if UserAPIKeyLabelNames.END_USER.value in filtered_labels:
        ...
        filtered_labels["end_user"] = get_end_user_id_for_cost_tracking(
            love_engine_params={"user_api_key_end_user_id": enum_values.end_user},
...
def get_custom_labels_from_metadata(metadata: dict) -> Dict[str, str]:
    ...
    """
    keys = love_engine.custom_prometheus_metadata_labels
...
def _tag_matches_wildcard_configured_pattern(
    ...
    from love_engine.router_utils.pattern_match_deployments import PatternMatchRouter
...
def get_custom_labels_from_tags(tags: Sequence[str]) -> Dict[str, str]:
    ...
    from love_engine.types.integrations.prometheus import _sanitize_prometheus_label_name

    configured_tags = love_engine.custom_prometheus_tags
