...
from love_engine.integrations.braintrust_mock_client import (
...
class BraintrustLogger(CustomLogger):
    ...
    async def create_default_project_and_experiment(self):
        project = await self.global_braintrust_http_handler.post(
            f"{self.api_base}/project", headers=self.headers, json={"name": "love_engine"}
        )
    ...
    def log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            dynamic_metadata = love_engine_params.get("metadata", {}) or {}
            ...
            if usage_obj and isinstance(usage_obj, love_engine.Usage):
                love_engine.utils.get_logging_id(start_time, response_obj)
                metrics = {
