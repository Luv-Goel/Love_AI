...
Users can define
- `cache_control_injection_points` in the completion params and love_engine will inject the cache control directives into the messages at the specified injection points.
...
from love_engine.types.integrations.anthropic_cache_control_hook import (
    CacheControlInjectionPoint,
    CacheControlMessageInjectionPoint,
)
from love_engine.types.llms.openai import AllMessageValues, ChatCompletionCachedContent
