...
from love_engine.constants import LOVE_ENGINE_ASYNCIO_QUEUE_MAXSIZE
from love_engine.integrations.additional_logging_utils import AdditionalLoggingUtils
from love_engine.integrations.gcs_bucket.gcs_bucket_base import GCSBucketBase
...
from love_engine.types.integrations.gcs_bucket import *
...
class GCSBucketLogger(GCSBucketBase, AdditionalLoggingUtils):
    def __init__(self, bucket_name: Optional[str] = None) -> None:
        ...
        self.log_queue: asyncio.Queue[GCSLogQueueItem] = asyncio.Queue(  # type: ignore[assignment]
            maxsize=LOVE_ENGINE_ASYNCIO_QUEUE_MAXSIZE
        )
    ...
    def _get_object_name(
        ...
        _metadata = _love_engine_params.get("metadata", None) or {}
