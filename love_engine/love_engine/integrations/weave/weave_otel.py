...
from love_engine.types.integrations.weave_otel import WeaveOtelConfig, WeaveSpanAttributes
...
def _set_weave_specific_attributes(
    ...
    custom_llm_provider = love_engine_params.get("custom_llm_provider") or ""
...
class WeaveOtelLogger(OpenTelemetry):
    """
    Weave (W&B) OpenTelemetry Logger for love_engine.
    ...
    Usage:
        love_engine.callbacks = ["weave_otel"]

        Or manually:
        from love_engine.integrations.weave.weave_otel import WeaveOtelLogger
        weave_logger = WeaveOtelLogger(callback_name="weave_otel")
        love_engine.callbacks = [weave_logger]
    ...
    def _start_primary_span(
        ...
        from the love_engine LLM call spans, creating proper nesting in Weave.
        """
    ...
    def _handle_success(self, kwargs, response_obj, start_time, end_time):
        ...
        they should be managed by the user code, not ended by love_engine.
        """
