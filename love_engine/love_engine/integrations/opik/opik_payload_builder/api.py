...
from love_engine.integrations.opik import utils
...
def build_opik_payload(
    ...
    """
    Build Opik trace and span payloads from love_engine completion data.

    This is the main public API for creating Opik payloads. It:
    1. Extracts all necessary data from love_engine kwargs and response
    ...
    Args:
        kwargs: love_engine kwargs containing request metadata and logging data
        response_obj: love_engine response object containing model response
