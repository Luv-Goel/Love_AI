...
from love_engine.constants import MAVVRIK_FOCUS_EXPORT_JOB_NAME
from love_engine.integrations.focus.destinations.base import FocusTimeWindow
...
class MavvrikFocusLogger(FocusLogger):
    ...
    # data that has likely been cleaned up from LOVE_ENGINE_DailyUserSpend.
    _MAX_CATCHUP_DAYS = 7
    ...
    async def _run_scheduled_export(self) -> None:
        ...
        """
        engine = self._ensure_engine()
        from love_engine.integrations.focus.destinations.mavvrik_destination import (  # noqa: PLC0415
    ...
    async def initialize_mavvrik_focus_export_job(self) -> None:
        ...
        from love_engine.proxy.proxy_server import proxy_logging_obj  # noqa: PLC0415
    ...
    async def init_mavvrik_focus_background_job(
        ...
        loggers: List[MavvrikFocusLogger] = [
            cb
            for cb in love_engine.logging_callback_manager.get_custom_loggers_for_type(
