...
from love_engine.integrations.langsmith_mock_client import (
...
from love_engine.types.integrations.langsmith import *
from love_engine.types.utils import StandardCallbackDynamicParams, StandardLoggingPayload
...
class LangsmithLogger(CustomBatchLogger):
    def __init__(
        ...
        **kwargs,
        ...
        _batch_size = (
            os.getenv("LANGSMITH_BATCH_SIZE", None) or love_engine.langsmith_batch_size
        )
    ...
    def get_credentials_from_env(
        ...
        if allow_env_credentials is False and langsmith_base_url is not None:
            ...
            _credentials_project = langsmith_project or "love_engine-completion"
    ...
    def _prepare_log_data(
        ...
        try:
            ...
            metadata = _love_engine_params.get("metadata", {}) or {}
