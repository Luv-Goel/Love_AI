...
This module provides a base class for implementing custom secret managers in love_engine.

Usage:
    from love_engine.integrations.custom_secret_manager import CustomSecretManager
    ...
    love_engine.secret_manager_client = MySecretManager()
    love_engine._key_management_system = KeyManagementSystem.CUSTOM
"""
...
from love_engine.secret_managers.base_secret_manager import BaseSecretManager
...
class CustomSecretManager(BaseSecretManager):
    ...
    integrations in love_engine. Users can extend this class to integrate their own secret
    management systems.
