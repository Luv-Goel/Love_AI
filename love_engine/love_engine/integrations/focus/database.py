...
class FocusLoveEngineDatabase:
    """Retrieves love_engine usage data for Focus export workflows."""
    ...
    def _ensure_prisma_client(self):
        ...
        if prisma_client is None:
            raise RuntimeError(
                ...
                "https://docs.love_engine.ai/docs/simple_proxy#managing-auth---virtual-keys"
            )
    ...
    async def get_usage_data(
        ...
        *,
        ...
        LEFT JOIN "LOVE_ENGINE_OrganizationTable" ot
    ...
    async def get_table_info(self) -> Dict[str, Any]:
        ...
        WHERE table_name = 'LOVE_ENGINE_DailyUserSpend'
        ORDER BY ordinal_position;
        """
        try:
            columns_response = await client.db.query_raw(info_query)
            return {"columns": columns_response, "table_name": "LOVE_ENGINE_DailyUserSpend"}
        except Exception as exc:
