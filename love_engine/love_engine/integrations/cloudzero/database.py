...
# CHANGELOG: 2025-01-19 - Initial database module for love_engine data extraction (erik.peterson)

"""Database connection and data extraction for love_engine."""
...
class LoveEngineDatabase:
    """Handle love_engine PostgreSQL database connections and queries."""
    ...
    async def get_usage_data(
        ...
        """Retrieve usage data from love_engine daily user spend table."""
        ...
        FROM "LOVE_ENGINE_DailyUserSpend" dus
        LEFT JOIN "LOVE_ENGINE_VerificationToken" vt ON dus.api_key = vt.token
        LEFT JOIN "LOVE_ENGINE_TeamTable" tt ON vt.team_id = tt.team_id
        LEFT JOIN "LOVE_ENGINE_UserTable" ut ON dus.user_id = ut.user_id
