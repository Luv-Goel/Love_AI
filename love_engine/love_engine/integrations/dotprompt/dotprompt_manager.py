"""
Dotprompt manager that integrates with love_engine's prompt management system.
...
from love_engine.integrations.prompt_management_base import PromptManagementClient
...
class DotpromptManager(CustomPromptManagement):
    ...
    This class enables using .prompt files with the love_engine completion() function
    by implementing the PromptManagementBase interface.

    Usage:
        # Set global prompt directory
        love_engine.prompt_directory = "path/to/prompts"
    ...
    def __init__(
        ...
        self.prompt_directory = prompt_directory or love_engine.global_prompt_directory
        ...
        if self._prompt_manager is None:
            if (
                ...
                raise ValueError(
                    ...
                    "Set love_engine.global_prompt_directory, initialize with prompt_directory parameter, or provide prompt_data."
                )
    ...
    def get_chat_completion_prompt(
        ...
        from love_engine.integrations.prompt_management_base import PromptManagementBase
