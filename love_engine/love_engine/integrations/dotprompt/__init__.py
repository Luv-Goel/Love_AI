...
def set_global_prompt_directory(directory: str) -> None:
    ...
    love_engine.global_prompt_directory = directory  # type: ignore
...
def prompt_initializer(
    ...
    """
    prompt_directory = getattr(love_engine_params, "prompt_directory", None)
    prompt_data = getattr(love_engine_params, "prompt_data", None)
    ...
    prompt_file = getattr(love_engine_params, "prompt_file", None)

    # Handle dotprompt_content from database
    dotprompt_content = getattr(love_engine_params, "dotprompt_content", None)
