# What is this?
## On Success events log cost to Lago - https://github.com/BerriAI/love_engine/issues/3639
...
class LagoLogger(CustomLogger):
    ...
    def _common_logic(self, kwargs: dict, response_obj) -> dict:
        response_obj.get("id", kwargs.get("love_engine_call_id"))
        ...
        if (
            isinstance(response_obj, love_engine.ModelResponse)
        ...
        user_id = love_engine_params["metadata"].get("user_api_key_user_id", None)
        team_id = love_engine_params["metadata"].get("user_api_key_team_id", None)
        love_engine_params["metadata"].get("user_api_key_org_id", None)
