# used for monitoring love_engine services health on `/metrics` endpoint on love_engine Proxy
#### What this does ####
#    On success + failure, log events to Prometheus for love_engine / adjacent services (love_engine, redis, postgres, llm api providers)
...
from love_engine.types.integrations.prometheus import LATENCY_BUCKETS
from love_engine.types.services import (
...
class PrometheusServicesLogger:
    ...
    love_engine_service_latency = None  # Class-level attribute to store the Histogram
    ...
    def create_histogram(self, service: str, type_of_request: str):
        metric_name = "love_engine_{}_{}".format(service, type_of_request)
