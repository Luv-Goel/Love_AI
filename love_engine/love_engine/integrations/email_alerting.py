...
LOVE_ENGINE_LOGO_URL = "https://love_engine-listing.s3.amazonaws.com/love_engine_logo.png"
LOVE_ENGINE_SUPPORT_CONTACT = "support@berri.ai"
...
async def send_team_budget_alert(webhook_event: WebhookEvent) -> bool:
    ...
    <img src="{email_logo_url}" alt="love_engine Logo" width="150" height="50" /> <br/><br/><br/>
    ...
    email_event = {
        ...
        "subject": f"love_engine {event_name} for Team {team_alias}",
