"""
Generic prompt manager that integrates with love_engine's prompt management system.
Fetches prompts from any API that implements the /beta/love_engine_prompt_management endpoint.
"""
...
from love_engine.integrations.prompt_management_base import (
...
class GenericPromptManager(CustomPromptManagement):
    ...
    /beta/love_engine_prompt_management endpoint.
    ...
    Usage:
        ...
        # Use with completion
        response = love_engine.completion(
    ...
    def _fetch_prompt_from_api(
        ...
        url = f"{self.api_base}/beta/love_engine_prompt_management"
        params = {
            "prompt_id": prompt_id,
    ...
    async def async_fetch_prompt_from_api(
        ...
        params = {
            "prompt_id": prompt_id,
            **(
                prompt_spec.love_engine_params.provider_specific_query_params
                if prompt_spec
                and prompt_spec.love_engine_params.provider_specific_query_params
                else {}
            ),
        }
    ...
    def should_run_prompt_management(
        ...
        if prompt_id is not None or (
            ...
            and prompt_spec.love_engine_params.provider_specific_query_params is not None
        ):
            return True
        return False
    ...
    async def async_get_chat_completion_prompt(
        ...
        return await PromptManagementBase.async_get_chat_completion_prompt(
            ...
            ignore_prompt_manager_model=(
                ignore_prompt_manager_model
                or prompt_spec.love_engine_params.ignore_prompt_manager_model
                if prompt_spec
                else False
            ),
            ignore_prompt_manager_optional_params=(
                ignore_prompt_manager_optional_params
                or prompt_spec.love_engine_params.ignore_prompt_manager_optional_params
                if prompt_spec
                else False
            ),
        )
