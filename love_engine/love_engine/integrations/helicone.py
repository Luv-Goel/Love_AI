...
from love_engine.integrations.helicone_mock_client import (
...
class HeliconeLogger:
    ...
    def add_metadata_from_header(love_engine_params: dict, metadata: dict) -> dict:
        ...
        if "love_engine_parent_otel_span" in metadata:
            metadata.pop("love_engine_parent_otel_span")
    ...
    def log_success(
        ...
        try:
            ...
            kwargs.get("love_engine_call_id", None)
            ...
            if isinstance(response_obj, love_engine.EmbeddingResponse) or isinstance(
            ...
            response = love_engine.module_level_client.post(url, headers=headers, json=data)
