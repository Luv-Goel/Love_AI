...
from love_engine.love_engine_core_utils.json_validation_rule import normalize_tool_schema
...
class GoogleGenAIAdapter:
    """Adapter for transforming Google GenAI generate_content requests to/from love_engine.completion format"""
    ...
    def translate_generate_content_to_completion(
        ...
        **kwargs,
        ...
        """
        Transform generate_content request to love_engine completion format
        ...
        #########################################################
        # forward any love_engine specific params
        #########################################################
        completion_request_dict = dict(completion_request)
        if love_engine_params:
            completion_request_dict = self._add_generic_love_engine_params_to_request(
    ...
    def _add_generic_love_engine_params_to_request(
        self,
        completion_request_dict: Dict[str, Any],
        love_engine_params: Optional[GenericLoveEngineParams] = None,
    ) -> dict:
        """Add generic love_engine params to request. e.g add api_base, api_key, api_version, etc.
        ...
        Returns:
            Dict[str, Any]
        """
        allowed_fields = GenericLoveEngineParams.model_fields.keys()
        if love_engine_params:
            love_engine_dict = love_engine_params.model_dump(exclude_none=True)
            for key, value in love_engine_dict.items():
    ...
    def translate_completion_to_generate_content(
        ...
        """
        Transform love_engine completion response to Google GenAI generate_content format

        Args:
            response: ModelResponse from love_engine.completion
    ...
    def translate_streaming_completion_to_generate_content(
        ...
        """
        Transform streaming love_engine completion chunk to Google GenAI generate_content format

        Args:
            response: Streaming ModelResponse chunk from love_engine.completion
