    ...
    def setup_generate_content_call(
        ...
        **kwargs,
        ...
        if (
            ...
            and love_engine_params.mock_response
            and isinstance(love_engine_params.mock_response, str)
        ):
        ...
        if love_engine_params.custom_llm_provider is None:
        ...
        if generate_content_provider_config is None:
            ...
            if love_engine_logging_obj is None:
                raise ValueError("love_engine_logging_obj is required, but got None")
    ...
    try:
        ...
        if setup_result.generate_content_provider_config is None:
            ...
            return GenerateContentToCompletionHandler.generate_content_handler(
                ...
                tools=tools,
                _is_async=_is_async,
                love_engine_params=setup_result.love_engine_params,
                extra_headers=extra_headers,
                **kwargs,
            )
        ...
        response = base_llm_http_handler.generate_content_handler(
            ...
            love_engine_params=setup_result.love_engine_params,
            logging_obj=setup_result.love_engine_logging_obj,
            extra_headers=extra_headers,
            extra_body=extra_body,
