...
class AutoRouter(CustomLogger):
    ...
    def __init__(
        ...
        Args:
            ...
            love_engine_router_instance: The instance of the LoveEngine Router.
        """
        ...
        self.love_engine_router_instance: "Router" = love_engine_router_instance
    ...
    async def async_pre_routing_hook(
        ...
        from love_engine.router_strategy.auto_router.love_engine_encoder import (
            LoveEngineRouterEncoder,
        )
        from love_engine.types.router import PreRoutingHookResponse
        ...
        if self.routelayer is None:
            ...
            self.routelayer = SemanticRouter(
                ...
                encoder=LoveEngineRouterEncoder(
                    love_engine_router_instance=self.love_engine_router_instance,
