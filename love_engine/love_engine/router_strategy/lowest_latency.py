...
from love_engine.love_engine_core_utils.core_helpers import safe_divide_seconds
...
class LowestLatencyLoggingHandler(CustomLogger):
    ...
    def log_success_event(self, kwargs, response_obj, start_time, end_time):
        try:
            ...
            if kwargs["love_engine_params"].get(metadata_field) is None:
                pass
            else:
                model_group = kwargs["love_engine_params"][metadata_field].get(
                    "model_group", None
                )

                id = (kwargs["love_engine_params"].get("model_info") or {}).get("id", None)
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if isinstance(_exception, love_engine.Timeout):
                if kwargs["love_engine_params"].get(metadata_field) is None:
                    pass
                else:
                    model_group = kwargs["love_engine_params"][metadata_field].get(
                    ...
                    id = (kwargs["love_engine_params"].get("model_info") or {}).get(
                        "id", None
                    )
                    if model_group is None or id is None:
                        return
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        try:
            ...
            verbose_logger.exception(
                "love_engine.router_strategy.lowest_latency.py::async_log_success_event(): Exception occured - {}".format(
                    str(e)
                )
            )
            pass
