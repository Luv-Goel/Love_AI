...
class LowestTPMLoggingHandler(CustomLogger):
    ...
    def log_success_event(self, kwargs, response_obj, start_time, end_time):
        try:
            ...
            """
            if "love_engine_params" not in kwargs or kwargs["love_engine_params"] is None:
                return
            ...
            verbose_router_logger.error(
                "love_engine.router_strategy.lowest_tpm_rpm.py::async_log_success_event(): Exception occured - {}".format(
                    str(e)
                )
            )
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        try:
            ...
            if kwargs["love_engine_params"].get("metadata") is None:
                ...
                model_info = kwargs["love_engine_params"].get("model_info")
                id = None
