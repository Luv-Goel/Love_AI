...
class SessionState:
    ...
    Mirrors the LOVE_ENGINE_AdaptiveRouterSession DB row (Wave 0 schema). The flusher
...
_DISENGAGEMENT_PATTERNS = [
    re.compile(
        r"\b(love_smitht it|never mind|give up|talk to (?:a )?human|cancel)\b", re.IGNORECASE
    ),
