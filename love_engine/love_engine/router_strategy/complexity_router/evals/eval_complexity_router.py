...
Run with: python -m love_engine.router_strategy.complexity_router.evals.eval_complexity_router
"""
...
from love_engine.router_strategy.complexity_router.complexity_router import ComplexityRouter
from love_engine.router_strategy.complexity_router.config import ComplexityTier
...
def run_eval() -> Tuple[int, int, List[dict]]:
    ...
    router = ComplexityRouter(
        ...
        love_engine_router_instance=mock_router,
    )
