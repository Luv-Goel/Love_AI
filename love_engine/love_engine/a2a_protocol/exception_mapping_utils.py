...
Maps A2A SDK exceptions to love_engine A2A exception types.
"""

from typing import TYPE_CHECKING, Any, Optional

from love_engine._logging import verbose_logger
from love_engine.a2a_protocol.card_resolver import (
    fix_agent_card_url,
...
from love_engine.constants import CONNECTION_ERROR_PATTERNS
...
def map_a2a_exception(
    ...
    """
    Map an A2A SDK exception to a love_engine A2A exception type.
    ...
    Returns:
        A mapped love_engine A2A exception
