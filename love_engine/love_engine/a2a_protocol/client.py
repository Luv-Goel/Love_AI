...
class A2AClient:
    """
    love_engine wrapper for A2A agent invocation.

    Creates the underlying A2A client once on first use and reuses it.

    Example:
        ```python
        from love_engine.a2a_protocol import A2AClient
    ...
    async def _get_client(self) -> "A2AClientType":
        ...
        if self._a2a_client is None:
            from love_engine.a2a_protocol.main import create_a2a_client
    ...
    async def get_agent_card(self) -> "AgentCard":
        ...
        from love_engine.a2a_protocol.main import aget_agent_card
    ...
    async def send_message(
        ...
        from love_engine.a2a_protocol.main import asend_message
    ...
    async def send_message_streaming(
        ...
        from love_engine.a2a_protocol.main import asend_message_streaming
