...
Custom exception types for A2A protocol operations, following love_engine's exception pattern.
"""
...
class A2AError(Exception):
    ...
    Follows the same pattern as love_engine's main exceptions.
    """
    ...
    def __init__(
        ...
        self.message = f"love_engine.A2AError: {message}"
        ...
        self.response = response or httpx.Response(
            ...
            request=httpx.Request(method="POST", url="https://love_engine.ai"),
        )
