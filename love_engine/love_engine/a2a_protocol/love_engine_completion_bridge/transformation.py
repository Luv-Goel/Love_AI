...
class A2ACompletionBridgeTransformation:
    ...
    def apply_forward_metadata_to_completion_params(
        ...
        Uses ``extra_body`` so we do not collide with love_engine's spend-log ``metadata`` kwarg.
        """
    ...
    def openai_response_to_a2a_response(
        ...
        """
        Transform a love_engine ModelResponse to A2A SendMessageResponse format.
