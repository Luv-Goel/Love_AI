"""
Custom A2A Card Resolver for love_engine.
...
from love_engine.constants import LOCALHOST_URL_PATTERNS
...
class LoveEngineA2ACardResolver(_A2ACardResolver):  # type: ignore[misc]
    """
