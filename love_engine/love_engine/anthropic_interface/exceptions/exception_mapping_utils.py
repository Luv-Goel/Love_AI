...
Similar to love_engine/love_engine_core_utils/exception_mapping_utils.py but for Anthropic response format.
"""
...
class AnthropicExceptionMapping:
    ...
    Similar pattern to ExceptionCheckers in love_engine_core_utils/exception_mapping_utils.py
    """
