...
Relevant issue: https://github.com/BerriAI/love_engine/issues/1235
...
def load_google_kms(use_google_kms: Optional[bool]):
    ...
    try:
        ...
        love_engine._key_management_system = KeyManagementSystem.GOOGLE_KMS
        love_engine._google_kms_resource_name = os.getenv("GOOGLE_KMS_RESOURCE_NAME")
