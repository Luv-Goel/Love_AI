...
def load_custom_secret_manager(config_file_path: Optional[str] = None) -> None:
    ...
    if love_engine._key_management_settings is None:
        raise ValueError(
    ...
    custom_secret_manager_path = getattr(
        love_engine._key_management_settings, "custom_secret_manager", None
    )
    ...
    love_engine.secret_manager_client = _secret_manager_instance
