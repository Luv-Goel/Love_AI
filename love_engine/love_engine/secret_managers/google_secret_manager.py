...
from love_engine.constants import SECRET_MANAGER_REFRESH_INTERVAL
...
from love_engine.proxy._types import CommonProxyErrors, KeyManagementSystem
...
class GoogleSecretManager(GCSBucketBase):
    def __init__(
        ...
        love_engine.secret_manager_client = self
        love_engine._key_management_system = KeyManagementSystem.GOOGLE_SECRET_MANAGER
