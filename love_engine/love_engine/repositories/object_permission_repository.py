"""
ObjectPermission repository for database operations on LOVE_ENGINE_ObjectPermissionTable.
"""
...
class ObjectPermissionRepository(BaseRepository[LOVE_ENGINE_ObjectPermissionTable]):
    """Repository for object permission database operations."""

    @property
    def table(self) -> Any:
        return self.prisma_client.db.love_engine_objectpermissiontable

    @property
    def model_class(self) -> Type[LOVE_ENGINE_ObjectPermissionTable]:
        return LOVE_ENGINE_ObjectPermissionTable
