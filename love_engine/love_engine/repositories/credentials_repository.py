"""
Credentials repository for database operations on LOVE_ENGINE_CredentialsTable.

This is the only place that talks to ``love_engine_credentialstable``. Encryption of
...
from love_engine.models.credentials import CredentialItem
...
class CredentialsRepository:
    ...
    @property
    def table(self) -> Any:
        return self.prisma_client.db.love_engine_credentialstable
