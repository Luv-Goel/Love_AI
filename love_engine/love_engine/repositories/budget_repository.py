"""
Budget repository for database operations on LOVE_ENGINE_BudgetTable.
"""
...
class BudgetRepository(BaseRepository[LOVE_ENGINE_BudgetTable]):
    """Repository for budget database operations."""

    @property
    def table(self) -> Any:
        return self.prisma_client.db.love_engine_budgettable

    @property
    def model_class(self) -> Type[LOVE_ENGINE_BudgetTable]:
        return LOVE_ENGINE_BudgetTable
    ...
    async def delete_budget(self, budget_id: str) -> Optional[LOVE_ENGINE_BudgetTable]:
