"""
Main OCR function for LoveEngine.
"""
...
async def aocr(
    ...
    **kwargs,
    ...
    Example:
        ...
        # OCR with PDF
        response = await love_engine.aocr(
...
def ocr(
    ...
    **kwargs,
    ...
    try:
        ...
        # Get love_engine params using GenericLoveEngineParams (same as responses API)
