...
_ENABLE_SECRET_REDACTION = (
    os.getenv("LOVE_ENGINE_DISABLE_REDACT_SECRETS", "").lower() != "true"
)
...
def redact_secrets(value: str) -> str:
    ...
    love_engine_core_utils/redact_messages.py, which redacts LLM prompt/response
...
log_level = os.getenv("LOVE_ENGINE_LOG", "DEBUG")
...
verbose_proxy_logger = logging.getLogger("love_engine Proxy")
verbose_router_logger = logging.getLogger("love_engine Router")
verbose_logger = logging.getLogger("love_engine")
...
def _get_loggers_to_initialize():
    ...
    all_callbacks = set(love_engine.success_callback + love_engine.failure_callback)
...
def _get_uvicorn_json_log_config():
    ...
    """
    json_formatter_class = "love_engine._logging.JsonFormatter"
