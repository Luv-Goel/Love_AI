...
DEFAULT_BASE_BRANCH = "love_engine_internal_staging"
...
def create_migration(
    ...
    Args:
        ...
        base_branch (str): Branch to check freshness against
            (default: "love_engine_internal_staging").
    ...
    try:
        migrations_dir = (
            root_dir / "love_engine-proxy-extras" / "love_engine_proxy_extras" / "migrations"
        )
