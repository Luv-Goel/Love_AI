...
from love_crawler.llmtxt import AsyncLLMTextManager


class DocsManager:
    def __init__(self, logger=None):
        self.docs_dir = Path.home() / ".love_crawler" / "docs"
    ...
    async def fetch_docs(self) -> bool:
        ...
        try:
            ...
            response = requests.get(
                "https://api.github.com/repos/unclecode/love_crawler/contents/docs/llm.txt",
