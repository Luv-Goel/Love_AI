...
class NaivePDFProcessorStrategy(PDFProcessorStrategy):
    def __init__(self, image_dpi: int = 144, image_quality: int = 85, extract_images: bool = True, 
        ...
        try:
            ...
            raise ImportError("pypdf is required for PDF processing. Install with 'pip install love_crawler[pdf]'")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("pypdf is required for PDF processing. Install with 'pip install love_crawler[pdf]'")
        exit(1)
