...
class LXMLWebScrapingStrategy(ContentScrapingStrategy):
    ...
    This is the primary scraping strategy in love_crawler, providing high-performance
    ...
    def _scrap(
        ...
        **kwargs,
        ...
        try:
            ...
            error_div = etree.SubElement(error_body, "div", id="love_crawler_error_message")
            error_div.text = f"""
            love_crawler Error: This page is not fully supported.
