"""
Adaptive Web Crawler for love_crawler
...
from love_crawler.async_configs import CrawlerRunConfig, LinkPreviewConfig, LLMConfig
from love_crawler.models import Link, CrawlResult
import numpy as np
