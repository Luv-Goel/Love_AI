...
from love_crawler import CacheMode
from love_crawler.async_configs import CrawlerRunConfig
from love_crawler.models import CrawlResult, TraversalStats
from love_crawler.deep_crawling.filters import FilterChain
from love_crawler.async_webcrawler import AsyncWebCrawler
import time
import logging
...
async def main():
    ...
    async with AsyncWebCrawler() as crawler:
        ...
        async for result in crawler.arun("https://docs.love_crawler.com", config=config):
