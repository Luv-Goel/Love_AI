from .__version__ import __version__ as love_crawler_version
import os
import re
import sys
import time
...
class AsyncWebCrawler:
    ...
    Attributes:
        ...
        love_crawler_folder (str): Directory for storing cache.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.logger = logger or AsyncLogger(
            log_file=os.path.join(base_directory, ".love_crawler", "crawler.log"),
        ...
        self.love_crawler_folder = os.path.join(base_directory, ".love_crawler")
        os.makedirs(self.love_crawler_folder, exist_ok=True)
        os.makedirs(f"{self.love_crawler_folder}/cache", exist_ok=True)
    ...
    async def start(self):
        ...
        self.logger.info(f"Love AI Web Engine {love_crawler_version}", tag="INIT")
        self.ready = True
        return self
        ...
        **kwargs
        ...
        if not self.url_seeder:
            ...
            self.url_seeder = AsyncUrlSeeder(
                base_directory=self.love_crawler_folder,
                logger=self.logger
            )                    
        ...
        seeding_config.base_directory = seeding_config.base_directory or self.love_crawler_folder        
