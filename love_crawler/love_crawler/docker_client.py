...
class love_crawlerClientError(Exception):
    """Base exception for love_crawler Docker client errors."""
    pass


class ConnectionError(love_crawlerClientError):
    """Raised when connection to the Docker server fails."""
    pass


class RequestError(love_crawlerClientError):
    """Raised when the server returns an error response."""
    pass


class love_crawlerDockerClient:
    """Client for interacting with love_crawler Docker server with token authentication."""
    ...
    async def __aenter__(self) -> "love_crawlerDockerClient":
        return self
...
# Example usage
async def main():
    async with love_crawlerDockerClient(verbose=True) as client:
