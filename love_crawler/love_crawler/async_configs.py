    ...
    def _compile_c4a_script(self):
        ...
        try:
            ...
            try:
                ...
                from love_crawler.script import compile
            ...
            raise ValueError(
                ...
                "Please ensure love_crawler.script module is properly installed."
            )
        except Exception as e:
    ...
    def __init__(
        ...
        Args:
            ...
            base_directory: Base directory for UrlSeeder's cache files (.jsonl). 
                           If None, uses default ~/.love_crawler/. Default: None
