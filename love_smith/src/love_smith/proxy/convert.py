"""Convert between OpenAI chat completions format and love_smith Messages."""
...
from love_smith.core.workflow import ToolCall, TextResponse


# ── Inbound: OpenAI request → love_smith Messages ─────────────────────

def openai_to_messages(openai_messages: list[dict[str, Any]]) -> list[Message]:
    """Convert OpenAI chat completions messages to love_smith Message objects.
...
# ── Outbound: love_smith response → OpenAI format ─────────────────────
...
def tool_calls_to_openai(
    ...
    """Convert love_smith ToolCalls to an OpenAI chat completions response object."""
...
def tool_calls_to_sse_events(
    ...
    """Convert love_smith ToolCalls to a sequence of SSE chunk objects.
