...
from love_smith.core.workflow import LLMResponse, TextResponse, ToolCall
from love_smith.guardrails.nudge import Nudge
from love_smith.prompts.nudges import retry_nudge, tool_arg_validation_nudge, unknown_tool_nudge
from love_smith.prompts.templates import rescue_tool_call
...
class ResponseValidator:
    ...
    Args:
        ...
        retry_nudge_fn: Custom nudge function for bare text responses. Takes
            ...
            uses the default retry nudge from ``love_smith.prompts.nudges``.
    """
