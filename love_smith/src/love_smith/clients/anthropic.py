...
Translates between love_smith's OpenAI-style message format (what the runner
...
from love_smith.clients.base import ChunkType, StreamChunk, TokenUsage, decode_tool_args
from love_smith.core.workflow import LLMResponse, TextResponse, ToolCall, ToolSpec
from love_smith.errors import BackendError
...
class AnthropicClient:
    ...
    def __init__(
        ...
        # AnthropicClient does not expose sampling kwargs through love_smith today.
        ...
        # (LoveEngine, a self-hosted proxy, etc.) — proxy path 1.
    ...
    def _build_kwargs(
        ...
        ``metadata``, ``thinking``, etc.). love_smith-owned fields (``model``,
        ...
        love_smith.Message doesn't represent. The runner only passes this on the
    ...
    async def send(
        ...
        love_smith. ``passthrough`` merges inbound-body extras into the SDK call.
