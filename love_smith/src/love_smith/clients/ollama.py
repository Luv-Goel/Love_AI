...
from love_smith.clients.base import ChunkType, StreamChunk, TokenUsage, format_tool
...
from love_smith.errors import BackendError, ThinkingNotSupportedError
...
class OllamaClient:
    ...
    async def send(
        ...
        (love_smith proxy uses LlamafileClient for external mode). Adding
