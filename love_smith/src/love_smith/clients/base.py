...
from love_smith.core.workflow import LLMResponse, ToolSpec
...
# schema the client authored, instead of love_smith's reconstructed ToolSpec.
...
class LLMClient(Protocol):
    ...
    async def send(
        ...
        Args:
            ...
            passthrough: Optional dict of inbound body fields love_smith doesn't
                ...
                tool_choice, etc.) without love_smith having to enumerate every
            ...
            inbound_anthropic_body: Path-1 only — when set, the AnthropicClient
                ...
                love_smith-mutation (retry / compaction / context warning) so
