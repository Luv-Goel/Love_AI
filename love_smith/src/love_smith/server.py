...
from love_smith.context.hardware import detect_hardware
from love_smith.context.manager import CompactEvent, ContextManager
from love_smith.context.strategies import TieredCompact
from love_smith.errors import BackendError, BudgetResolutionError
...
class BudgetMode(str, Enum):
    ...
    love_smith_FULL = "love_smith-full"  # Max safe context (server auto-tune / Ollama tier).
    love_smith_FAST = "love_smith-fast"  # Half of full. Trades context for faster attention.
...
class ServerManager:
    ...
    async def resolve_budget(
        ...
        if self._backend == "ollama":
            ...
            if mode == BudgetMode.love_smith_FAST:
                return full // 2
            return full
    ...
    async def start_with_budget(
        ...
        *,
        ...
        - BACKEND/love_smith_FULL: start without -c, read /props
        - MANUAL: start with -c = manual_tokens, read /props
        - love_smith_FAST: start without -c, read /props for max,
        ...
        if budget_mode == BudgetMode.love_smith_FAST:
        ...
        # BACKEND / love_smith_FULL / MANUAL
...
async def setup_backend(
    ...
    Example usage::
        ...
        server, ctx = await setup_backend(
            ...
            budget_mode=BudgetMode.love_smith_FAST,
            client=client,
        )
