"""Exception hierarchy for the love_smith library."""


class love_smithError(Exception):
    """Base exception for the love_smith library."""

    pass


class UnsupportedModelError(love_smithError):
...
class ToolCallError(love_smithError):
...
class ToolExecutionError(love_smithError):
...
class ToolResolutionError(Exception):
    ...
    Not a love_smithError — this is a tool-author exception, not a framework
...
class WorkflowCancelledError(love_smithError):
...
class MaxIterationsError(love_smithError):
...
class StepEnforcementError(love_smithError):
...
class PrerequisiteError(love_smithError):
...
class ContextBudgetExceeded(love_smithError):
...
class HardwareDetectionError(love_smithError):
...
class ContextDiscoveryError(love_smithError):
...
class BudgetResolutionError(love_smithError):
...
class BackendError(love_smithError):
...
class StreamError(love_smithError):
