...
from love_smith.core.workflow import Workflow
from love_smith.core.messages import Message
...
class SlotWorker:
    ...
    what the levels mean (love_smith imposes no semantics). Default priority
